Shader "CTS/CTS Terrain Shader Advanced LOD"
{
	Properties
	{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			fixed localTangent7740 = ( 0 );
			v.tangent.xyz = cross ( v.normal, float3( 0, 0, 1 ) );
			v.tangent.w = -1;
			fixed3 temp_cast_0 = (localTangent7740).xxx;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult7739 = (fixed2(ase_vertex3Pos.x , ase_vertex3Pos.z));
			fixed2 Top_Bottom1999 = appendResult7739;
			...
			float clampResult7747 = clamp( ( tex2DNode7708.a + ( 1.0 - _Global_Color_Opacity_Power ) ) , 0 , 1 );
			float2 appendResult7710 = (fixed2(1 , ( _Global_Color_Map_Far_Power * clampResult7747 )));
