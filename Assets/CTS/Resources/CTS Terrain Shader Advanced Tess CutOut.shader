Shader "CTS/CTS Terrain Shader Advanced Tess CutOut"
{
	Properties
	{
	...
	SubShader
	{
		...
		inline fixed MyCustomExpression8064( inout fixed3 In0 )
		{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float2 appendResult8055 = (fixed2(ase_vertex3Pos.x , ase_vertex3Pos.z));
			fixed2 Top_Bottom1999 = appendResult8055;
			...
			float2 appendResult8057 = (fixed2(ase_vertex3Pos.z , ase_vertex3Pos.y));
			fixed2 Front_Back1991 = appendResult8057;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult11_g1164 = (fixed2(texArray6256.w , texArray6256.y));
			float2 temp_output_4_0_g1164 = ( ( ( appendResult11_g1164 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power_Close );
			...
			float2 appendResult11_g1163 = (fixed2(texArray4374.w , texArray4374.y));
			float2 temp_output_4_0_g1163 = ( ( ( appendResult11_g1163 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power );
			...
			float clampResult297 = clamp( pow( ( max( max( abs( ( ase_worldPos - _WorldSpaceCameraPos ) ).x , abs( ( ase_worldPos - _WorldSpaceCameraPos ) ).y ) , abs( ( ase_worldPos - _WorldSpaceCameraPos ) ).z ) / _UV_Mix_Start_Distance ) , _UV_Mix_Power ) , 0 , 1 );
			fixed UVmixDistance636 = clampResult297;
			float3 lerpResult6257 = lerp( appendResult10_g1164 , appendResult10_g1163 , UVmixDistance636);
			...
			float2 appendResult11_g1091 = (fixed2(texArray3300.w , texArray3300.y));
			float2 temp_output_4_0_g1091 = ( ( ( appendResult11_g1091 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			...
			float3 appendResult10_g1091 = (fixed3(temp_output_4_0_g1091.x , temp_output_4_0_g1091.y , temp_output_9_0_g1091));
			float3 temp_output_6989_0 = appendResult10_g1091;
			float4 texArray3299 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3279_0, _Texture_1_Normal_Index)  );
			float2 appendResult11_g536 = (fixed2(texArray3299.w , texArray3299.y));
			float2 temp_output_4_0_g536 = ( ( ( appendResult11_g536 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_1_Normal_Power * -1 ) );
			float dotResult5_g536 = dot( temp_output_4_0_g536 , temp_output_4_0_g536 );
			float temp_output_9_0_g536 = sqrt( ( 1.0 - saturate( dotResult5_g536 ) ) );
			float3 appendResult19_g536 = (fixed3(temp_output_4_0_g536.y , temp_output_4_0_g536.x , temp_output_9_0_g536));
			...
			float2 appendResult11_g535 = (fixed2(texArray3301.w , texArray3301.y));
			float2 temp_output_4_0_g535 = ( ( ( appendResult11_g535 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			float dotResult5_g535 = dot( temp_output_4_0_g535 , temp_output_4_0_g535 );
			float temp_output_9_0_g535 = sqrt( ( 1.0 - saturate( dotResult5_g535 ) ) );
			float3 appendResult10_g535 = (fixed3(temp_output_4_0_g535.x , temp_output_4_0_g535.y , temp_output_9_0_g535));
			float3 appendResult6860 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6393 = BlendComponents91;
			float3 weightedAvg6393 = ( ( weightedBlendVar6393.x*( appendResult19_g536 * appendResult6857 ) + weightedBlendVar6393.y*temp_output_6989_0 + weightedBlendVar6393.z*( appendResult10_g535 * appendResult6860 ) )/( weightedBlendVar6393.x + weightedBlendVar6393.y + weightedBlendVar6393.z ) );
			...
			float2 appendResult11_g537 = (fixed2(texArray3384.w , texArray3384.y));
			float2 temp_output_4_0_g537 = ( ( ( appendResult11_g537 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_2_Normal_Power * -1 ) );
			float dotResult5_g537 = dot( temp_output_4_0_g537 , temp_output_4_0_g537 );
			float temp_output_9_0_g537 = sqrt( ( 1.0 - saturate( dotResult5_g537 ) ) );
			float3 appendResult19_g537 = (fixed3(temp_output_4_0_g537.y , temp_output_4_0_g537.x , temp_output_9_0_g537));
			...
			float2 appendResult11_g540 = (fixed2(texArray3351.w , texArray3351.y));
			float2 temp_output_4_0_g540 = ( ( ( appendResult11_g540 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			...
			float3 weightedAvg6401 = ( ( weightedBlendVar6401.x*( appendResult19_g537 * appendResult6864 ) + weightedBlendVar6401.y*temp_output_6992_0 + weightedBlendVar6401.z*( appendResult10_g540 * appendResult6867 ) )/( weightedBlendVar6401.x + weightedBlendVar6401.y + weightedBlendVar6401.z ) );
			...
			float2 appendResult11_g1100 = (fixed2(texArray3416.w , texArray3416.y));
			float2 temp_output_4_0_g1100 = ( ( ( appendResult11_g1100 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			...
			float3 temp_output_6995_0 = appendResult10_g1100;
			...
			float2 appendResult11_g539 = (fixed2(texArray3417.w , texArray3417.y));
			float2 temp_output_4_0_g539 = ( ( ( appendResult11_g539 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			...
			float3 appendResult10_g539 = (fixed3(temp_output_4_0_g539.x , temp_output_4_0_g539.y , temp_output_9_0_g539));
			float3 appendResult6874 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6408 = BlendComponents91;
			float3 weightedAvg6408 = ( ( weightedBlendVar6408.x*( appendResult19_g541 * appendResult6871 ) + weightedBlendVar6408.y*temp_output_6995_0 + weightedBlendVar6408.z*( appendResult10_g539 * appendResult6874 ) )/( weightedBlendVar6408.x + weightedBlendVar6408.y + weightedBlendVar6408.z ) );
			...
			float2 appendResult11_g1098 = (fixed2(texArray3483.w , texArray3483.y));
			...
			float3 appendResult10_g1098 = (fixed3(temp_output_4_0_g1098.x , temp_output_4_0_g1098.y , temp_output_9_0_g1098));
			float3 temp_output_6998_0 = appendResult10_g1098;
			float4 texArray3512 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3478_0, _Texture_4_Normal_Index)  );
			float2 appendResult11_g538 = (fixed2(texArray3512.w , texArray3512.y));
			float2 temp_output_4_0_g538 = ( ( ( appendResult11_g538 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_4_Normal_Power * -1 ) );
			...
			float3 appendResult19_g538 = (fixed3(temp_output_4_0_g538.y , temp_output_4_0_g538.x , temp_output_9_0_g538));
			...
			float2 appendResult11_g534 = (fixed2(texArray3484.w , texArray3484.y));
			float2 temp_output_4_0_g534 = ( ( ( appendResult11_g534 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			float dotResult5_g534 = dot( temp_output_4_0_g534 , temp_output_4_0_g534 );
			float temp_output_9_0_g534 = sqrt( ( 1.0 - saturate( dotResult5_g534 ) ) );
			float3 appendResult10_g534 = (fixed3(temp_output_4_0_g534.x , temp_output_4_0_g534.y , temp_output_9_0_g534));
			float3 appendResult6881 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6415 = BlendComponents91;
			float3 weightedAvg6415 = ( ( weightedBlendVar6415.x*( appendResult19_g538 * appendResult6878 ) + weightedBlendVar6415.y*temp_output_6998_0 + weightedBlendVar6415.z*( appendResult10_g534 * appendResult6881 ) )/( weightedBlendVar6415.x + weightedBlendVar6415.y + weightedBlendVar6415.z ) );
			...
			float2 appendResult11_g1122 = (fixed2(texArray4424.w , texArray4424.y));
			float2 temp_output_4_0_g1122 = ( ( ( appendResult11_g1122 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
			...
			float3 temp_output_7001_0 = appendResult10_g1122;
			float4 texArray4417 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4400_0, _Texture_5_Normal_Index)  );
			float2 appendResult11_g1094 = (fixed2(texArray4417.w , texArray4417.y));
			float2 temp_output_4_0_g1094 = ( ( ( appendResult11_g1094 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_5_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1094 = (fixed3(temp_output_4_0_g1094.y , temp_output_4_0_g1094.x , temp_output_9_0_g1094));
			...
			float2 appendResult11_g1090 = (fixed2(texArray4422.w , texArray4422.y));
			float2 temp_output_4_0_g1090 = ( ( ( appendResult11_g1090 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
			...
			float3 appendResult10_g1090 = (fixed3(temp_output_4_0_g1090.x , temp_output_4_0_g1090.y , temp_output_9_0_g1090));
			float3 appendResult6888 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6422 = BlendComponents91;
			float3 weightedAvg6422 = ( ( weightedBlendVar6422.x*( appendResult19_g1094 * appendResult6885 ) + weightedBlendVar6422.y*temp_output_7001_0 + weightedBlendVar6422.z*( appendResult10_g1090 * appendResult6888 ) )/( weightedBlendVar6422.x + weightedBlendVar6422.y + weightedBlendVar6422.z ) );
			...
			float2 appendResult11_g1132 = (fixed2(texArray4493.w , texArray4493.y));
			float2 temp_output_4_0_g1132 = ( ( ( appendResult11_g1132 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			...
			float3 temp_output_7004_0 = appendResult10_g1132;
			float4 texArray4486 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4472_0, _Texture_6_Normal_Index)  );
			float2 appendResult11_g1095 = (fixed2(texArray4486.w , texArray4486.y));
			float2 temp_output_4_0_g1095 = ( ( ( appendResult11_g1095 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_6_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1095 = (fixed3(temp_output_4_0_g1095.y , temp_output_4_0_g1095.x , temp_output_9_0_g1095));
			...
			float2 appendResult11_g1101 = (fixed2(texArray4491.w , texArray4491.y));
			float2 temp_output_4_0_g1101 = ( ( ( appendResult11_g1101 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			...
			float3 appendResult10_g1101 = (fixed3(temp_output_4_0_g1101.x , temp_output_4_0_g1101.y , temp_output_9_0_g1101));
			float3 appendResult6895 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6429 = BlendComponents91;
			float3 weightedAvg6429 = ( ( weightedBlendVar6429.x*( appendResult19_g1095 * appendResult6892 ) + weightedBlendVar6429.y*temp_output_7004_0 + weightedBlendVar6429.z*( appendResult10_g1101 * appendResult6895 ) )/( weightedBlendVar6429.x + weightedBlendVar6429.y + weightedBlendVar6429.z ) );
			...
			float2 appendResult11_g1133 = (fixed2(texArray4567.w , texArray4567.y));
			float2 temp_output_4_0_g1133 = ( ( ( appendResult11_g1133 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
			...
			float3 appendResult10_g1133 = (fixed3(temp_output_4_0_g1133.x , temp_output_4_0_g1133.y , temp_output_9_0_g1133));
			float3 temp_output_7007_0 = appendResult10_g1133;
			float4 texArray4560 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4546_0, _Texture_7_Normal_Index)  );
			float2 appendResult11_g1092 = (fixed2(texArray4560.w , texArray4560.y));
			float2 temp_output_4_0_g1092 = ( ( ( appendResult11_g1092 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_7_Normal_Power * -1 ) );
			...
			float2 appendResult11_g1093 = (fixed2(texArray4565.w , texArray4565.y));
			float2 temp_output_4_0_g1093 = ( ( ( appendResult11_g1093 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
			...
			float3 weightedAvg6436 = ( ( weightedBlendVar6436.x*( appendResult19_g1092 * appendResult6899 ) + weightedBlendVar6436.y*temp_output_7007_0 + weightedBlendVar6436.z*( appendResult10_g1093 * appendResult6902 ) )/( weightedBlendVar6436.x + weightedBlendVar6436.y + weightedBlendVar6436.z ) );
			...
			float2 appendResult11_g1128 = (fixed2(texArray4641.w , texArray4641.y));
			float2 temp_output_4_0_g1128 = ( ( ( appendResult11_g1128 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			...
			float3 temp_output_7010_0 = appendResult10_g1128;
			float4 texArray4634 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4620_0, _Texture_8_Normal_Index)  );
			float2 appendResult11_g1097 = (fixed2(texArray4634.w , texArray4634.y));
			float2 temp_output_4_0_g1097 = ( ( ( appendResult11_g1097 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_8_Normal_Power * -1 ) );
			...
			float2 appendResult11_g1099 = (fixed2(texArray4639.w , texArray4639.y));
			float2 temp_output_4_0_g1099 = ( ( ( appendResult11_g1099 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			...
			float3 weightedAvg6443 = ( ( weightedBlendVar6443.x*( appendResult19_g1097 * appendResult6906 ) + weightedBlendVar6443.y*temp_output_7010_0 + weightedBlendVar6443.z*( appendResult10_g1099 * appendResult6909 ) )/( weightedBlendVar6443.x + weightedBlendVar6443.y + weightedBlendVar6443.z ) );
			...
			float2 appendResult11_g1150 = (fixed2(texArray4788.w , texArray4788.y));
			float2 temp_output_4_0_g1150 = ( ( ( appendResult11_g1150 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 temp_output_7034_0 = appendResult10_g1150;
			float4 texArray5285 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4706_0, _Texture_9_Normal_Index)  );
			float2 appendResult11_g1126 = (fixed2(texArray5285.w , texArray5285.y));
			float2 temp_output_4_0_g1126 = ( ( ( appendResult11_g1126 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_9_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1126 = (fixed3(temp_output_4_0_g1126.y , temp_output_4_0_g1126.x , temp_output_9_0_g1126));
			...
			float2 appendResult11_g1123 = (fixed2(texArray4783.w , texArray4783.y));
			float2 temp_output_4_0_g1123 = ( ( ( appendResult11_g1123 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 appendResult10_g1123 = (fixed3(temp_output_4_0_g1123.x , temp_output_4_0_g1123.y , temp_output_9_0_g1123));
			float3 appendResult6965 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6450 = BlendComponents91;
			float3 weightedAvg6450 = ( ( weightedBlendVar6450.x*( appendResult19_g1126 * appendResult6962 ) + weightedBlendVar6450.y*temp_output_7034_0 + weightedBlendVar6450.z*( appendResult10_g1123 * appendResult6965 ) )/( weightedBlendVar6450.x + weightedBlendVar6450.y + weightedBlendVar6450.z ) );
			...
			float2 appendResult11_g1153 = (fixed2(texArray4822.w , texArray4822.y));
			...
			float3 temp_output_7031_0 = appendResult10_g1153;
			float4 texArray4798 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4742_0, _Texture_10_Normal_Index)  );
			float2 appendResult11_g1130 = (fixed2(texArray4798.w , texArray4798.y));
			float2 temp_output_4_0_g1130 = ( ( ( appendResult11_g1130 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_10_Normal_Power * -1 ) );
			...
			float2 appendResult11_g1127 = (fixed2(texArray4791.w , texArray4791.y));
			float2 temp_output_4_0_g1127 = ( ( ( appendResult11_g1127 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
			...
			float3 weightedAvg6457 = ( ( weightedBlendVar6457.x*( appendResult19_g1130 * appendResult6955 ) + weightedBlendVar6457.y*temp_output_7031_0 + weightedBlendVar6457.z*( appendResult10_g1127 * appendResult6958 ) )/( weightedBlendVar6457.x + weightedBlendVar6457.y + weightedBlendVar6457.z ) );
			...
			float2 appendResult11_g1157 = (fixed2(texArray4856.w , texArray4856.y));
			float2 temp_output_4_0_g1157 = ( ( ( appendResult11_g1157 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
			...
			float3 temp_output_7028_0 = appendResult10_g1157;
			float4 texArray4828 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4748_0, _Texture_11_Normal_Index)  );
			float2 appendResult11_g1125 = (fixed2(texArray4828.w , texArray4828.y));
			float2 temp_output_4_0_g1125 = ( ( ( appendResult11_g1125 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_11_Normal_Power * -1 ) );
			...
			float3 weightedAvg6464 = ( ( weightedBlendVar6464.x*( appendResult19_g1125 * appendResult6948 ) + weightedBlendVar6464.y*temp_output_7028_0 + weightedBlendVar6464.z*( appendResult10_g1131 * appendResult6951 ) )/( weightedBlendVar6464.x + weightedBlendVar6464.y + weightedBlendVar6464.z ) );
			...
			float2 appendResult11_g1154 = (fixed2(texArray4870.w , texArray4870.y));
			float2 temp_output_4_0_g1154 = ( ( ( appendResult11_g1154 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			float3 temp_output_7025_0 = appendResult10_g1154;
			float4 texArray4850 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4758_0, _Texture_12_Normal_Index)  );
			float2 appendResult11_g1129 = (fixed2(texArray4850.w , texArray4850.y));
			float2 temp_output_4_0_g1129 = ( ( ( appendResult11_g1129 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_12_Normal_Power * -1 ) );
			...
			float2 appendResult11_g1124 = (fixed2(texArray4852.w , texArray4852.y));
			float2 temp_output_4_0_g1124 = ( ( ( appendResult11_g1124 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			float3 appendResult10_g1124 = (fixed3(temp_output_4_0_g1124.x , temp_output_4_0_g1124.y , temp_output_9_0_g1124));
			float3 appendResult6944 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6471 = BlendComponents91;
			float3 weightedAvg6471 = ( ( weightedBlendVar6471.x*( appendResult19_g1129 * appendResult6941 ) + weightedBlendVar6471.y*temp_output_7025_0 + weightedBlendVar6471.z*( appendResult10_g1124 * appendResult6944 ) )/( weightedBlendVar6471.x + weightedBlendVar6471.y + weightedBlendVar6471.z ) );
			...
			float2 appendResult11_g1161 = (fixed2(texArray5120.w , texArray5120.y));
			float2 temp_output_4_0_g1161 = ( ( ( appendResult11_g1161 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 temp_output_7022_0 = appendResult10_g1161;
			float4 texArray5127 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5025_0, _Texture_13_Normal_Index)  );
			float2 appendResult11_g1149 = (fixed2(texArray5127.w , texArray5127.y));
			float2 temp_output_4_0_g1149 = ( ( ( appendResult11_g1149 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_13_Normal_Power * -1 ) );
			...
			float2 appendResult11_g1156 = (fixed2(texArray5109.w , texArray5109.y));
			float2 temp_output_4_0_g1156 = ( ( ( appendResult11_g1156 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 appendResult6937 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 0));
			float3 weightedBlendVar6478 = BlendComponents91;
			float3 weightedAvg6478 = ( ( weightedBlendVar6478.x*( appendResult19_g1149 * appendResult6934 ) + weightedBlendVar6478.y*temp_output_7022_0 + weightedBlendVar6478.z*( appendResult10_g1156 * appendResult6937 ) )/( weightedBlendVar6478.x + weightedBlendVar6478.y + weightedBlendVar6478.z ) );
			...
			float2 appendResult11_g1158 = (fixed2(texArray5178.w , texArray5178.y));
			float2 temp_output_4_0_g1158 = ( ( ( appendResult11_g1158 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			...
			float3 temp_output_7019_0 = appendResult10_g1158;
			...
			float3 weightedAvg6485 = ( ( weightedBlendVar6485.x*( appendResult19_g1151 * appendResult6927 ) + weightedBlendVar6485.y*temp_output_7019_0 + weightedBlendVar6485.z*( appendResult10_g1144 * appendResult6930 ) )/( weightedBlendVar6485.x + weightedBlendVar6485.y + weightedBlendVar6485.z ) );
			...
			float2 appendResult11_g1159 = (fixed2(texArray5246.w , texArray5246.y));
			float2 temp_output_4_0_g1159 = ( ( ( appendResult11_g1159 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 temp_output_7016_0 = appendResult10_g1159;
			float4 texArray5227 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5213_0, _Texture_15_Normal_Index)  );
			float2 appendResult11_g1145 = (fixed2(texArray5227.w , texArray5227.y));
			float2 temp_output_4_0_g1145 = ( ( ( appendResult11_g1145 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_15_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1145 = (fixed3(temp_output_4_0_g1145.y , temp_output_4_0_g1145.x , temp_output_9_0_g1145));
			...
			float2 appendResult11_g1152 = (fixed2(texArray5250.w , texArray5250.y));
			float2 temp_output_4_0_g1152 = ( ( ( appendResult11_g1152 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 weightedAvg6492 = ( ( weightedBlendVar6492.x*( appendResult19_g1145 * appendResult6920 ) + weightedBlendVar6492.y*temp_output_7016_0 + weightedBlendVar6492.z*( appendResult10_g1152 * appendResult6923 ) )/( weightedBlendVar6492.x + weightedBlendVar6492.y + weightedBlendVar6492.z ) );
			...
			float2 appendResult11_g1148 = (fixed2(texArray5082.w , texArray5082.y));
			float2 temp_output_4_0_g1148 = ( ( ( appendResult11_g1148 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_16_Normal_Power * -1 ) );
			...
			float2 appendResult11_g1155 = (fixed2(texArray4731.w , texArray4731.y));
			float2 temp_output_4_0_g1155 = ( ( ( appendResult11_g1155 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			...
			float3 weightedAvg6499 = ( ( weightedBlendVar6499.x*( appendResult19_g1148 * appendResult6913 ) + weightedBlendVar6499.y*temp_output_7013_0 + weightedBlendVar6499.z*( appendResult10_g1155 * appendResult6916 ) )/( weightedBlendVar6499.x + weightedBlendVar6499.y + weightedBlendVar6499.z ) );
			...
			float2 appendResult11_g1162 = (fixed2(texArray4382.w , texArray4382.y));
			float2 temp_output_4_0_g1162 = ( ( ( appendResult11_g1162 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Snow_Normal_Scale );
			...
			if( _Texture_Snow_Normal_Index <= 0 )
				...
				ifLocalVar7819 = appendResult10_g1162;
			...
			fixed3 In08064 = float3( 0,0,0 );
			fixed localMyCustomExpression8064 = MyCustomExpression8064( In08064 );
			float temp_output_8070_0 = ( _Glitter_Refreshing_Speed * ( ( localMyCustomExpression8064 * 10 ) + ( _WorldSpaceCameraPos.x + _WorldSpaceCameraPos.y + _WorldSpaceCameraPos.z ) ) );
			float temp_output_8073_0 = ( 0 + temp_output_8070_0 );
			float clampResult8090 = clamp( sin( ( temp_output_8073_0 * 0.1 ) ) , 0 , 1 );
			float2 temp_output_8076_0 = ( Top_Bottom1999 * ( 1 / _Glitter_Tiling ) );
			float2 appendResult8111 = (fixed2(temp_output_8076_0.y , temp_output_8076_0.x));
			fixed4 tex2DNode8092 = tex2D( _Texture_Glitter, ( appendResult8111 + float2( 0.37,0.67 ) ) );
			float2 panner8077 = ( temp_output_8076_0 + ( temp_output_8070_0 * 0.01 ) * float2( 1,1 ));
			float cos8079 = cos( sin( ( temp_output_8073_0 * 0.0001 ) ) );
			float sin8079 = sin( sin( ( temp_output_8073_0 * 0.0001 ) ) );
			float2 rotator8079 = mul( panner8077 - float2( 0.5,0.5 ) , float2x2( cos8079 , -sin8079 , sin8079 , cos8079 )) + float2( 0.5,0.5 );
			float clampResult8094 = clamp( pow( tex2D( _Texture_Glitter, ( ( rotator8079 + temp_output_8076_0 ) * float2( 0.2,0.2 ) ) ).r , ( 1.0 - _Glitter_Noise_Threshold ) ) , 0 , 1 );
			float lerpResult8096 = lerp(  ( clampResult8090 - 0.2 > 0 ? tex2D( _Texture_Glitter, temp_output_8076_0 ).r : clampResult8090 - 0.2 <= 0 && clampResult8090 + 0.2 >= 0 ? tex2DNode8092.r : tex2DNode8092.r )  , 0.6 , clampResult8094);
			float clampResult8100 = clamp( pow( lerpResult8096 , 100.0 ) , 0 , 1 );
			float temp_output_8101_0 = ( _Gliter_Color_Power * clampResult8100 );
			float3 lerpResult1356 = lerp( ( saturate( ( blendOpSrc4362 + blendOpDest4362 ) )) , ( appendResult1410 + temp_output_8101_0 ) , HeightMask6539);
			...
			float clampResult8106 = clamp( temp_output_8101_0 , 0 , 1 );
			float3 lerpResult8108 = lerp( ( clampResult6245 * _Snow_Specular ) , temp_cast_4 , clampResult8106);
			float3 lerpResult4040 = lerp( ( ( appendResult3857 * float3( 0.3,0.3,0.3 ) ) * _Terrain_Specular ) , lerpResult8108 , HeightMask6539);
			o.Specular = lerpResult4040;
			float lerpResult8107 = lerp( ifLocalVar7821.w , _Glitter_Smoothness , clampResult8106);
			float lerpResult3951 = lerp( ( layeredBlend6532.w * _Terrain_Smoothness ) , lerpResult8107 , HeightMask6539);
