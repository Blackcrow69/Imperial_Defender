Shader "CTS/CTS Terrain Shader Advanced CutOut Mesh"
{
	Properties
	{
		...
		_Texture_8_Geological_Power("Texture_8_Geological_Power", Range( 0 , 2)) = 2
	...
	SubShader
	{
		...
		inline fixed MyCustomExpression8017( inout fixed3 In0 )
		{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult8006 = (fixed2(ase_vertex3Pos.x , ase_vertex3Pos.z));
			fixed2 Top_Bottom1999 = appendResult8006;
			...
			float2 appendResult11_g982 = (fixed2(texArray6256.w , texArray6256.y));
			float2 temp_output_4_0_g982 = ( ( ( appendResult11_g982 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power_Close );
			...
			float2 appendResult11_g981 = (fixed2(texArray4374.w , texArray4374.y));
			float2 temp_output_4_0_g981 = ( ( ( appendResult11_g981 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power );
			...
			float3 lerpResult6257 = lerp( appendResult10_g982 , appendResult10_g981 , UVmixDistance636);
			...
			float2 appendResult8004 = (fixed2(ase_vertex3Pos.z , ase_vertex3Pos.y));
			fixed2 Front_Back1991 = appendResult8004;
			...
			float2 appendResult8005 = (fixed2(ase_vertex3Pos.x , ase_vertex3Pos.y));
			fixed2 Left_Right2003 = appendResult8005;
			...
			float2 appendResult11_g946 = (fixed2(texArray3300.w , texArray3300.y));
			float2 temp_output_4_0_g946 = ( ( ( appendResult11_g946 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			...
			float3 temp_output_6989_0 = appendResult10_g946;
			float4 texArray3299 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3279_0, _Texture_1_Normal_Index)  );
			float2 appendResult11_g434 = (fixed2(texArray3299.w , texArray3299.y));
			float2 temp_output_4_0_g434 = ( ( ( appendResult11_g434 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_1_Normal_Power * -1 ) );
			float dotResult5_g434 = dot( temp_output_4_0_g434 , temp_output_4_0_g434 );
			float temp_output_9_0_g434 = sqrt( ( 1.0 - saturate( dotResult5_g434 ) ) );
			float3 appendResult19_g434 = (fixed3(temp_output_4_0_g434.y , temp_output_4_0_g434.x , temp_output_9_0_g434));
			...
			float2 appendResult11_g431 = (fixed2(texArray3301.w , texArray3301.y));
			float2 temp_output_4_0_g431 = ( ( ( appendResult11_g431 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			float dotResult5_g431 = dot( temp_output_4_0_g431 , temp_output_4_0_g431 );
			float temp_output_9_0_g431 = sqrt( ( 1.0 - saturate( dotResult5_g431 ) ) );
			float3 appendResult10_g431 = (fixed3(temp_output_4_0_g431.x , temp_output_4_0_g431.y , temp_output_9_0_g431));
			float3 appendResult6860 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6393 = BlendComponents91;
			float3 weightedAvg6393 = ( ( weightedBlendVar6393.x*( appendResult19_g434 * appendResult6857 ) + weightedBlendVar6393.y*temp_output_6989_0 + weightedBlendVar6393.z*( appendResult10_g431 * appendResult6860 ) )/( weightedBlendVar6393.x + weightedBlendVar6393.y + weightedBlendVar6393.z ) );
			...
			float2 appendResult11_g944 = (fixed2(texArray3350.w , texArray3350.y));
			float2 temp_output_4_0_g944 = ( ( ( appendResult11_g944 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			...
			float3 appendResult10_g944 = (fixed3(temp_output_4_0_g944.x , temp_output_4_0_g944.y , temp_output_9_0_g944));
			float3 temp_output_6992_0 = appendResult10_g944;
			float4 texArray3384 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3344_0, _Texture_2_Normal_Index)  );
			float2 appendResult11_g437 = (fixed2(texArray3384.w , texArray3384.y));
			float2 temp_output_4_0_g437 = ( ( ( appendResult11_g437 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_2_Normal_Power * -1 ) );
			float dotResult5_g437 = dot( temp_output_4_0_g437 , temp_output_4_0_g437 );
			float temp_output_9_0_g437 = sqrt( ( 1.0 - saturate( dotResult5_g437 ) ) );
			float3 appendResult19_g437 = (fixed3(temp_output_4_0_g437.y , temp_output_4_0_g437.x , temp_output_9_0_g437));
			...
			float2 appendResult11_g432 = (fixed2(texArray3351.w , texArray3351.y));
			float2 temp_output_4_0_g432 = ( ( ( appendResult11_g432 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			float dotResult5_g432 = dot( temp_output_4_0_g432 , temp_output_4_0_g432 );
			float temp_output_9_0_g432 = sqrt( ( 1.0 - saturate( dotResult5_g432 ) ) );
			float3 appendResult10_g432 = (fixed3(temp_output_4_0_g432.x , temp_output_4_0_g432.y , temp_output_9_0_g432));
			float3 appendResult6867 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6401 = BlendComponents91;
			float3 weightedAvg6401 = ( ( weightedBlendVar6401.x*( appendResult19_g437 * appendResult6864 ) + weightedBlendVar6401.y*temp_output_6992_0 + weightedBlendVar6401.z*( appendResult10_g432 * appendResult6867 ) )/( weightedBlendVar6401.x + weightedBlendVar6401.y + weightedBlendVar6401.z ) );
			...
			float2 appendResult11_g937 = (fixed2(texArray3416.w , texArray3416.y));
			float2 temp_output_4_0_g937 = ( ( ( appendResult11_g937 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			...
			float3 appendResult10_g937 = (fixed3(temp_output_4_0_g937.x , temp_output_4_0_g937.y , temp_output_9_0_g937));
			float3 temp_output_6995_0 = appendResult10_g937;
			float4 texArray3445 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3411_0, _Texture_3_Normal_Index)  );
			float2 appendResult11_g438 = (fixed2(texArray3445.w , texArray3445.y));
			float2 temp_output_4_0_g438 = ( ( ( appendResult11_g438 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_3_Normal_Power * -1 ) );
			float dotResult5_g438 = dot( temp_output_4_0_g438 , temp_output_4_0_g438 );
			float temp_output_9_0_g438 = sqrt( ( 1.0 - saturate( dotResult5_g438 ) ) );
			float3 appendResult19_g438 = (fixed3(temp_output_4_0_g438.y , temp_output_4_0_g438.x , temp_output_9_0_g438));
			...
			float2 appendResult11_g433 = (fixed2(texArray3417.w , texArray3417.y));
			float2 temp_output_4_0_g433 = ( ( ( appendResult11_g433 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			float dotResult5_g433 = dot( temp_output_4_0_g433 , temp_output_4_0_g433 );
			float temp_output_9_0_g433 = sqrt( ( 1.0 - saturate( dotResult5_g433 ) ) );
			float3 appendResult10_g433 = (fixed3(temp_output_4_0_g433.x , temp_output_4_0_g433.y , temp_output_9_0_g433));
			float3 appendResult6874 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6408 = BlendComponents91;
			float3 weightedAvg6408 = ( ( weightedBlendVar6408.x*( appendResult19_g438 * appendResult6871 ) + weightedBlendVar6408.y*temp_output_6995_0 + weightedBlendVar6408.z*( appendResult10_g433 * appendResult6874 ) )/( weightedBlendVar6408.x + weightedBlendVar6408.y + weightedBlendVar6408.z ) );
			...
			float2 appendResult11_g947 = (fixed2(texArray3483.w , texArray3483.y));
			float2 temp_output_4_0_g947 = ( ( ( appendResult11_g947 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			...
			float3 temp_output_6998_0 = appendResult10_g947;
			float4 texArray3512 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3478_0, _Texture_4_Normal_Index)  );
			float2 appendResult11_g436 = (fixed2(texArray3512.w , texArray3512.y));
			float2 temp_output_4_0_g436 = ( ( ( appendResult11_g436 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_4_Normal_Power * -1 ) );
			float dotResult5_g436 = dot( temp_output_4_0_g436 , temp_output_4_0_g436 );
			float temp_output_9_0_g436 = sqrt( ( 1.0 - saturate( dotResult5_g436 ) ) );
			float3 appendResult19_g436 = (fixed3(temp_output_4_0_g436.y , temp_output_4_0_g436.x , temp_output_9_0_g436));
			...
			float2 appendResult11_g435 = (fixed2(texArray3484.w , texArray3484.y));
			float2 temp_output_4_0_g435 = ( ( ( appendResult11_g435 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			float dotResult5_g435 = dot( temp_output_4_0_g435 , temp_output_4_0_g435 );
			float temp_output_9_0_g435 = sqrt( ( 1.0 - saturate( dotResult5_g435 ) ) );
			float3 appendResult10_g435 = (fixed3(temp_output_4_0_g435.x , temp_output_4_0_g435.y , temp_output_9_0_g435));
			float3 appendResult6881 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6415 = BlendComponents91;
			float3 weightedAvg6415 = ( ( weightedBlendVar6415.x*( appendResult19_g436 * appendResult6878 ) + weightedBlendVar6415.y*temp_output_6998_0 + weightedBlendVar6415.z*( appendResult10_g435 * appendResult6881 ) )/( weightedBlendVar6415.x + weightedBlendVar6415.y + weightedBlendVar6415.z ) );
			...
			float2 appendResult11_g953 = (fixed2(texArray4424.w , texArray4424.y));
			float2 temp_output_4_0_g953 = ( ( ( appendResult11_g953 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
			...
			float3 temp_output_7001_0 = appendResult10_g953;
			float4 texArray4417 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4400_0, _Texture_5_Normal_Index)  );
			float2 appendResult11_g949 = (fixed2(texArray4417.w , texArray4417.y));
			float2 temp_output_4_0_g949 = ( ( ( appendResult11_g949 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_5_Normal_Power * -1 ) );
			...
			float3 appendResult19_g949 = (fixed3(temp_output_4_0_g949.y , temp_output_4_0_g949.x , temp_output_9_0_g949));
			...
			float2 appendResult11_g940 = (fixed2(texArray4422.w , texArray4422.y));
			...
			float3 weightedAvg6422 = ( ( weightedBlendVar6422.x*( appendResult19_g949 * appendResult6885 ) + weightedBlendVar6422.y*temp_output_7001_0 + weightedBlendVar6422.z*( appendResult10_g940 * appendResult6888 ) )/( weightedBlendVar6422.x + weightedBlendVar6422.y + weightedBlendVar6422.z ) );
			...
			float2 appendResult11_g955 = (fixed2(texArray4493.w , texArray4493.y));
			float2 temp_output_4_0_g955 = ( ( ( appendResult11_g955 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			...
			float3 temp_output_7004_0 = appendResult10_g955;
			float4 texArray4486 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4472_0, _Texture_6_Normal_Index)  );
			float2 appendResult11_g948 = (fixed2(texArray4486.w , texArray4486.y));
			float2 temp_output_4_0_g948 = ( ( ( appendResult11_g948 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_6_Normal_Power * -1 ) );
			...
			float2 appendResult11_g945 = (fixed2(texArray4491.w , texArray4491.y));
			float2 temp_output_4_0_g945 = ( ( ( appendResult11_g945 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			...
			float3 appendResult10_g945 = (fixed3(temp_output_4_0_g945.x , temp_output_4_0_g945.y , temp_output_9_0_g945));
			float3 appendResult6895 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6429 = BlendComponents91;
			float3 weightedAvg6429 = ( ( weightedBlendVar6429.x*( appendResult19_g948 * appendResult6892 ) + weightedBlendVar6429.y*temp_output_7004_0 + weightedBlendVar6429.z*( appendResult10_g945 * appendResult6895 ) )/( weightedBlendVar6429.x + weightedBlendVar6429.y + weightedBlendVar6429.z ) );
			...
			float2 appendResult11_g957 = (fixed2(texArray4567.w , texArray4567.y));
			float2 temp_output_4_0_g957 = ( ( ( appendResult11_g957 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
			...
			float3 temp_output_7007_0 = appendResult10_g957;
			float4 texArray4560 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4546_0, _Texture_7_Normal_Index)  );
			float2 appendResult11_g939 = (fixed2(texArray4560.w , texArray4560.y));
			float2 temp_output_4_0_g939 = ( ( ( appendResult11_g939 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_7_Normal_Power * -1 ) );
			...
			float3 appendResult19_g939 = (fixed3(temp_output_4_0_g939.y , temp_output_4_0_g939.x , temp_output_9_0_g939));
			...
			float2 appendResult11_g941 = (fixed2(texArray4565.w , texArray4565.y));
			float2 temp_output_4_0_g941 = ( ( ( appendResult11_g941 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
			...
			float3 weightedAvg6436 = ( ( weightedBlendVar6436.x*( appendResult19_g939 * appendResult6899 ) + weightedBlendVar6436.y*temp_output_7007_0 + weightedBlendVar6436.z*( appendResult10_g941 * appendResult6902 ) )/( weightedBlendVar6436.x + weightedBlendVar6436.y + weightedBlendVar6436.z ) );
			...
			float2 appendResult11_g958 = (fixed2(texArray4641.w , texArray4641.y));
			float2 temp_output_4_0_g958 = ( ( ( appendResult11_g958 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			...
			float3 temp_output_7010_0 = appendResult10_g958;
			float4 texArray4634 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4620_0, _Texture_8_Normal_Index)  );
			float2 appendResult11_g943 = (fixed2(texArray4634.w , texArray4634.y));
			float2 temp_output_4_0_g943 = ( ( ( appendResult11_g943 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_8_Normal_Power * -1 ) );
			...
			float2 appendResult11_g942 = (fixed2(texArray4639.w , texArray4639.y));
			float2 temp_output_4_0_g942 = ( ( ( appendResult11_g942 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			...
			float3 weightedAvg6443 = ( ( weightedBlendVar6443.x*( appendResult19_g943 * appendResult6906 ) + weightedBlendVar6443.y*temp_output_7010_0 + weightedBlendVar6443.z*( appendResult10_g942 * appendResult6909 ) )/( weightedBlendVar6443.x + weightedBlendVar6443.y + weightedBlendVar6443.z ) );
			...
			float2 appendResult11_g973 = (fixed2(texArray4788.w , texArray4788.y));
			float2 temp_output_4_0_g973 = ( ( ( appendResult11_g973 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 appendResult10_g973 = (fixed3(temp_output_4_0_g973.x , temp_output_4_0_g973.y , temp_output_9_0_g973));
			float3 temp_output_7034_0 = appendResult10_g973;
			float4 texArray5285 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4706_0, _Texture_9_Normal_Index)  );
			float2 appendResult11_g960 = (fixed2(texArray5285.x , texArray5285.y));
			float2 temp_output_4_0_g960 = ( ( ( appendResult11_g960 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_9_Normal_Power * -1 ) );
			float dotResult5_g960 = dot( temp_output_4_0_g960 , temp_output_4_0_g960 );
			float temp_output_9_0_g960 = sqrt( ( 1.0 - saturate( dotResult5_g960 ) ) );
			float3 appendResult19_g960 = (fixed3(temp_output_4_0_g960.y , temp_output_4_0_g960.x , temp_output_9_0_g960));
			...
			float2 appendResult11_g951 = (fixed2(texArray4783.w , texArray4783.y));
			float2 temp_output_4_0_g951 = ( ( ( appendResult11_g951 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 weightedAvg6450 = ( ( weightedBlendVar6450.x*( appendResult19_g960 * appendResult6962 ) + weightedBlendVar6450.y*temp_output_7034_0 + weightedBlendVar6450.z*( appendResult10_g951 * appendResult6965 ) )/( weightedBlendVar6450.x + weightedBlendVar6450.y + weightedBlendVar6450.z ) );
			...
			float2 appendResult11_g975 = (fixed2(texArray4822.w , texArray4822.y));
			float2 temp_output_4_0_g975 = ( ( ( appendResult11_g975 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
			...
			float3 appendResult10_g975 = (fixed3(temp_output_4_0_g975.x , temp_output_4_0_g975.y , temp_output_9_0_g975));
			float3 temp_output_7031_0 = appendResult10_g975;
			float4 texArray4798 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4742_0, _Texture_10_Normal_Index)  );
			float2 appendResult11_g961 = (fixed2(texArray4798.w , texArray4798.y));
			float2 temp_output_4_0_g961 = ( ( ( appendResult11_g961 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_10_Normal_Power * -1 ) );
			float dotResult5_g961 = dot( temp_output_4_0_g961 , temp_output_4_0_g961 );
			float temp_output_9_0_g961 = sqrt( ( 1.0 - saturate( dotResult5_g961 ) ) );
			float3 appendResult19_g961 = (fixed3(temp_output_4_0_g961.y , temp_output_4_0_g961.x , temp_output_9_0_g961));
			...
			float2 appendResult11_g956 = (fixed2(texArray4791.w , texArray4791.y));
			float2 temp_output_4_0_g956 = ( ( ( appendResult11_g956 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
			...
			float3 weightedAvg6457 = ( ( weightedBlendVar6457.x*( appendResult19_g961 * appendResult6955 ) + weightedBlendVar6457.y*temp_output_7031_0 + weightedBlendVar6457.z*( appendResult10_g956 * appendResult6958 ) )/( weightedBlendVar6457.x + weightedBlendVar6457.y + weightedBlendVar6457.z ) );
			...
			float2 appendResult11_g966 = (fixed2(texArray4856.w , texArray4856.y));
			float2 temp_output_4_0_g966 = ( ( ( appendResult11_g966 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
			...
			float3 appendResult10_g966 = (fixed3(temp_output_4_0_g966.x , temp_output_4_0_g966.y , temp_output_9_0_g966));
			float3 temp_output_7028_0 = appendResult10_g966;
			float4 texArray4828 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4748_0, _Texture_11_Normal_Index)  );
			float2 appendResult11_g962 = (fixed2(texArray4828.w , texArray4828.y));
			float2 temp_output_4_0_g962 = ( ( ( appendResult11_g962 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_11_Normal_Power * -1 ) );
			float dotResult5_g962 = dot( temp_output_4_0_g962 , temp_output_4_0_g962 );
			float temp_output_9_0_g962 = sqrt( ( 1.0 - saturate( dotResult5_g962 ) ) );
			float3 appendResult19_g962 = (fixed3(temp_output_4_0_g962.y , temp_output_4_0_g962.x , temp_output_9_0_g962));
			...
			float2 appendResult11_g952 = (fixed2(texArray4811.w , texArray4811.y));
			float2 temp_output_4_0_g952 = ( ( ( appendResult11_g952 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
			...
			float3 weightedAvg6464 = ( ( weightedBlendVar6464.x*( appendResult19_g962 * appendResult6948 ) + weightedBlendVar6464.y*temp_output_7028_0 + weightedBlendVar6464.z*( appendResult10_g952 * appendResult6951 ) )/( weightedBlendVar6464.x + weightedBlendVar6464.y + weightedBlendVar6464.z ) );
			...
			float2 appendResult11_g967 = (fixed2(texArray4870.w , texArray4870.y));
			...
			float3 appendResult10_g967 = (fixed3(temp_output_4_0_g967.x , temp_output_4_0_g967.y , temp_output_9_0_g967));
			float3 temp_output_7025_0 = appendResult10_g967;
			float4 texArray4850 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4758_0, _Texture_12_Normal_Index)  );
			float2 appendResult11_g954 = (fixed2(texArray4850.w , texArray4850.y));
			float2 temp_output_4_0_g954 = ( ( ( appendResult11_g954 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_12_Normal_Power * -1 ) );
			...
			float3 appendResult19_g954 = (fixed3(temp_output_4_0_g954.y , temp_output_4_0_g954.x , temp_output_9_0_g954));
			...
			float2 appendResult11_g959 = (fixed2(texArray4852.w , texArray4852.y));
			float2 temp_output_4_0_g959 = ( ( ( appendResult11_g959 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			float3 weightedAvg6471 = ( ( weightedBlendVar6471.x*( appendResult19_g954 * appendResult6941 ) + weightedBlendVar6471.y*temp_output_7025_0 + weightedBlendVar6471.z*( appendResult10_g959 * appendResult6944 ) )/( weightedBlendVar6471.x + weightedBlendVar6471.y + weightedBlendVar6471.z ) );
			...
			float2 appendResult11_g976 = (fixed2(texArray5120.w , texArray5120.y));
			float2 temp_output_4_0_g976 = ( ( ( appendResult11_g976 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 appendResult10_g976 = (fixed3(temp_output_4_0_g976.x , temp_output_4_0_g976.y , temp_output_9_0_g976));
			float3 temp_output_7022_0 = appendResult10_g976;
			float4 texArray5127 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5025_0, _Texture_13_Normal_Index)  );
			float2 appendResult11_g964 = (fixed2(texArray5127.w , texArray5127.y));
			float2 temp_output_4_0_g964 = ( ( ( appendResult11_g964 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_13_Normal_Power * -1 ) );
			float dotResult5_g964 = dot( temp_output_4_0_g964 , temp_output_4_0_g964 );
			float temp_output_9_0_g964 = sqrt( ( 1.0 - saturate( dotResult5_g964 ) ) );
			float3 appendResult19_g964 = (fixed3(temp_output_4_0_g964.y , temp_output_4_0_g964.x , temp_output_9_0_g964));
			...
			float2 appendResult11_g969 = (fixed2(texArray5109.w , texArray5109.y));
			float2 temp_output_4_0_g969 = ( ( ( appendResult11_g969 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 appendResult10_g969 = (fixed3(temp_output_4_0_g969.x , temp_output_4_0_g969.y , temp_output_9_0_g969));
			float3 appendResult6937 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6478 = BlendComponents91;
			float3 weightedAvg6478 = ( ( weightedBlendVar6478.x*( appendResult19_g964 * appendResult6934 ) + weightedBlendVar6478.y*temp_output_7022_0 + weightedBlendVar6478.z*( appendResult10_g969 * appendResult6937 ) )/( weightedBlendVar6478.x + weightedBlendVar6478.y + weightedBlendVar6478.z ) );
			...
			float2 appendResult11_g977 = (fixed2(texArray5178.w , texArray5178.y));
			float2 temp_output_4_0_g977 = ( ( ( appendResult11_g977 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			float dotResult5_g977 = dot( temp_output_4_0_g977 , temp_output_4_0_g977 );
			float temp_output_9_0_g977 = sqrt( ( 1.0 - saturate( dotResult5_g977 ) ) );
			float3 appendResult10_g977 = (fixed3(temp_output_4_0_g977.x , temp_output_4_0_g977.y , temp_output_9_0_g977));
			float3 temp_output_7019_0 = appendResult10_g977;
			float4 texArray5017 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5009_0, _Texture_14_Normal_Index)  );
			float2 appendResult11_g968 = (fixed2(texArray5017.w , texArray5017.y));
			float2 temp_output_4_0_g968 = ( ( ( appendResult11_g968 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_14_Normal_Power * -1 ) );
			...
			float3 appendResult19_g968 = (fixed3(temp_output_4_0_g968.y , temp_output_4_0_g968.x , temp_output_9_0_g968));
			...
			float2 appendResult11_g971 = (fixed2(texArray5170.w , texArray5170.y));
			float2 temp_output_4_0_g971 = ( ( ( appendResult11_g971 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			...
			float3 appendResult10_g971 = (fixed3(temp_output_4_0_g971.x , temp_output_4_0_g971.y , temp_output_9_0_g971));
			float3 appendResult6930 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6485 = BlendComponents91;
			float3 weightedAvg6485 = ( ( weightedBlendVar6485.x*( appendResult19_g968 * appendResult6927 ) + weightedBlendVar6485.y*temp_output_7019_0 + weightedBlendVar6485.z*( appendResult10_g971 * appendResult6930 ) )/( weightedBlendVar6485.x + weightedBlendVar6485.y + weightedBlendVar6485.z ) );
			...
			float2 appendResult11_g978 = (fixed2(texArray5246.w , texArray5246.y));
			float2 temp_output_4_0_g978 = ( ( ( appendResult11_g978 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			float dotResult5_g978 = dot( temp_output_4_0_g978 , temp_output_4_0_g978 );
			float temp_output_9_0_g978 = sqrt( ( 1.0 - saturate( dotResult5_g978 ) ) );
			float3 appendResult10_g978 = (fixed3(temp_output_4_0_g978.x , temp_output_4_0_g978.y , temp_output_9_0_g978));
			float3 temp_output_7016_0 = appendResult10_g978;
			float4 texArray5227 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5213_0, _Texture_15_Normal_Index)  );
			float2 appendResult11_g970 = (fixed2(texArray5227.w , texArray5227.y));
			float2 temp_output_4_0_g970 = ( ( ( appendResult11_g970 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_15_Normal_Power * -1 ) );
			...
			float3 appendResult19_g970 = (fixed3(temp_output_4_0_g970.y , temp_output_4_0_g970.x , temp_output_9_0_g970));
			...
			float2 appendResult11_g972 = (fixed2(texArray5250.w , texArray5250.y));
			float2 temp_output_4_0_g972 = ( ( ( appendResult11_g972 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 appendResult10_g972 = (fixed3(temp_output_4_0_g972.x , temp_output_4_0_g972.y , temp_output_9_0_g972));
			float3 appendResult6923 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6492 = BlendComponents91;
			float3 weightedAvg6492 = ( ( weightedBlendVar6492.x*( appendResult19_g970 * appendResult6920 ) + weightedBlendVar6492.y*temp_output_7016_0 + weightedBlendVar6492.z*( appendResult10_g972 * appendResult6923 ) )/( weightedBlendVar6492.x + weightedBlendVar6492.y + weightedBlendVar6492.z ) );
			...
			float2 appendResult11_g979 = (fixed2(texArray5099.w , texArray5099.y));
			float2 temp_output_4_0_g979 = ( ( ( appendResult11_g979 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			float dotResult5_g979 = dot( temp_output_4_0_g979 , temp_output_4_0_g979 );
			float temp_output_9_0_g979 = sqrt( ( 1.0 - saturate( dotResult5_g979 ) ) );
			float3 appendResult10_g979 = (fixed3(temp_output_4_0_g979.x , temp_output_4_0_g979.y , temp_output_9_0_g979));
			float3 temp_output_7013_0 = appendResult10_g979;
			float4 texArray5082 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5079_0, _Texture_16_Normal_Index)  );
			float2 appendResult11_g965 = (fixed2(texArray5082.w , texArray5082.y));
			float2 temp_output_4_0_g965 = ( ( ( appendResult11_g965 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_16_Normal_Power * -1 ) );
			...
			float3 appendResult19_g965 = (fixed3(temp_output_4_0_g965.y , temp_output_4_0_g965.x , temp_output_9_0_g965));
			...
			float2 appendResult11_g974 = (fixed2(texArray4731.w , texArray4731.y));
			float2 temp_output_4_0_g974 = ( ( ( appendResult11_g974 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			...
			float3 appendResult10_g974 = (fixed3(temp_output_4_0_g974.x , temp_output_4_0_g974.y , temp_output_9_0_g974));
			float3 appendResult6916 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6499 = BlendComponents91;
			float3 weightedAvg6499 = ( ( weightedBlendVar6499.x*( appendResult19_g965 * appendResult6913 ) + weightedBlendVar6499.y*temp_output_7013_0 + weightedBlendVar6499.z*( appendResult10_g974 * appendResult6916 ) )/( weightedBlendVar6499.x + weightedBlendVar6499.y + weightedBlendVar6499.z ) );
			...
			float2 appendResult11_g980 = (fixed2(texArray4382.w , texArray4382.y));
			float2 temp_output_4_0_g980 = ( ( ( appendResult11_g980 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Snow_Normal_Scale );
			float dotResult5_g980 = dot( temp_output_4_0_g980 , temp_output_4_0_g980 );
			float temp_output_9_0_g980 = sqrt( ( 1.0 - saturate( dotResult5_g980 ) ) );
			float3 appendResult10_g980 = (fixed3(temp_output_4_0_g980.x , temp_output_4_0_g980.y , temp_output_9_0_g980));
			fixed3 ifLocalVar7798 = 0;
			UNITY_BRANCH 
			if( _Texture_Snow_Normal_Index <= -1 )
				ifLocalVar7798 = EmptyNRM7781;
			else
				ifLocalVar7798 = appendResult10_g980;
			...
			float clampResult8066 = clamp( ( tex2DNode7984.a + ( 1.0 - _Global_Color_Opacity_Power ) ) , 0 , 1 );
			float2 appendResult7986 = (fixed2(1 , ( lerpResult7983 * clampResult8066 )));
			...
			fixed3 In08017 = float3( 0,0,0 );
			fixed localMyCustomExpression8017 = MyCustomExpression8017( In08017 );
			float temp_output_8023_0 = ( _Glitter_Refreshing_Speed * ( ( localMyCustomExpression8017 * 10 ) + ( _WorldSpaceCameraPos.x + _WorldSpaceCameraPos.y + _WorldSpaceCameraPos.z ) ) );
			float temp_output_8025_0 = ( 0 + temp_output_8023_0 );
			float clampResult8042 = clamp( sin( ( temp_output_8025_0 * 0.1 ) ) , 0 , 1 );
			float2 temp_output_8030_0 = ( Top_Bottom1999 * ( 1 / _Glitter_Tiling ) );
			float2 appendResult8061 = (fixed2(temp_output_8030_0.y , temp_output_8030_0.x));
			fixed4 tex2DNode8045 = tex2D( _Texture_Glitter, ( appendResult8061 + float2( 0.37,0.67 ) ) );
			float2 panner8032 = ( temp_output_8030_0 + ( temp_output_8023_0 * 0.01 ) * float2( 1,1 ));
			float cos8033 = cos( sin( ( temp_output_8025_0 * 0.0001 ) ) );
			float sin8033 = sin( sin( ( temp_output_8025_0 * 0.0001 ) ) );
			float2 rotator8033 = mul( panner8032 - float2( 0.5,0.5 ) , float2x2( cos8033 , -sin8033 , sin8033 , cos8033 )) + float2( 0.5,0.5 );
			float clampResult8046 = clamp( pow( tex2D( _Texture_Glitter, ( ( rotator8033 + temp_output_8030_0 ) * float2( 0.2,0.2 ) ) ).r , ( 1.0 - _Glitter_Noise_Threshold ) ) , 0 , 1 );
			float lerpResult8049 = lerp(  ( clampResult8042 - 0.2 > 0 ? tex2D( _Texture_Glitter, temp_output_8030_0 ).r : clampResult8042 - 0.2 <= 0 && clampResult8042 + 0.2 >= 0 ? tex2DNode8045.r : tex2DNode8045.r )  , 0.6 , clampResult8046);
			float clampResult8052 = clamp( pow( lerpResult8049 , 100.0 ) , 0 , 1 );
			float temp_output_8057_0 = ( _Gliter_Color_Power * clampResult8052 );
			float3 lerpResult1356 = lerp( ( saturate( ( blendOpSrc4362 + blendOpDest4362 ) )) , ( appendResult1410 + temp_output_8057_0 ) , HeightMask6539);
			...
			float clampResult8053 = clamp( temp_output_8057_0 , 0 , 1 );
			float3 lerpResult8058 = lerp( ( clampResult6245 * _Snow_Specular ) , temp_cast_3 , clampResult8053);
			...
			float lerpResult8059 = lerp( ifLocalVar7802.w , _Glitter_Smoothness , clampResult8053);
			float lerpResult3951 = lerp( ( layeredBlend6532.w * _Terrain_Smoothness ) , lerpResult8059 , HeightMask6539);
