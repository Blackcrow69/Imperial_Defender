Shader "CTS/CTS Terrain Shader Advanced LOD CutOut"
{
	...
	SubShader
	{
		...
		uniform fixed _Texture_9_H_AO_Index_AO_H_Index;
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			fixed localMyCustomExpression7741 = ( 0 );
			v.tangent.xyz = cross ( v.normal, float3( 0, 0, 1 ) );
			v.tangent.w = -1;
			fixed3 temp_cast_0 = (localMyCustomExpression7741).xxx;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult7743 = (fixed2(ase_vertex3Pos.x , ase_vertex3Pos.z));
			fixed2 Top_Bottom1999 = appendResult7743;
			...
			float2 appendResult11_g668 = (fixed2(texArray4374.w , texArray4374.y));
			...
			float3 appendResult10_g668 = (fixed3(temp_output_4_0_g668.x , temp_output_4_0_g668.y , temp_output_9_0_g668));
			float3 temp_output_7038_0 = appendResult10_g668;
			...
			fixed ifLocalVar7658 = 0;
			UNITY_BRANCH 
			if( _Texture_1_H_AO_Index > -1 )
				ifLocalVar7658 = texArray7704.g;
			fixed Texture_1_H5480 = ifLocalVar7658;
			...
			fixed ifLocalVar7662 = 0;
			UNITY_BRANCH 
			if( _Texture_2_H_AO_Index > -1 )
				ifLocalVar7662 = texArray5533.y;
			fixed Texture_2_H5497 = ifLocalVar7662;
			...
			fixed ifLocalVar7664 = 0;
			UNITY_BRANCH 
			if( _Texture_3_H_AO_Index > -1 )
				ifLocalVar7664 = texArray5586.y;
			fixed Texture_3_H5581 = ifLocalVar7664;
			...
			fixed ifLocalVar7666 = 0;
			UNITY_BRANCH 
			if( _Texture_4_H_AO_Index > -1 )
				ifLocalVar7666 = texArray5615.y;
			fixed Texture_4_H5631 = ifLocalVar7666;
			...
			float layeredBlend6518 = ( lerp( lerp( lerp( lerp( 0 , temp_output_5544_0 , layeredBlendVar6518.x ) , temp_output_5545_0 , layeredBlendVar6518.y ) , temp_output_5590_0 , layeredBlendVar6518.z ) , temp_output_6118_0 , layeredBlendVar6518.w ) );
			...
			fixed ifLocalVar7668 = 0;
			UNITY_BRANCH 
			if( _Texture_5_H_AO_Index > -1 )
				ifLocalVar7668 = texArray5655.y;
			fixed Texture_5_H5671 = ifLocalVar7668;
			...
			fixed ifLocalVar7670 = 0;
			UNITY_BRANCH 
			if( _Texture_6_H_AO_Index > -1 )
				ifLocalVar7670 = texArray5695.y;
			fixed Texture_6_H5711 = ifLocalVar7670;
			...
			fixed ifLocalVar7672 = 0;
			UNITY_BRANCH 
			if( _Texture_7_H_AO_Index > -1 )
				ifLocalVar7672 = texArray5735.y;
			fixed Texture_7_H5751 = ifLocalVar7672;
			...
			fixed ifLocalVar7674 = 0;
			UNITY_BRANCH 
			if( _Texture_8_H_AO_Index > -1 )
				ifLocalVar7674 = texArray5775.y;
			fixed Texture_8_H5791 = ifLocalVar7674;
			...
			UNITY_BRANCH 
			if( _Texture_9_H_AO_Index_AO_H_Index > -1 )
				ifLocalVar7689 = texArray5811.y;
			fixed Texture_9_H5832 = ifLocalVar7689;
			...
			fixed ifLocalVar7687 = 0;
			UNITY_BRANCH 
			if( _Texture_10_H_AO_Index > -1 )
				ifLocalVar7687 = texArray5851.y;
			fixed Texture_10_H5872 = ifLocalVar7687;
			...
			fixed ifLocalVar7685 = 0;
			UNITY_BRANCH 
			if( _Texture_11_H_AO_Index > -1 )
				ifLocalVar7685 = texArray5891.y;
			fixed Texture_11_H5912 = ifLocalVar7685;
			...
			fixed Texture_12_H5952 = ifLocalVar7683;
			...
			fixed Texture_13_H5992 = ifLocalVar7681;
			...
			fixed Texture_14_H6032 = ifLocalVar7679;
			...
			fixed ifLocalVar7677 = 0;
			UNITY_BRANCH 
			if( _Texture_15_H_AO_Index > -1 )
				ifLocalVar7677 = texArray6051.y;
			fixed Texture_15_H6072 = ifLocalVar7677;
			...
			fixed ifLocalVar7675 = 0;
			UNITY_BRANCH 
			if( _Texture_16_H_AO_Index > -1 )
				ifLocalVar7675 = texArray6091.y;
			fixed Texture_16_H6112 = ifLocalVar7675;
			...
			float2 temp_output_7717_0 = ( Top_Bottom1999 * _Snow_Noise_Tiling );
			float4 texArray7722 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Albedo, float3(temp_output_7717_0, _Texture_Snow_Noise_Index)  );
			float4 texArray7723 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Albedo, float3(( temp_output_7717_0 * float2( 0.23,0.23 ) ), _Texture_Snow_Noise_Index)  );
			float4 texArray7721 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Albedo, float3(( temp_output_7717_0 * float2( 0.53,0.53 ) ), _Texture_Snow_Noise_Index)  );
			float lerpResult7728 = lerp( 1.0 , ( texArray7722.w + texArray7723.w + texArray7721.w ) , ( _Snow_Noise_Power * 0.1 ));
			...
			float clampResult6569 = clamp( ( 1 - ( temp_output_7621_0 * 0.1 ) ) , 0.01 , 1 );
			float clampResult4146 = clamp( pow( ( ( _Snow_Amount * ( 0.1 - ( temp_output_7621_0 * 0.01 ) ) ) * SnowSlope1352 ) , clampResult6569 ) , 0 , 1 );
			...
			float lerpResult3759 = lerp( 0 , ( ( _Snow_Amount * lerpResult7728 ) * clampResult4146 ) , clampResult4263);
			...
			float3 normalizeResult3901 = normalize( UnpackScaleNormal( tex2D( _Global_Normal_Map, uv_TexCoord2588 ) ,_Global_Normalmap_Power ) );
			float3 temp_output_4100_0 = BlendNormals( lerpResult6503 , normalizeResult3901 );
			o.Normal = temp_output_4100_0;
			fixed4 tex2DNode7708 = tex2D( _Global_Color_Map, ( _Global_Color_Map_Offset + ( _Global_Color_Map_Scale * uv_TexCoord2588 ) ) );
			float clampResult7751 = clamp( ( tex2DNode7708.a + ( 1.0 - _Global_Color_Opacity_Power ) ) , 0 , 1 );
			float2 appendResult7710 = (fixed2(1 , ( _Global_Color_Map_Far_Power * clampResult7751 )));
			...
			fixed4 Texture_1_Final950 = ifLocalVar7657;
			...
			fixed4 Texture_2_Final3385 = ifLocalVar7661;
			...
			fixed4 Texture_3_Final3451 = ifLocalVar7663;
			...
			fixed4 Texture_4_Final3518 = ifLocalVar7665;
			...
			fixed4 Texture_5_Final4396 = ifLocalVar7667;
			...
			fixed4 Texture_6_Final4536 = ifLocalVar7669;
			...
			fixed4 Texture_7_Final4614 = ifLocalVar7671;
			...
			fixed4 Texture_8_Final4689 = ifLocalVar7673;
			...
			fixed4 Texture_9_Final4987 = ifLocalVar7690;
			...
			fixed4 Texture_10_Final4994 = ifLocalVar7688;
			...
			fixed4 Texture_11_Final4996 = ifLocalVar7686;
			...
			fixed4 Texture_12_Final4997 = ifLocalVar7684;
			...
			fixed4 Texture_13_Final5058 = ifLocalVar7682;
			...
			fixed4 Texture_14_Final5163 = ifLocalVar7680;
			...
			fixed4 Texture_15_Final5270 = ifLocalVar7678;
			...
			fixed4 Texture_16_Final5094 = ifLocalVar7676;
			...
			float3 appendResult7709 = (fixed3(tex2DNode7708.r , tex2DNode7708.g , tex2DNode7708.b));
			...
			float lerpResult3951 = lerp( ( layeredBlend6532.w * _Terrain_Smoothness ) , ( _Texture_Snow_Average * _Snow_Color ).w , HeightMask6539);
			o.Smoothness = lerpResult3951;
			float clampResult7695 = clamp( ( ( 1 + temp_output_4100_0.y ) * 0.5 ) , ( 1 - _Ambient_Occlusion_Power ) , 1 );
			...
			float clampResult7733 = clamp( ( ase_worldPos.y + ( 0 - _Remove_Vert_Height ) ) , 0 , 1 );
			clip( ( tex2D( _Texture_Additional_Masks, uv_Texture_Additional_Masks ).a * clampResult7733 ) - _Cutoff );
		}
