Shader "CTS/CTS Terrain Shader Advanced CutOut"
{
	...
	SubShader
	{
		...
		inline fixed MyCustomExpression8016( inout fixed3 In0 )
		{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			fixed localTangent8006 = ( 0 );
			v.tangent.xyz = cross ( v.normal, float3( 0, 0, 1 ) );
			v.tangent.w = -1;
			fixed3 temp_cast_0 = (localTangent8006).xxx;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult8003 = (fixed2(ase_vertex3Pos.x , ase_vertex3Pos.z));
			fixed2 Top_Bottom1999 = appendResult8003;
			...
			float2 appendResult11_g935 = (fixed2(texArray6256.w , texArray6256.y));
			float2 temp_output_4_0_g935 = ( ( ( appendResult11_g935 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power_Close );
			...
			float2 appendResult11_g936 = (fixed2(texArray4374.w , texArray4374.y));
			float2 temp_output_4_0_g936 = ( ( ( appendResult11_g936 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power );
			...
			float3 lerpResult6257 = lerp( appendResult10_g935 , appendResult10_g936 , UVmixDistance636);
			...
			float2 appendResult7808 = (fixed2(texArray7282.y , texArray7282.w));
			...
			float2 appendResult7806 = (fixed2(texArray5491.y , 1));
			...
			float2 appendResult8005 = (fixed2(ase_vertex3Pos.z , ase_vertex3Pos.y));
			fixed2 Front_Back1991 = appendResult8005;
			...
			float2 appendResult7810 = (fixed2(texArray7804.y , texArray7804.w));
			float2 appendResult8004 = (fixed2(ase_vertex3Pos.x , ase_vertex3Pos.y));
			fixed2 Left_Right2003 = appendResult8004;
			...
			float2 appendResult7809 = (fixed2(texArray7283.y , texArray7283.w));
			...
			float2 appendResult7805 = (fixed2(texArray5486.y , 1));
			...
			float2 appendResult7807 = (fixed2(texArray5489.y , 1));
			...
			float2 appendResult7814 = (fixed2(texArray7293.y , texArray7293.w));
			...
			float2 appendResult7924 = (fixed2(texArray5533.y , 1));
			...
			float2 appendResult7816 = (fixed2(texArray7304.y , texArray7304.w));
			...
			float2 appendResult7815 = (fixed2(texArray7294.y , texArray7294.w));
			...
			float2 appendResult7813 = (fixed2(texArray5530.y , 1));
			...
			float2 appendResult7925 = (fixed2(texArray5532.y , 1));
			...
			float2 appendResult7817 = (fixed2(texArray7310.y , texArray7310.w));
			...
			float2 appendResult7927 = (fixed2(texArray5586.y , 1));
			...
			float2 appendResult7819 = (fixed2(texArray7311.y , texArray7311.w));
			...
			float2 appendResult7818 = (fixed2(texArray7305.y , texArray7305.w));
			...
			float2 appendResult7926 = (fixed2(texArray5560.y , 1));
			...
			float2 appendResult7928 = (fixed2(texArray5572.y , 1));
			...
			float2 appendResult7826 = (fixed2(texArray7322.y , texArray7322.w));
			...
			float2 appendResult7930 = (fixed2(texArray5615.y , 1));
			...
			float2 appendResult7828 = (fixed2(texArray7323.y , texArray7323.w));
			...
			float2 appendResult7827 = (fixed2(texArray7317.y , texArray7317.w));
			...
			float2 appendResult7929 = (fixed2(texArray5596.y , 1));
			...
			float2 appendResult7931 = (fixed2(texArray5604.y , 1));
			...
			float layeredBlend7775 = ( lerp( lerp( lerp( lerp( 0 , temp_output_5544_0 , layeredBlendVar7775.x ) , temp_output_5545_0 , layeredBlendVar7775.y ) , temp_output_5590_0 , layeredBlendVar7775.z ) , temp_output_6118_0 , layeredBlendVar7775.w ) );
			...
			float2 appendResult7832 = (fixed2(texArray7334.y , texArray7334.w));
			...
			float2 appendResult7933 = (fixed2(texArray5655.y , 1));
			...
			float2 appendResult7834 = (fixed2(texArray7335.y , texArray7335.w));
			...
			float2 appendResult7833 = (fixed2(texArray7329.y , texArray7329.w));
			...
			float2 appendResult7932 = (fixed2(texArray5636.x , 1));
			...
			float2 appendResult7934 = (fixed2(texArray5644.y , 1));
			...
			float2 appendResult7838 = (fixed2(texArray7346.y , texArray7346.w));
			...
			float2 appendResult7936 = (fixed2(texArray5695.y , 1));
			...
			float2 appendResult7840 = (fixed2(texArray7347.y , texArray7347.w));
			...
			float2 appendResult7839 = (fixed2(texArray7341.y , texArray7341.w));
			...
			float2 appendResult7935 = (fixed2(texArray5676.y , 1));
			...
			float2 appendResult7937 = (fixed2(texArray5684.y , 1));
			...
			float2 appendResult7844 = (fixed2(texArray7358.y , texArray7358.w));
			...
			float2 appendResult7939 = (fixed2(texArray5735.y , 1));
			...
			float2 appendResult7846 = (fixed2(texArray7359.y , texArray7359.w));
			...
			float2 appendResult7845 = (fixed2(texArray7353.y , texArray7353.w));
			...
			float2 appendResult7938 = (fixed2(texArray5716.y , 1));
			...
			float2 appendResult7940 = (fixed2(texArray5724.y , 1));
			...
			float2 appendResult7850 = (fixed2(texArray7370.y , texArray7370.w));
			...
			float2 appendResult7942 = (fixed2(texArray5775.y , 1));
			...
			float2 appendResult7852 = (fixed2(texArray7371.y , texArray7371.w));
			...
			float2 appendResult7851 = (fixed2(texArray7365.y , texArray7365.w));
			...
			float2 appendResult7941 = (fixed2(texArray5756.y , 1));
			...
			float2 appendResult7943 = (fixed2(texArray5764.y , 1));
			...
			float2 appendResult7856 = (fixed2(texArray7382.y , texArray7382.w));
			...
			float2 appendResult7858 = (fixed2(texArray7383.y , texArray7383.w));
			...
			float2 appendResult7857 = (fixed2(texArray7377.y , texArray7377.w));
			...
			float2 appendResult7944 = (fixed2(texArray5796.y , 1));
			float2 appendResult7945 = (fixed2(texArray5811.y , 1));
			...
			float2 appendResult7946 = (fixed2(texArray5806.y , 1));
			...
			float2 appendResult7862 = (fixed2(texArray7394.y , texArray7394.w));
			...
			float2 appendResult7948 = (fixed2(texArray5851.y , 1));
			...
			float2 appendResult7864 = (fixed2(texArray7395.y , texArray7395.w));
			...
			float2 appendResult7863 = (fixed2(texArray7389.y , texArray7389.w));
			...
			float2 appendResult7947 = (fixed2(texArray5836.y , 1));
			...
			float2 appendResult7949 = (fixed2(texArray5846.y , 1));
			...
			float2 appendResult7868 = (fixed2(texArray7406.y , texArray7406.w));
			...
			float2 appendResult7951 = (fixed2(texArray5891.y , 1));
			...
			float2 appendResult7870 = (fixed2(texArray7407.y , texArray7407.w));
			...
			float2 appendResult7869 = (fixed2(texArray7401.y , texArray7401.w));
			...
			float2 appendResult7950 = (fixed2(texArray5876.y , 1));
			...
			float2 appendResult7952 = (fixed2(texArray5886.y , 1));
			...
			float2 appendResult7874 = (fixed2(texArray7418.y , texArray7418.w));
			...
			float2 appendResult7954 = (fixed2(texArray5931.y , 1));
			...
			float2 appendResult7876 = (fixed2(texArray7419.y , texArray7419.w));
			...
			float2 appendResult7875 = (fixed2(texArray7413.y , texArray7413.w));
			...
			float2 appendResult7953 = (fixed2(texArray5916.y , 1));
			...
			float2 appendResult7955 = (fixed2(texArray5926.y , 1));
			...
			float2 appendResult7880 = (fixed2(texArray7430.y , texArray7430.w));
			...
			float2 appendResult7957 = (fixed2(texArray5971.y , 1));
			...
			float2 appendResult7882 = (fixed2(texArray7431.y , texArray7431.w));
			...
			float2 appendResult7881 = (fixed2(texArray7425.y , texArray7425.w));
			...
			float2 appendResult7956 = (fixed2(texArray5956.y , 1));
			...
			float2 appendResult7958 = (fixed2(texArray5966.y , 1));
			...
			float2 appendResult7886 = (fixed2(texArray7442.y , texArray7442.w));
			...
			float2 appendResult7960 = (fixed2(texArray6011.y , 1));
			...
			float2 appendResult7888 = (fixed2(texArray7443.y , texArray7443.w));
			...
			float2 appendResult7887 = (fixed2(texArray7437.y , texArray7437.w));
			...
			float2 appendResult7959 = (fixed2(texArray5996.y , 1));
			...
			float2 appendResult7961 = (fixed2(texArray6006.y , 1));
			...
			float2 appendResult7892 = (fixed2(texArray7454.y , texArray7454.w));
			...
			float2 appendResult7963 = (fixed2(texArray6051.y , 1));
			...
			float2 appendResult7894 = (fixed2(texArray7455.y , texArray7455.w));
			...
			float2 appendResult7893 = (fixed2(texArray7449.y , texArray7449.w));
			...
			float2 appendResult7962 = (fixed2(texArray6036.y , 1));
			...
			float2 appendResult7964 = (fixed2(texArray6046.y , 1));
			...
			float2 appendResult7898 = (fixed2(texArray7466.y , texArray7466.w));
			...
			float2 appendResult7966 = (fixed2(texArray6091.y , 1));
			...
			float2 appendResult7900 = (fixed2(texArray7467.y , texArray7467.w));
			...
			float2 appendResult7899 = (fixed2(texArray7461.y , texArray7461.w));
			...
			float2 appendResult7965 = (fixed2(texArray6076.y , 1));
			...
			float2 appendResult7967 = (fixed2(texArray6086.y , 1));
			...
			float2 appendResult11_g883 = (fixed2(texArray3300.w , texArray3300.y));
			float2 temp_output_4_0_g883 = ( ( ( appendResult11_g883 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			float dotResult5_g883 = dot( temp_output_4_0_g883 , temp_output_4_0_g883 );
			float temp_output_9_0_g883 = sqrt( ( 1.0 - saturate( dotResult5_g883 ) ) );
			float3 appendResult10_g883 = (fixed3(temp_output_4_0_g883.x , temp_output_4_0_g883.y , temp_output_9_0_g883));
			float3 temp_output_6989_0 = appendResult10_g883;
			float4 texArray3299 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3279_0, _Texture_1_Normal_Index)  );
			float2 appendResult11_g409 = (fixed2(texArray3299.w , texArray3299.y));
			float2 temp_output_4_0_g409 = ( ( ( appendResult11_g409 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_1_Normal_Power * -1 ) );
			float dotResult5_g409 = dot( temp_output_4_0_g409 , temp_output_4_0_g409 );
			float temp_output_9_0_g409 = sqrt( ( 1.0 - saturate( dotResult5_g409 ) ) );
			float3 appendResult19_g409 = (fixed3(temp_output_4_0_g409.y , temp_output_4_0_g409.x , temp_output_9_0_g409));
			...
			float2 appendResult11_g411 = (fixed2(texArray3301.w , texArray3301.y));
			float2 temp_output_4_0_g411 = ( ( ( appendResult11_g411 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			float dotResult5_g411 = dot( temp_output_4_0_g411 , temp_output_4_0_g411 );
			float temp_output_9_0_g411 = sqrt( ( 1.0 - saturate( dotResult5_g411 ) ) );
			float3 appendResult10_g411 = (fixed3(temp_output_4_0_g411.x , temp_output_4_0_g411.y , temp_output_9_0_g411));
			float3 appendResult6860 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6393 = BlendComponents91;
			float3 weightedAvg6393 = ( ( weightedBlendVar6393.x*( appendResult19_g409 * appendResult6857 ) + weightedBlendVar6393.y*temp_output_6989_0 + weightedBlendVar6393.z*( appendResult10_g411 * appendResult6860 ) )/( weightedBlendVar6393.x + weightedBlendVar6393.y + weightedBlendVar6393.z ) );
			...
			float2 appendResult11_g884 = (fixed2(texArray3350.w , texArray3350.y));
			float2 temp_output_4_0_g884 = ( ( ( appendResult11_g884 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			float dotResult5_g884 = dot( temp_output_4_0_g884 , temp_output_4_0_g884 );
			float temp_output_9_0_g884 = sqrt( ( 1.0 - saturate( dotResult5_g884 ) ) );
			float3 appendResult10_g884 = (fixed3(temp_output_4_0_g884.x , temp_output_4_0_g884.y , temp_output_9_0_g884));
			float3 temp_output_6992_0 = appendResult10_g884;
			float4 texArray3384 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3344_0, _Texture_2_Normal_Index)  );
			float2 appendResult11_g405 = (fixed2(texArray3384.w , texArray3384.y));
			float2 temp_output_4_0_g405 = ( ( ( appendResult11_g405 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_2_Normal_Power * -1 ) );
			float dotResult5_g405 = dot( temp_output_4_0_g405 , temp_output_4_0_g405 );
			float temp_output_9_0_g405 = sqrt( ( 1.0 - saturate( dotResult5_g405 ) ) );
			float3 appendResult19_g405 = (fixed3(temp_output_4_0_g405.y , temp_output_4_0_g405.x , temp_output_9_0_g405));
			...
			float2 appendResult11_g406 = (fixed2(texArray3351.w , texArray3351.y));
			float2 temp_output_4_0_g406 = ( ( ( appendResult11_g406 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			float dotResult5_g406 = dot( temp_output_4_0_g406 , temp_output_4_0_g406 );
			float temp_output_9_0_g406 = sqrt( ( 1.0 - saturate( dotResult5_g406 ) ) );
			float3 appendResult10_g406 = (fixed3(temp_output_4_0_g406.x , temp_output_4_0_g406.y , temp_output_9_0_g406));
			float3 appendResult6867 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6401 = BlendComponents91;
			float3 weightedAvg6401 = ( ( weightedBlendVar6401.x*( appendResult19_g405 * appendResult6864 ) + weightedBlendVar6401.y*temp_output_6992_0 + weightedBlendVar6401.z*( appendResult10_g406 * appendResult6867 ) )/( weightedBlendVar6401.x + weightedBlendVar6401.y + weightedBlendVar6401.z ) );
			...
			float2 appendResult11_g891 = (fixed2(texArray3416.w , texArray3416.y));
			float2 temp_output_4_0_g891 = ( ( ( appendResult11_g891 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			float dotResult5_g891 = dot( temp_output_4_0_g891 , temp_output_4_0_g891 );
			float temp_output_9_0_g891 = sqrt( ( 1.0 - saturate( dotResult5_g891 ) ) );
			float3 appendResult10_g891 = (fixed3(temp_output_4_0_g891.x , temp_output_4_0_g891.y , temp_output_9_0_g891));
			float3 temp_output_6995_0 = appendResult10_g891;
			float4 texArray3445 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3411_0, _Texture_3_Normal_Index)  );
			float2 appendResult11_g404 = (fixed2(texArray3445.w , texArray3445.y));
			float2 temp_output_4_0_g404 = ( ( ( appendResult11_g404 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_3_Normal_Power * -1 ) );
			float dotResult5_g404 = dot( temp_output_4_0_g404 , temp_output_4_0_g404 );
			float temp_output_9_0_g404 = sqrt( ( 1.0 - saturate( dotResult5_g404 ) ) );
			float3 appendResult19_g404 = (fixed3(temp_output_4_0_g404.y , temp_output_4_0_g404.x , temp_output_9_0_g404));
			...
			float2 appendResult11_g410 = (fixed2(texArray3417.w , texArray3417.y));
			float2 temp_output_4_0_g410 = ( ( ( appendResult11_g410 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			float dotResult5_g410 = dot( temp_output_4_0_g410 , temp_output_4_0_g410 );
			float temp_output_9_0_g410 = sqrt( ( 1.0 - saturate( dotResult5_g410 ) ) );
			float3 appendResult10_g410 = (fixed3(temp_output_4_0_g410.x , temp_output_4_0_g410.y , temp_output_9_0_g410));
			float3 appendResult6874 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6408 = BlendComponents91;
			float3 weightedAvg6408 = ( ( weightedBlendVar6408.x*( appendResult19_g404 * appendResult6871 ) + weightedBlendVar6408.y*temp_output_6995_0 + weightedBlendVar6408.z*( appendResult10_g410 * appendResult6874 ) )/( weightedBlendVar6408.x + weightedBlendVar6408.y + weightedBlendVar6408.z ) );
			...
			float2 appendResult11_g881 = (fixed2(texArray3483.w , texArray3483.y));
			float2 temp_output_4_0_g881 = ( ( ( appendResult11_g881 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			float dotResult5_g881 = dot( temp_output_4_0_g881 , temp_output_4_0_g881 );
			float temp_output_9_0_g881 = sqrt( ( 1.0 - saturate( dotResult5_g881 ) ) );
			float3 appendResult10_g881 = (fixed3(temp_output_4_0_g881.x , temp_output_4_0_g881.y , temp_output_9_0_g881));
			float3 temp_output_6998_0 = appendResult10_g881;
			float4 texArray3512 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3478_0, _Texture_4_Normal_Index)  );
			float2 appendResult11_g407 = (fixed2(texArray3512.w , texArray3512.y));
			float2 temp_output_4_0_g407 = ( ( ( appendResult11_g407 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_4_Normal_Power * -1 ) );
			float dotResult5_g407 = dot( temp_output_4_0_g407 , temp_output_4_0_g407 );
			float temp_output_9_0_g407 = sqrt( ( 1.0 - saturate( dotResult5_g407 ) ) );
			float3 appendResult19_g407 = (fixed3(temp_output_4_0_g407.y , temp_output_4_0_g407.x , temp_output_9_0_g407));
			...
			float2 appendResult11_g408 = (fixed2(texArray3484.w , texArray3484.y));
			float2 temp_output_4_0_g408 = ( ( ( appendResult11_g408 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			float dotResult5_g408 = dot( temp_output_4_0_g408 , temp_output_4_0_g408 );
			float temp_output_9_0_g408 = sqrt( ( 1.0 - saturate( dotResult5_g408 ) ) );
			float3 appendResult10_g408 = (fixed3(temp_output_4_0_g408.x , temp_output_4_0_g408.y , temp_output_9_0_g408));
			float3 appendResult6881 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6415 = BlendComponents91;
			float3 weightedAvg6415 = ( ( weightedBlendVar6415.x*( appendResult19_g407 * appendResult6878 ) + weightedBlendVar6415.y*temp_output_6998_0 + weightedBlendVar6415.z*( appendResult10_g408 * appendResult6881 ) )/( weightedBlendVar6415.x + weightedBlendVar6415.y + weightedBlendVar6415.z ) );
			...
			float2 appendResult11_g917 = (fixed2(texArray4424.w , texArray4424.y));
			float2 temp_output_4_0_g917 = ( ( ( appendResult11_g917 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
			...
			float3 appendResult10_g917 = (fixed3(temp_output_4_0_g917.x , temp_output_4_0_g917.y , temp_output_9_0_g917));
			float3 temp_output_7001_0 = appendResult10_g917;
			float4 texArray4417 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4400_0, _Texture_5_Normal_Index)  );
			float2 appendResult11_g879 = (fixed2(texArray4417.w , texArray4417.y));
			float2 temp_output_4_0_g879 = ( ( ( appendResult11_g879 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_5_Normal_Power * -1 ) );
			float dotResult5_g879 = dot( temp_output_4_0_g879 , temp_output_4_0_g879 );
			float temp_output_9_0_g879 = sqrt( ( 1.0 - saturate( dotResult5_g879 ) ) );
			float3 appendResult19_g879 = (fixed3(temp_output_4_0_g879.y , temp_output_4_0_g879.x , temp_output_9_0_g879));
			...
			float2 appendResult11_g889 = (fixed2(texArray4422.w , texArray4422.y));
			float2 temp_output_4_0_g889 = ( ( ( appendResult11_g889 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
			float dotResult5_g889 = dot( temp_output_4_0_g889 , temp_output_4_0_g889 );
			float temp_output_9_0_g889 = sqrt( ( 1.0 - saturate( dotResult5_g889 ) ) );
			float3 appendResult10_g889 = (fixed3(temp_output_4_0_g889.x , temp_output_4_0_g889.y , temp_output_9_0_g889));
			float3 appendResult6888 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6422 = BlendComponents91;
			float3 weightedAvg6422 = ( ( weightedBlendVar6422.x*( appendResult19_g879 * appendResult6885 ) + weightedBlendVar6422.y*temp_output_7001_0 + weightedBlendVar6422.z*( appendResult10_g889 * appendResult6888 ) )/( weightedBlendVar6422.x + weightedBlendVar6422.y + weightedBlendVar6422.z ) );
			...
			float2 appendResult11_g910 = (fixed2(texArray4493.w , texArray4493.y));
			float2 temp_output_4_0_g910 = ( ( ( appendResult11_g910 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			float dotResult5_g910 = dot( temp_output_4_0_g910 , temp_output_4_0_g910 );
			float temp_output_9_0_g910 = sqrt( ( 1.0 - saturate( dotResult5_g910 ) ) );
			float3 appendResult10_g910 = (fixed3(temp_output_4_0_g910.x , temp_output_4_0_g910.y , temp_output_9_0_g910));
			float3 temp_output_7004_0 = appendResult10_g910;
			float4 texArray4486 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4472_0, _Texture_6_Normal_Index)  );
			float2 appendResult11_g890 = (fixed2(texArray4486.w , texArray4486.y));
			float2 temp_output_4_0_g890 = ( ( ( appendResult11_g890 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_6_Normal_Power * -1 ) );
			float dotResult5_g890 = dot( temp_output_4_0_g890 , temp_output_4_0_g890 );
			float temp_output_9_0_g890 = sqrt( ( 1.0 - saturate( dotResult5_g890 ) ) );
			float3 appendResult19_g890 = (fixed3(temp_output_4_0_g890.y , temp_output_4_0_g890.x , temp_output_9_0_g890));
			...
			float2 appendResult11_g882 = (fixed2(texArray4491.w , texArray4491.y));
			float2 temp_output_4_0_g882 = ( ( ( appendResult11_g882 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			float dotResult5_g882 = dot( temp_output_4_0_g882 , temp_output_4_0_g882 );
			float temp_output_9_0_g882 = sqrt( ( 1.0 - saturate( dotResult5_g882 ) ) );
			float3 appendResult10_g882 = (fixed3(temp_output_4_0_g882.x , temp_output_4_0_g882.y , temp_output_9_0_g882));
			float3 appendResult6895 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6429 = BlendComponents91;
			float3 weightedAvg6429 = ( ( weightedBlendVar6429.x*( appendResult19_g890 * appendResult6892 ) + weightedBlendVar6429.y*temp_output_7004_0 + weightedBlendVar6429.z*( appendResult10_g882 * appendResult6895 ) )/( weightedBlendVar6429.x + weightedBlendVar6429.y + weightedBlendVar6429.z ) );
			...
			float2 appendResult11_g913 = (fixed2(texArray4567.w , texArray4567.y));
			float2 temp_output_4_0_g913 = ( ( ( appendResult11_g913 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
			float dotResult5_g913 = dot( temp_output_4_0_g913 , temp_output_4_0_g913 );
			float temp_output_9_0_g913 = sqrt( ( 1.0 - saturate( dotResult5_g913 ) ) );
			float3 appendResult10_g913 = (fixed3(temp_output_4_0_g913.x , temp_output_4_0_g913.y , temp_output_9_0_g913));
			float3 temp_output_7007_0 = appendResult10_g913;
			float4 texArray4560 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4546_0, _Texture_7_Normal_Index)  );
			float2 appendResult11_g885 = (fixed2(texArray4560.w , texArray4560.y));
			float2 temp_output_4_0_g885 = ( ( ( appendResult11_g885 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_7_Normal_Power * -1 ) );
			float dotResult5_g885 = dot( temp_output_4_0_g885 , temp_output_4_0_g885 );
			float temp_output_9_0_g885 = sqrt( ( 1.0 - saturate( dotResult5_g885 ) ) );
			float3 appendResult19_g885 = (fixed3(temp_output_4_0_g885.y , temp_output_4_0_g885.x , temp_output_9_0_g885));
			...
			float2 appendResult11_g886 = (fixed2(texArray4565.w , texArray4565.y));
			float2 temp_output_4_0_g886 = ( ( ( appendResult11_g886 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
			float dotResult5_g886 = dot( temp_output_4_0_g886 , temp_output_4_0_g886 );
			float temp_output_9_0_g886 = sqrt( ( 1.0 - saturate( dotResult5_g886 ) ) );
			float3 appendResult10_g886 = (fixed3(temp_output_4_0_g886.x , temp_output_4_0_g886.y , temp_output_9_0_g886));
			float3 appendResult6902 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6436 = BlendComponents91;
			float3 weightedAvg6436 = ( ( weightedBlendVar6436.x*( appendResult19_g885 * appendResult6899 ) + weightedBlendVar6436.y*temp_output_7007_0 + weightedBlendVar6436.z*( appendResult10_g886 * appendResult6902 ) )/( weightedBlendVar6436.x + weightedBlendVar6436.y + weightedBlendVar6436.z ) );
			...
			float2 appendResult11_g916 = (fixed2(texArray4641.w , texArray4641.y));
			float2 temp_output_4_0_g916 = ( ( ( appendResult11_g916 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			...
			float3 temp_output_7010_0 = appendResult10_g916;
			float4 texArray4634 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4620_0, _Texture_8_Normal_Index)  );
			float2 appendResult11_g888 = (fixed2(texArray4634.w , texArray4634.y));
			float2 temp_output_4_0_g888 = ( ( ( appendResult11_g888 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_8_Normal_Power * -1 ) );
			float dotResult5_g888 = dot( temp_output_4_0_g888 , temp_output_4_0_g888 );
			float temp_output_9_0_g888 = sqrt( ( 1.0 - saturate( dotResult5_g888 ) ) );
			float3 appendResult19_g888 = (fixed3(temp_output_4_0_g888.y , temp_output_4_0_g888.x , temp_output_9_0_g888));
			...
			float2 appendResult11_g887 = (fixed2(texArray4639.w , texArray4639.y));
			float2 temp_output_4_0_g887 = ( ( ( appendResult11_g887 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			float dotResult5_g887 = dot( temp_output_4_0_g887 , temp_output_4_0_g887 );
			float temp_output_9_0_g887 = sqrt( ( 1.0 - saturate( dotResult5_g887 ) ) );
			float3 appendResult10_g887 = (fixed3(temp_output_4_0_g887.x , temp_output_4_0_g887.y , temp_output_9_0_g887));
			float3 appendResult6909 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6443 = BlendComponents91;
			float3 weightedAvg6443 = ( ( weightedBlendVar6443.x*( appendResult19_g888 * appendResult6906 ) + weightedBlendVar6443.y*temp_output_7010_0 + weightedBlendVar6443.z*( appendResult10_g887 * appendResult6909 ) )/( weightedBlendVar6443.x + weightedBlendVar6443.y + weightedBlendVar6443.z ) );
			...
			float2 appendResult11_g918 = (fixed2(texArray4788.w , texArray4788.y));
			float2 temp_output_4_0_g918 = ( ( ( appendResult11_g918 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 appendResult10_g918 = (fixed3(temp_output_4_0_g918.x , temp_output_4_0_g918.y , temp_output_9_0_g918));
			float3 temp_output_7034_0 = appendResult10_g918;
			float4 texArray5285 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4706_0, _Texture_9_Normal_Index)  );
			float2 appendResult11_g909 = (fixed2(texArray5285.x , texArray5285.y));
			float2 temp_output_4_0_g909 = ( ( ( appendResult11_g909 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_9_Normal_Power * -1 ) );
			float dotResult5_g909 = dot( temp_output_4_0_g909 , temp_output_4_0_g909 );
			float temp_output_9_0_g909 = sqrt( ( 1.0 - saturate( dotResult5_g909 ) ) );
			float3 appendResult19_g909 = (fixed3(temp_output_4_0_g909.y , temp_output_4_0_g909.x , temp_output_9_0_g909));
			...
			float2 appendResult11_g908 = (fixed2(texArray4783.w , texArray4783.y));
			float2 temp_output_4_0_g908 = ( ( ( appendResult11_g908 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			float dotResult5_g908 = dot( temp_output_4_0_g908 , temp_output_4_0_g908 );
			float temp_output_9_0_g908 = sqrt( ( 1.0 - saturate( dotResult5_g908 ) ) );
			float3 appendResult10_g908 = (fixed3(temp_output_4_0_g908.x , temp_output_4_0_g908.y , temp_output_9_0_g908));
			float3 appendResult6965 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6450 = BlendComponents91;
			float3 weightedAvg6450 = ( ( weightedBlendVar6450.x*( appendResult19_g909 * appendResult6962 ) + weightedBlendVar6450.y*temp_output_7034_0 + weightedBlendVar6450.z*( appendResult10_g908 * appendResult6965 ) )/( weightedBlendVar6450.x + weightedBlendVar6450.y + weightedBlendVar6450.z ) );
			...
			float2 appendResult11_g928 = (fixed2(texArray4822.w , texArray4822.y));
			float2 temp_output_4_0_g928 = ( ( ( appendResult11_g928 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
			float dotResult5_g928 = dot( temp_output_4_0_g928 , temp_output_4_0_g928 );
			float temp_output_9_0_g928 = sqrt( ( 1.0 - saturate( dotResult5_g928 ) ) );
			float3 appendResult10_g928 = (fixed3(temp_output_4_0_g928.x , temp_output_4_0_g928.y , temp_output_9_0_g928));
			float3 temp_output_7031_0 = appendResult10_g928;
			float4 texArray4798 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4742_0, _Texture_10_Normal_Index)  );
			float2 appendResult11_g914 = (fixed2(texArray4798.w , texArray4798.y));
			float2 temp_output_4_0_g914 = ( ( ( appendResult11_g914 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_10_Normal_Power * -1 ) );
			...
			float3 appendResult19_g914 = (fixed3(temp_output_4_0_g914.y , temp_output_4_0_g914.x , temp_output_9_0_g914));
			...
			float2 appendResult11_g911 = (fixed2(texArray4791.w , texArray4791.y));
			float2 temp_output_4_0_g911 = ( ( ( appendResult11_g911 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
			float dotResult5_g911 = dot( temp_output_4_0_g911 , temp_output_4_0_g911 );
			float temp_output_9_0_g911 = sqrt( ( 1.0 - saturate( dotResult5_g911 ) ) );
			float3 appendResult10_g911 = (fixed3(temp_output_4_0_g911.x , temp_output_4_0_g911.y , temp_output_9_0_g911));
			float3 appendResult6958 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6457 = BlendComponents91;
			float3 weightedAvg6457 = ( ( weightedBlendVar6457.x*( appendResult19_g914 * appendResult6955 ) + weightedBlendVar6457.y*temp_output_7031_0 + weightedBlendVar6457.z*( appendResult10_g911 * appendResult6958 ) )/( weightedBlendVar6457.x + weightedBlendVar6457.y + weightedBlendVar6457.z ) );
			...
			float2 appendResult11_g925 = (fixed2(texArray4856.w , texArray4856.y));
			float2 temp_output_4_0_g925 = ( ( ( appendResult11_g925 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
			...
			float3 temp_output_7028_0 = appendResult10_g925;
			float4 texArray4828 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4748_0, _Texture_11_Normal_Index)  );
			float2 appendResult11_g907 = (fixed2(texArray4828.w , texArray4828.y));
			float2 temp_output_4_0_g907 = ( ( ( appendResult11_g907 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_11_Normal_Power * -1 ) );
			float dotResult5_g907 = dot( temp_output_4_0_g907 , temp_output_4_0_g907 );
			float temp_output_9_0_g907 = sqrt( ( 1.0 - saturate( dotResult5_g907 ) ) );
			float3 appendResult19_g907 = (fixed3(temp_output_4_0_g907.y , temp_output_4_0_g907.x , temp_output_9_0_g907));
			...
			float2 appendResult11_g915 = (fixed2(texArray4811.w , texArray4811.y));
			float2 temp_output_4_0_g915 = ( ( ( appendResult11_g915 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
			...
			float3 weightedAvg6464 = ( ( weightedBlendVar6464.x*( appendResult19_g907 * appendResult6948 ) + weightedBlendVar6464.y*temp_output_7028_0 + weightedBlendVar6464.z*( appendResult10_g915 * appendResult6951 ) )/( weightedBlendVar6464.x + weightedBlendVar6464.y + weightedBlendVar6464.z ) );
			...
			float2 appendResult11_g921 = (fixed2(texArray4870.w , texArray4870.y));
			float2 temp_output_4_0_g921 = ( ( ( appendResult11_g921 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			float3 appendResult10_g921 = (fixed3(temp_output_4_0_g921.x , temp_output_4_0_g921.y , temp_output_9_0_g921));
			float3 temp_output_7025_0 = appendResult10_g921;
			float4 texArray4850 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4758_0, _Texture_12_Normal_Index)  );
			float2 appendResult11_g912 = (fixed2(texArray4850.w , texArray4850.y));
			float2 temp_output_4_0_g912 = ( ( ( appendResult11_g912 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_12_Normal_Power * -1 ) );
			float dotResult5_g912 = dot( temp_output_4_0_g912 , temp_output_4_0_g912 );
			float temp_output_9_0_g912 = sqrt( ( 1.0 - saturate( dotResult5_g912 ) ) );
			float3 appendResult19_g912 = (fixed3(temp_output_4_0_g912.y , temp_output_4_0_g912.x , temp_output_9_0_g912));
			...
			float2 appendResult11_g906 = (fixed2(texArray4852.w , texArray4852.y));
			float2 temp_output_4_0_g906 = ( ( ( appendResult11_g906 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			float dotResult5_g906 = dot( temp_output_4_0_g906 , temp_output_4_0_g906 );
			float temp_output_9_0_g906 = sqrt( ( 1.0 - saturate( dotResult5_g906 ) ) );
			float3 appendResult10_g906 = (fixed3(temp_output_4_0_g906.x , temp_output_4_0_g906.y , temp_output_9_0_g906));
			float3 appendResult6944 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6471 = BlendComponents91;
			float3 weightedAvg6471 = ( ( weightedBlendVar6471.x*( appendResult19_g912 * appendResult6941 ) + weightedBlendVar6471.y*temp_output_7025_0 + weightedBlendVar6471.z*( appendResult10_g906 * appendResult6944 ) )/( weightedBlendVar6471.x + weightedBlendVar6471.y + weightedBlendVar6471.z ) );
			...
			float2 appendResult11_g930 = (fixed2(texArray5120.w , texArray5120.y));
			float2 temp_output_4_0_g930 = ( ( ( appendResult11_g930 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 temp_output_7022_0 = appendResult10_g930;
			float4 texArray5127 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5025_0, _Texture_13_Normal_Index)  );
			float2 appendResult11_g920 = (fixed2(texArray5127.w , texArray5127.y));
			float2 temp_output_4_0_g920 = ( ( ( appendResult11_g920 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_13_Normal_Power * -1 ) );
			...
			float3 appendResult19_g920 = (fixed3(temp_output_4_0_g920.y , temp_output_4_0_g920.x , temp_output_9_0_g920));
			...
			float2 appendResult11_g926 = (fixed2(texArray5109.w , texArray5109.y));
			float2 temp_output_4_0_g926 = ( ( ( appendResult11_g926 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 weightedAvg6478 = ( ( weightedBlendVar6478.x*( appendResult19_g920 * appendResult6934 ) + weightedBlendVar6478.y*temp_output_7022_0 + weightedBlendVar6478.z*( appendResult10_g926 * appendResult6937 ) )/( weightedBlendVar6478.x + weightedBlendVar6478.y + weightedBlendVar6478.z ) );
			...
			float2 appendResult11_g931 = (fixed2(texArray5178.w , texArray5178.y));
			float2 temp_output_4_0_g931 = ( ( ( appendResult11_g931 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			...
			float3 temp_output_7019_0 = appendResult10_g931;
			float4 texArray5017 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5009_0, _Texture_14_Normal_Index)  );
			float2 appendResult11_g924 = (fixed2(texArray5017.w , texArray5017.y));
			float2 temp_output_4_0_g924 = ( ( ( appendResult11_g924 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_14_Normal_Power * -1 ) );
			...
			float3 appendResult19_g924 = (fixed3(temp_output_4_0_g924.y , temp_output_4_0_g924.x , temp_output_9_0_g924));
			...
			float2 appendResult11_g927 = (fixed2(texArray5170.w , texArray5170.y));
			float2 temp_output_4_0_g927 = ( ( ( appendResult11_g927 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			...
			float3 appendResult10_g927 = (fixed3(temp_output_4_0_g927.x , temp_output_4_0_g927.y , temp_output_9_0_g927));
			float3 appendResult6930 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6485 = BlendComponents91;
			float3 weightedAvg6485 = ( ( weightedBlendVar6485.x*( appendResult19_g924 * appendResult6927 ) + weightedBlendVar6485.y*temp_output_7019_0 + weightedBlendVar6485.z*( appendResult10_g927 * appendResult6930 ) )/( weightedBlendVar6485.x + weightedBlendVar6485.y + weightedBlendVar6485.z ) );
			...
			float2 appendResult11_g933 = (fixed2(texArray5246.w , texArray5246.y));
			float2 temp_output_4_0_g933 = ( ( ( appendResult11_g933 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 temp_output_7016_0 = appendResult10_g933;
			float4 texArray5227 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5213_0, _Texture_15_Normal_Index)  );
			float2 appendResult11_g922 = (fixed2(texArray5227.w , texArray5227.y));
			float2 temp_output_4_0_g922 = ( ( ( appendResult11_g922 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_15_Normal_Power * -1 ) );
			...
			float3 appendResult19_g922 = (fixed3(temp_output_4_0_g922.y , temp_output_4_0_g922.x , temp_output_9_0_g922));
			...
			float2 appendResult11_g919 = (fixed2(texArray5250.w , texArray5250.y));
			float2 temp_output_4_0_g919 = ( ( ( appendResult11_g919 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 appendResult10_g919 = (fixed3(temp_output_4_0_g919.x , temp_output_4_0_g919.y , temp_output_9_0_g919));
			float3 appendResult6923 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6492 = BlendComponents91;
			float3 weightedAvg6492 = ( ( weightedBlendVar6492.x*( appendResult19_g922 * appendResult6920 ) + weightedBlendVar6492.y*temp_output_7016_0 + weightedBlendVar6492.z*( appendResult10_g919 * appendResult6923 ) )/( weightedBlendVar6492.x + weightedBlendVar6492.y + weightedBlendVar6492.z ) );
			...
			float2 appendResult11_g932 = (fixed2(texArray5099.w , texArray5099.y));
			float2 temp_output_4_0_g932 = ( ( ( appendResult11_g932 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			...
			float3 temp_output_7013_0 = appendResult10_g932;
			float4 texArray5082 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5079_0, _Texture_16_Normal_Index)  );
			float2 appendResult11_g929 = (fixed2(texArray5082.w , texArray5082.y));
			float2 temp_output_4_0_g929 = ( ( ( appendResult11_g929 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_16_Normal_Power * -1 ) );
			...
			float2 appendResult11_g923 = (fixed2(texArray4731.w , texArray4731.y));
			float2 temp_output_4_0_g923 = ( ( ( appendResult11_g923 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			...
			float3 weightedAvg6499 = ( ( weightedBlendVar6499.x*( appendResult19_g929 * appendResult6913 ) + weightedBlendVar6499.y*temp_output_7013_0 + weightedBlendVar6499.z*( appendResult10_g923 * appendResult6916 ) )/( weightedBlendVar6499.x + weightedBlendVar6499.y + weightedBlendVar6499.z ) );
			...
			float2 appendResult11_g934 = (fixed2(texArray4382.w , texArray4382.y));
			float2 temp_output_4_0_g934 = ( ( ( appendResult11_g934 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Snow_Normal_Scale );
			...
			if( _Texture_Snow_Normal_Index <= -1 )
				...
				ifLocalVar7798 = appendResult10_g934;
			...
			fixed4 tex2DNode7984 = tex2D( _Global_Color_Map, ( _Global_Color_Map_Offset + ( _Global_Color_Map_Scale * uv_TexCoord2588 ) ) );
			float clampResult8065 = clamp( ( tex2DNode7984.a + ( 1.0 - _Global_Color_Opacity_Power ) ) , 0 , 1 );
			float2 appendResult7986 = (fixed2(1 , ( lerpResult7983 * clampResult8065 )));
			...
			float3 appendResult7985 = (fixed3(tex2DNode7984.r , tex2DNode7984.g , tex2DNode7984.b));
			...
			float3 appendResult6970 = (fixed3(tex2DNode6968.r , tex2DNode6968.g , tex2DNode6968.b));
			...
			float3 appendResult1410 = (fixed3(ifLocalVar7802.x , ifLocalVar7802.y , ifLocalVar7802.z));
			fixed3 In08016 = float3( 0,0,0 );
			fixed localMyCustomExpression8016 = MyCustomExpression8016( In08016 );
			float temp_output_8022_0 = ( _Glitter_Refreshing_Speed * ( ( localMyCustomExpression8016 * 10 ) + ( _WorldSpaceCameraPos.x + _WorldSpaceCameraPos.y + _WorldSpaceCameraPos.z ) ) );
			float temp_output_8024_0 = ( 0 + temp_output_8022_0 );
			float clampResult8041 = clamp( sin( ( temp_output_8024_0 * 0.1 ) ) , 0 , 1 );
			float2 temp_output_8029_0 = ( Top_Bottom1999 * ( 1 / _Glitter_Tiling ) );
			float2 appendResult8060 = (fixed2(temp_output_8029_0.y , temp_output_8029_0.x));
			fixed4 tex2DNode8044 = tex2D( _Texture_Glitter, ( appendResult8060 + float2( 0.37,0.67 ) ) );
			float2 panner8031 = ( temp_output_8029_0 + ( temp_output_8022_0 * 0.01 ) * float2( 1,1 ));
			...
			float clampResult8045 = clamp( pow( tex2D( _Texture_Glitter, ( ( rotator8032 + temp_output_8029_0 ) * float2( 0.2,0.2 ) ) ).r , ( 1.0 - _Glitter_Noise_Threshold ) ) , 0 , 1 );
			float lerpResult8048 = lerp(  ( clampResult8041 - 0.2 > 0 ? tex2D( _Texture_Glitter, temp_output_8029_0 ).r : clampResult8041 - 0.2 <= 0 && clampResult8041 + 0.2 >= 0 ? tex2DNode8044.r : tex2DNode8044.r )  , 0.6 , clampResult8045);
			float clampResult8051 = clamp( pow( lerpResult8048 , 100.0 ) , 0 , 1 );
			...
			fixed3 temp_cast_3 = (_Glitter_Specular).xxx;
			float clampResult8052 = clamp( temp_output_8056_0 , 0 , 1 );
			...
			float lerpResult8058 = lerp( ifLocalVar7802.w , _Glitter_Smoothness , clampResult8052);
			float lerpResult3951 = lerp( ( layeredBlend6532.w * _Terrain_Smoothness ) , lerpResult8058 , HeightMask6539);
			...
			float layeredBlend7673 = ( lerp( lerp( lerp( lerp( 0 , clampResult6284 , layeredBlendVar7673.x ) , clampResult6290 , layeredBlendVar7673.y ) , clampResult6295 , layeredBlendVar7673.z ) , clampResult6300 , layeredBlendVar7673.w ) );
			...
			float lerpResult7968 = lerp( texArray7491.w , 1 , UVmixDistance636);
			float clampResult6536 = clamp( lerpResult7968 , ( 1 - _Snow_Ambient_Occlusion_Power ) , 1 );
			...
			float clampResult7995 = clamp( ( ase_worldPos.y + ( 0 - _Remove_Vert_Height ) ) , 0 , 1 );
			clip( ( tex2D( _Texture_Additional_Masks, uv_Texture_Additional_Masks ).a * clampResult7995 ) - _Cutoff );
		}
