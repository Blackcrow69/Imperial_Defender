Shader "CTS/CTS Terrain Shader Advanced Tess Mesh"
{
	Properties
	{
		...
		_Global_Color_Map_Far_Power("Global_Color_Map_Far_Power", Range( 0 , 10)) = 8.636831
	...
	SubShader
	{
		...
		inline fixed MyCustomExpression8074( inout fixed3 In0 )
		{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float2 appendResult8063 = (fixed2(ase_vertex3Pos.x , ase_vertex3Pos.z));
			fixed2 Top_Bottom1999 = appendResult8063;
			...
			float2 appendResult8061 = (fixed2(ase_vertex3Pos.z , ase_vertex3Pos.y));
			fixed2 Front_Back1991 = appendResult8061;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult11_g1179 = (fixed2(texArray6256.w , texArray6256.y));
			float2 temp_output_4_0_g1179 = ( ( ( appendResult11_g1179 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power_Close );
			...
			float2 appendResult11_g1180 = (fixed2(texArray4374.w , texArray4374.y));
			float2 temp_output_4_0_g1180 = ( ( ( appendResult11_g1180 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power );
			...
			float clampResult297 = clamp( pow( ( max( max( abs( ( ase_worldPos - _WorldSpaceCameraPos ) ).x , abs( ( ase_worldPos - _WorldSpaceCameraPos ) ).y ) , abs( ( ase_worldPos - _WorldSpaceCameraPos ) ).z ) / _UV_Mix_Start_Distance ) , _UV_Mix_Power ) , 0 , 1 );
			fixed UVmixDistance636 = clampResult297;
			float3 lerpResult6257 = lerp( appendResult10_g1179 , appendResult10_g1180 , UVmixDistance636);
			...
			float2 appendResult11_g1095 = (fixed2(texArray3300.w , texArray3300.y));
			float2 temp_output_4_0_g1095 = ( ( ( appendResult11_g1095 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			...
			float3 temp_output_6989_0 = appendResult10_g1095;
			float4 texArray3299 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3279_0, _Texture_1_Normal_Index)  );
			float2 appendResult11_g555 = (fixed2(texArray3299.w , texArray3299.y));
			float2 temp_output_4_0_g555 = ( ( ( appendResult11_g555 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_1_Normal_Power * -1 ) );
			...
			float3 appendResult19_g555 = (fixed3(temp_output_4_0_g555.y , temp_output_4_0_g555.x , temp_output_9_0_g555));
			...
			float3 weightedAvg6393 = ( ( weightedBlendVar6393.x*( appendResult19_g555 * appendResult6857 ) + weightedBlendVar6393.y*temp_output_6989_0 + weightedBlendVar6393.z*( appendResult10_g553 * appendResult6860 ) )/( weightedBlendVar6393.x + weightedBlendVar6393.y + weightedBlendVar6393.z ) );
			...
			float2 appendResult11_g1103 = (fixed2(texArray3350.w , texArray3350.y));
			float2 temp_output_4_0_g1103 = ( ( ( appendResult11_g1103 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			...
			float3 temp_output_6992_0 = appendResult10_g1103;
			float4 texArray3384 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3344_0, _Texture_2_Normal_Index)  );
			float2 appendResult11_g551 = (fixed2(texArray3384.w , texArray3384.y));
			float2 temp_output_4_0_g551 = ( ( ( appendResult11_g551 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_2_Normal_Power * -1 ) );
			...
			float2 appendResult11_g548 = (fixed2(texArray3351.w , texArray3351.y));
			float2 temp_output_4_0_g548 = ( ( ( appendResult11_g548 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			...
			float3 appendResult10_g548 = (fixed3(temp_output_4_0_g548.x , temp_output_4_0_g548.y , temp_output_9_0_g548));
			float3 appendResult6867 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6401 = BlendComponents91;
			float3 weightedAvg6401 = ( ( weightedBlendVar6401.x*( appendResult19_g551 * appendResult6864 ) + weightedBlendVar6401.y*temp_output_6992_0 + weightedBlendVar6401.z*( appendResult10_g548 * appendResult6867 ) )/( weightedBlendVar6401.x + weightedBlendVar6401.y + weightedBlendVar6401.z ) );
			...
			float2 appendResult11_g1102 = (fixed2(texArray3416.w , texArray3416.y));
			float2 temp_output_4_0_g1102 = ( ( ( appendResult11_g1102 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			...
			float3 temp_output_6995_0 = appendResult10_g1102;
			float4 texArray3445 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3411_0, _Texture_3_Normal_Index)  );
			float2 appendResult11_g552 = (fixed2(texArray3445.w , texArray3445.y));
			float2 temp_output_4_0_g552 = ( ( ( appendResult11_g552 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_3_Normal_Power * -1 ) );
			...
			float2 appendResult11_g549 = (fixed2(texArray3417.w , texArray3417.y));
			float2 temp_output_4_0_g549 = ( ( ( appendResult11_g549 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			...
			float3 weightedAvg6408 = ( ( weightedBlendVar6408.x*( appendResult19_g552 * appendResult6871 ) + weightedBlendVar6408.y*temp_output_6995_0 + weightedBlendVar6408.z*( appendResult10_g549 * appendResult6874 ) )/( weightedBlendVar6408.x + weightedBlendVar6408.y + weightedBlendVar6408.z ) );
			...
			float2 appendResult11_g1105 = (fixed2(texArray3483.w , texArray3483.y));
			float2 temp_output_4_0_g1105 = ( ( ( appendResult11_g1105 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			...
			float3 temp_output_6998_0 = appendResult10_g1105;
			float4 texArray3512 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3478_0, _Texture_4_Normal_Index)  );
			float2 appendResult11_g550 = (fixed2(texArray3512.w , texArray3512.y));
			float2 temp_output_4_0_g550 = ( ( ( appendResult11_g550 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_4_Normal_Power * -1 ) );
			...
			float2 appendResult11_g554 = (fixed2(texArray3484.w , texArray3484.y));
			float2 temp_output_4_0_g554 = ( ( ( appendResult11_g554 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			...
			float3 appendResult10_g554 = (fixed3(temp_output_4_0_g554.x , temp_output_4_0_g554.y , temp_output_9_0_g554));
			float3 appendResult6881 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6415 = BlendComponents91;
			float3 weightedAvg6415 = ( ( weightedBlendVar6415.x*( appendResult19_g550 * appendResult6878 ) + weightedBlendVar6415.y*temp_output_6998_0 + weightedBlendVar6415.z*( appendResult10_g554 * appendResult6881 ) )/( weightedBlendVar6415.x + weightedBlendVar6415.y + weightedBlendVar6415.z ) );
			...
			float2 appendResult11_g1145 = (fixed2(texArray4424.w , texArray4424.y));
			float2 temp_output_4_0_g1145 = ( ( ( appendResult11_g1145 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
			...
			float3 temp_output_7001_0 = appendResult10_g1145;
			...
			float2 appendResult11_g1100 = (fixed2(texArray4422.w , texArray4422.y));
			float2 temp_output_4_0_g1100 = ( ( ( appendResult11_g1100 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
			...
			float3 weightedAvg6422 = ( ( weightedBlendVar6422.x*( appendResult19_g1098 * appendResult6885 ) + weightedBlendVar6422.y*temp_output_7001_0 + weightedBlendVar6422.z*( appendResult10_g1100 * appendResult6888 ) )/( weightedBlendVar6422.x + weightedBlendVar6422.y + weightedBlendVar6422.z ) );
			...
			float2 appendResult11_g1136 = (fixed2(texArray4493.w , texArray4493.y));
			float2 temp_output_4_0_g1136 = ( ( ( appendResult11_g1136 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			...
			float3 appendResult10_g1136 = (fixed3(temp_output_4_0_g1136.x , temp_output_4_0_g1136.y , temp_output_9_0_g1136));
			float3 temp_output_7004_0 = appendResult10_g1136;
			float4 texArray4486 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4472_0, _Texture_6_Normal_Index)  );
			float2 appendResult11_g1097 = (fixed2(texArray4486.w , texArray4486.y));
			float2 temp_output_4_0_g1097 = ( ( ( appendResult11_g1097 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_6_Normal_Power * -1 ) );
			...
			float2 appendResult11_g1099 = (fixed2(texArray4491.w , texArray4491.y));
			float2 temp_output_4_0_g1099 = ( ( ( appendResult11_g1099 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			...
			float3 weightedAvg6429 = ( ( weightedBlendVar6429.x*( appendResult19_g1097 * appendResult6892 ) + weightedBlendVar6429.y*temp_output_7004_0 + weightedBlendVar6429.z*( appendResult10_g1099 * appendResult6895 ) )/( weightedBlendVar6429.x + weightedBlendVar6429.y + weightedBlendVar6429.z ) );
			...
			float2 appendResult11_g1142 = (fixed2(texArray4567.w , texArray4567.y));
			float2 temp_output_4_0_g1142 = ( ( ( appendResult11_g1142 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
			...
			float3 temp_output_7007_0 = appendResult10_g1142;
			float4 texArray4560 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4546_0, _Texture_7_Normal_Index)  );
			float2 appendResult11_g1104 = (fixed2(texArray4560.w , texArray4560.y));
			float2 temp_output_4_0_g1104 = ( ( ( appendResult11_g1104 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_7_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1104 = (fixed3(temp_output_4_0_g1104.y , temp_output_4_0_g1104.x , temp_output_9_0_g1104));
			...
			float2 appendResult11_g1096 = (fixed2(texArray4565.w , texArray4565.y));
			float2 temp_output_4_0_g1096 = ( ( ( appendResult11_g1096 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
			...
			float3 weightedAvg6436 = ( ( weightedBlendVar6436.x*( appendResult19_g1104 * appendResult6899 ) + weightedBlendVar6436.y*temp_output_7007_0 + weightedBlendVar6436.z*( appendResult10_g1096 * appendResult6902 ) )/( weightedBlendVar6436.x + weightedBlendVar6436.y + weightedBlendVar6436.z ) );
			...
			float2 appendResult11_g1134 = (fixed2(texArray4641.w , texArray4641.y));
			float2 temp_output_4_0_g1134 = ( ( ( appendResult11_g1134 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			...
			float3 temp_output_7010_0 = appendResult10_g1134;
			float4 texArray4634 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4620_0, _Texture_8_Normal_Index)  );
			float2 appendResult11_g1101 = (fixed2(texArray4634.w , texArray4634.y));
			float2 temp_output_4_0_g1101 = ( ( ( appendResult11_g1101 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_8_Normal_Power * -1 ) );
			...
			float2 appendResult11_g1106 = (fixed2(texArray4639.w , texArray4639.y));
			float2 temp_output_4_0_g1106 = ( ( ( appendResult11_g1106 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			...
			float3 weightedAvg6443 = ( ( weightedBlendVar6443.x*( appendResult19_g1101 * appendResult6906 ) + weightedBlendVar6443.y*temp_output_7010_0 + weightedBlendVar6443.z*( appendResult10_g1106 * appendResult6909 ) )/( weightedBlendVar6443.x + weightedBlendVar6443.y + weightedBlendVar6443.z ) );
			...
			float2 appendResult11_g1167 = (fixed2(texArray4788.w , texArray4788.y));
			float2 temp_output_4_0_g1167 = ( ( ( appendResult11_g1167 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 appendResult10_g1167 = (fixed3(temp_output_4_0_g1167.x , temp_output_4_0_g1167.y , temp_output_9_0_g1167));
			float3 temp_output_7034_0 = appendResult10_g1167;
			float4 texArray5285 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4706_0, _Texture_9_Normal_Index)  );
			float2 appendResult11_g1140 = (fixed2(texArray5285.w , texArray5285.y));
			float2 temp_output_4_0_g1140 = ( ( ( appendResult11_g1140 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_9_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1140 = (fixed3(temp_output_4_0_g1140.y , temp_output_4_0_g1140.x , temp_output_9_0_g1140));
			...
			float2 appendResult11_g1139 = (fixed2(texArray4783.w , texArray4783.y));
			float2 temp_output_4_0_g1139 = ( ( ( appendResult11_g1139 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 weightedAvg6450 = ( ( weightedBlendVar6450.x*( appendResult19_g1140 * appendResult6962 ) + weightedBlendVar6450.y*temp_output_7034_0 + weightedBlendVar6450.z*( appendResult10_g1139 * appendResult6965 ) )/( weightedBlendVar6450.x + weightedBlendVar6450.y + weightedBlendVar6450.z ) );
			...
			float2 appendResult11_g1166 = (fixed2(texArray4822.w , texArray4822.y));
			float2 temp_output_4_0_g1166 = ( ( ( appendResult11_g1166 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
			...
			float3 temp_output_7031_0 = appendResult10_g1166;
			float4 texArray4798 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4742_0, _Texture_10_Normal_Index)  );
			float2 appendResult11_g1144 = (fixed2(texArray4798.w , texArray4798.y));
			float2 temp_output_4_0_g1144 = ( ( ( appendResult11_g1144 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_10_Normal_Power * -1 ) );
			...
			float2 appendResult11_g1143 = (fixed2(texArray4791.w , texArray4791.y));
			float2 temp_output_4_0_g1143 = ( ( ( appendResult11_g1143 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
			...
			float3 appendResult10_g1143 = (fixed3(temp_output_4_0_g1143.x , temp_output_4_0_g1143.y , temp_output_9_0_g1143));
			float3 appendResult6958 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6457 = BlendComponents91;
			float3 weightedAvg6457 = ( ( weightedBlendVar6457.x*( appendResult19_g1144 * appendResult6955 ) + weightedBlendVar6457.y*temp_output_7031_0 + weightedBlendVar6457.z*( appendResult10_g1143 * appendResult6958 ) )/( weightedBlendVar6457.x + weightedBlendVar6457.y + weightedBlendVar6457.z ) );
			...
			float2 appendResult11_g1168 = (fixed2(texArray4856.w , texArray4856.y));
			float2 temp_output_4_0_g1168 = ( ( ( appendResult11_g1168 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
			...
			float3 temp_output_7028_0 = appendResult10_g1168;
			float4 texArray4828 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4748_0, _Texture_11_Normal_Index)  );
			float2 appendResult11_g1141 = (fixed2(texArray4828.w , texArray4828.y));
			float2 temp_output_4_0_g1141 = ( ( ( appendResult11_g1141 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_11_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1141 = (fixed3(temp_output_4_0_g1141.y , temp_output_4_0_g1141.x , temp_output_9_0_g1141));
			...
			float2 appendResult11_g1146 = (fixed2(texArray4811.w , texArray4811.y));
			float2 temp_output_4_0_g1146 = ( ( ( appendResult11_g1146 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
			...
			float3 weightedAvg6464 = ( ( weightedBlendVar6464.x*( appendResult19_g1141 * appendResult6948 ) + weightedBlendVar6464.y*temp_output_7028_0 + weightedBlendVar6464.z*( appendResult10_g1146 * appendResult6951 ) )/( weightedBlendVar6464.x + weightedBlendVar6464.y + weightedBlendVar6464.z ) );
			...
			float2 appendResult11_g1169 = (fixed2(texArray4870.w , texArray4870.y));
			float2 temp_output_4_0_g1169 = ( ( ( appendResult11_g1169 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			float3 appendResult10_g1169 = (fixed3(temp_output_4_0_g1169.x , temp_output_4_0_g1169.y , temp_output_9_0_g1169));
			float3 temp_output_7025_0 = appendResult10_g1169;
			float4 texArray4850 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4758_0, _Texture_12_Normal_Index)  );
			float2 appendResult11_g1137 = (fixed2(texArray4850.w , texArray4850.y));
			float2 temp_output_4_0_g1137 = ( ( ( appendResult11_g1137 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_12_Normal_Power * -1 ) );
			float dotResult5_g1137 = dot( temp_output_4_0_g1137 , temp_output_4_0_g1137 );
			float temp_output_9_0_g1137 = sqrt( ( 1.0 - saturate( dotResult5_g1137 ) ) );
			float3 appendResult19_g1137 = (fixed3(temp_output_4_0_g1137.y , temp_output_4_0_g1137.x , temp_output_9_0_g1137));
			...
			float2 appendResult11_g1135 = (fixed2(texArray4852.w , texArray4852.y));
			float2 temp_output_4_0_g1135 = ( ( ( appendResult11_g1135 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			float3 weightedAvg6471 = ( ( weightedBlendVar6471.x*( appendResult19_g1137 * appendResult6941 ) + weightedBlendVar6471.y*temp_output_7025_0 + weightedBlendVar6471.z*( appendResult10_g1135 * appendResult6944 ) )/( weightedBlendVar6471.x + weightedBlendVar6471.y + weightedBlendVar6471.z ) );
			...
			float2 appendResult11_g1174 = (fixed2(texArray5120.w , texArray5120.y));
			float2 temp_output_4_0_g1174 = ( ( ( appendResult11_g1174 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 temp_output_7022_0 = appendResult10_g1174;
			float4 texArray5127 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5025_0, _Texture_13_Normal_Index)  );
			float2 appendResult11_g1164 = (fixed2(texArray5127.w , texArray5127.y));
			float2 temp_output_4_0_g1164 = ( ( ( appendResult11_g1164 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_13_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1164 = (fixed3(temp_output_4_0_g1164.y , temp_output_4_0_g1164.x , temp_output_9_0_g1164));
			...
			float2 appendResult11_g1162 = (fixed2(texArray5109.w , texArray5109.y));
			...
			float3 weightedAvg6478 = ( ( weightedBlendVar6478.x*( appendResult19_g1164 * appendResult6934 ) + weightedBlendVar6478.y*temp_output_7022_0 + weightedBlendVar6478.z*( appendResult10_g1162 * appendResult6937 ) )/( weightedBlendVar6478.x + weightedBlendVar6478.y + weightedBlendVar6478.z ) );
			...
			float2 appendResult11_g1175 = (fixed2(texArray5178.w , texArray5178.y));
			float2 temp_output_4_0_g1175 = ( ( ( appendResult11_g1175 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			...
			float3 temp_output_7019_0 = appendResult10_g1175;
			float4 texArray5017 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5009_0, _Texture_14_Normal_Index)  );
			float2 appendResult11_g1172 = (fixed2(texArray5017.w , texArray5017.y));
			float2 temp_output_4_0_g1172 = ( ( ( appendResult11_g1172 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_14_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1172 = (fixed3(temp_output_4_0_g1172.y , temp_output_4_0_g1172.x , temp_output_9_0_g1172));
			...
			float2 appendResult11_g1163 = (fixed2(texArray5170.w , texArray5170.y));
			...
			float3 weightedAvg6485 = ( ( weightedBlendVar6485.x*( appendResult19_g1172 * appendResult6927 ) + weightedBlendVar6485.y*temp_output_7019_0 + weightedBlendVar6485.z*( appendResult10_g1163 * appendResult6930 ) )/( weightedBlendVar6485.x + weightedBlendVar6485.y + weightedBlendVar6485.z ) );
			...
			float2 appendResult11_g1177 = (fixed2(texArray5246.w , texArray5246.y));
			float2 temp_output_4_0_g1177 = ( ( ( appendResult11_g1177 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 temp_output_7016_0 = appendResult10_g1177;
			float4 texArray5227 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5213_0, _Texture_15_Normal_Index)  );
			float2 appendResult11_g1171 = (fixed2(texArray5227.w , texArray5227.y));
			float2 temp_output_4_0_g1171 = ( ( ( appendResult11_g1171 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_15_Normal_Power * -1 ) );
			...
			float2 appendResult11_g1173 = (fixed2(texArray5250.w , texArray5250.y));
			float2 temp_output_4_0_g1173 = ( ( ( appendResult11_g1173 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 appendResult10_g1173 = (fixed3(temp_output_4_0_g1173.x , temp_output_4_0_g1173.y , temp_output_9_0_g1173));
			float3 appendResult6923 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6492 = BlendComponents91;
			float3 weightedAvg6492 = ( ( weightedBlendVar6492.x*( appendResult19_g1171 * appendResult6920 ) + weightedBlendVar6492.y*temp_output_7016_0 + weightedBlendVar6492.z*( appendResult10_g1173 * appendResult6923 ) )/( weightedBlendVar6492.x + weightedBlendVar6492.y + weightedBlendVar6492.z ) );
			...
			float2 appendResult11_g1176 = (fixed2(texArray5099.w , texArray5099.y));
			float2 temp_output_4_0_g1176 = ( ( ( appendResult11_g1176 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			...
			float3 temp_output_7013_0 = appendResult10_g1176;
			float4 texArray5082 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5079_0, _Texture_16_Normal_Index)  );
			float2 appendResult11_g1165 = (fixed2(texArray5082.w , texArray5082.y));
			float2 temp_output_4_0_g1165 = ( ( ( appendResult11_g1165 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_16_Normal_Power * -1 ) );
			...
			float2 appendResult11_g1170 = (fixed2(texArray4731.w , texArray4731.y));
			float2 temp_output_4_0_g1170 = ( ( ( appendResult11_g1170 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			...
			float3 weightedAvg6499 = ( ( weightedBlendVar6499.x*( appendResult19_g1165 * appendResult6913 ) + weightedBlendVar6499.y*temp_output_7013_0 + weightedBlendVar6499.z*( appendResult10_g1170 * appendResult6916 ) )/( weightedBlendVar6499.x + weightedBlendVar6499.y + weightedBlendVar6499.z ) );
			...
			float2 appendResult11_g1178 = (fixed2(texArray4382.w , texArray4382.y));
			float2 temp_output_4_0_g1178 = ( ( ( appendResult11_g1178 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Snow_Normal_Scale );
			...
			if( _Texture_Snow_Normal_Index <= 0 )
				...
				ifLocalVar7819 = appendResult10_g1178;
			...
			fixed3 In08074 = float3( 0,0,0 );
			fixed localMyCustomExpression8074 = MyCustomExpression8074( In08074 );
			float temp_output_8078_0 = ( _Glitter_Refreshing_Speed * ( ( localMyCustomExpression8074 * 10 ) + ( _WorldSpaceCameraPos.x + _WorldSpaceCameraPos.y + _WorldSpaceCameraPos.z ) ) );
			float temp_output_8081_0 = ( 0 + temp_output_8078_0 );
			float clampResult8093 = clamp( sin( ( temp_output_8081_0 * 0.1 ) ) , 0 , 1 );
			float2 temp_output_8084_0 = ( Top_Bottom1999 * ( 1 / _Glitter_Tiling ) );
			float2 appendResult8116 = (fixed2(temp_output_8084_0.y , temp_output_8084_0.x));
			fixed4 tex2DNode8095 = tex2D( _Texture_Glitter, ( appendResult8116 + float2( 0.37,0.67 ) ) );
			float2 panner8085 = ( temp_output_8084_0 + ( temp_output_8078_0 * 0.01 ) * float2( 1,1 ));
			float cos8087 = cos( sin( ( temp_output_8081_0 * 0.0001 ) ) );
			float sin8087 = sin( sin( ( temp_output_8081_0 * 0.0001 ) ) );
			float2 rotator8087 = mul( panner8085 - float2( 0.5,0.5 ) , float2x2( cos8087 , -sin8087 , sin8087 , cos8087 )) + float2( 0.5,0.5 );
			float clampResult8097 = clamp( pow( tex2D( _Texture_Glitter, ( ( rotator8087 + temp_output_8084_0 ) * float2( 0.2,0.2 ) ) ).r , ( 1.0 - _Glitter_Noise_Threshold ) ) , 0 , 1 );
			float lerpResult8098 = lerp(  ( clampResult8093 - 0.2 > 0 ? tex2D( _Texture_Glitter, temp_output_8084_0 ).r : clampResult8093 - 0.2 <= 0 && clampResult8093 + 0.2 >= 0 ? tex2DNode8095.r : tex2DNode8095.r )  , 0.6 , clampResult8097);
			float clampResult8100 = clamp( pow( lerpResult8098 , 100.0 ) , 0 , 1 );
			float temp_output_8101_0 = ( _Gliter_Color_Power * clampResult8100 );
			float3 lerpResult1356 = lerp( ( saturate( ( blendOpSrc4362 + blendOpDest4362 ) )) , ( appendResult8052 + temp_output_8101_0 ) , HeightMask6539);
			...
			float clampResult8102 = clamp( temp_output_8101_0 , 0 , 1 );
			float3 lerpResult8104 = lerp( ( clampResult6245 * _Snow_Specular ) , temp_cast_8 , clampResult8102);
			float3 lerpResult4040 = lerp( ( ( appendResult8049 * float3( 0.3,0.3,0.3 ) ) * _Terrain_Specular ) , lerpResult8104 , HeightMask6539);
			o.Specular = lerpResult4040;
			float lerpResult8103 = lerp( ifLocalVar7821.w , _Glitter_Smoothness , clampResult8102);
			float lerpResult3951 = lerp( ( layeredBlend6532.w * _Terrain_Smoothness ) , lerpResult8103 , HeightMask6539);
