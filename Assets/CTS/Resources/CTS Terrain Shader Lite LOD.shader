Shader "CTS/CTS Terrain Shader Lite LOD"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float3 lerpResult3776 = lerp( float3( 0,0,1 ) , appendResult10_g223 , clampResult3775);
			...
			fixed2 temp_cast_1 = (( ( ase_worldPos.y / _Geological_Tiling_Far ) + _Geological_Map_Offset_Far )).xx;
			fixed4 tex2DNode5983 = tex2D( _Texture_Geological_Map, temp_cast_1 );
			float3 appendResult5985 = (fixed3(tex2DNode5983.r , tex2DNode5983.g , tex2DNode5983.b));
			fixed3 blendOpSrc4362 = appendResult3857;
