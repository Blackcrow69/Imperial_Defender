Shader "CTS/CTS Terrain Shader Advanced Tess"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float2 appendResult8061 = (fixed2(ase_vertex3Pos.x , ase_vertex3Pos.z));
			fixed2 Top_Bottom1999 = appendResult8061;
			...
			float2 appendResult8063 = (fixed2(ase_vertex3Pos.z , ase_vertex3Pos.y));
			fixed2 Front_Back1991 = appendResult8063;
			...
			float2 appendResult8062 = (fixed2(ase_vertex3Pos.x , ase_vertex3Pos.y));
			fixed2 Left_Right2003 = appendResult8062;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult11_g1183 = (fixed2(texArray6256.w , texArray6256.y));
			float2 temp_output_4_0_g1183 = ( ( ( appendResult11_g1183 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power_Close );
			...
			float3 appendResult10_g1183 = (fixed3(temp_output_4_0_g1183.x , temp_output_4_0_g1183.y , temp_output_9_0_g1183));
			...
			float2 appendResult11_g1184 = (fixed2(texArray4374.w , texArray4374.y));
			float2 temp_output_4_0_g1184 = ( ( ( appendResult11_g1184 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power );
			float dotResult5_g1184 = dot( temp_output_4_0_g1184 , temp_output_4_0_g1184 );
			float temp_output_9_0_g1184 = sqrt( ( 1.0 - saturate( dotResult5_g1184 ) ) );
			float3 appendResult10_g1184 = (fixed3(temp_output_4_0_g1184.x , temp_output_4_0_g1184.y , temp_output_9_0_g1184));
			float3 ase_worldPos = i.worldPos;
			float clampResult297 = clamp( pow( ( max( max( abs( ( ase_worldPos - _WorldSpaceCameraPos ) ).x , abs( ( ase_worldPos - _WorldSpaceCameraPos ) ).y ) , abs( ( ase_worldPos - _WorldSpaceCameraPos ) ).z ) / _UV_Mix_Start_Distance ) , _UV_Mix_Power ) , 0 , 1 );
			fixed UVmixDistance636 = clampResult297;
			float3 lerpResult6257 = lerp( appendResult10_g1183 , appendResult10_g1184 , UVmixDistance636);
			...
			float2 appendResult11_g1110 = (fixed2(texArray3300.w , texArray3300.y));
			float2 temp_output_4_0_g1110 = ( ( ( appendResult11_g1110 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			...
			float3 appendResult10_g1110 = (fixed3(temp_output_4_0_g1110.x , temp_output_4_0_g1110.y , temp_output_9_0_g1110));
			float3 temp_output_6989_0 = appendResult10_g1110;
			float4 texArray3299 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3279_0, _Texture_1_Normal_Index)  );
			float2 appendResult11_g551 = (fixed2(texArray3299.w , texArray3299.y));
			float2 temp_output_4_0_g551 = ( ( ( appendResult11_g551 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_1_Normal_Power * -1 ) );
			...
			float2 appendResult11_g553 = (fixed2(texArray3301.w , texArray3301.y));
			float2 temp_output_4_0_g553 = ( ( ( appendResult11_g553 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			...
			float3 weightedAvg6393 = ( ( weightedBlendVar6393.x*( appendResult19_g551 * appendResult6857 ) + weightedBlendVar6393.y*temp_output_6989_0 + weightedBlendVar6393.z*( appendResult10_g553 * appendResult6860 ) )/( weightedBlendVar6393.x + weightedBlendVar6393.y + weightedBlendVar6393.z ) );
			...
			float2 appendResult11_g1107 = (fixed2(texArray3350.w , texArray3350.y));
			float2 temp_output_4_0_g1107 = ( ( ( appendResult11_g1107 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			...
			float3 appendResult10_g1107 = (fixed3(temp_output_4_0_g1107.x , temp_output_4_0_g1107.y , temp_output_9_0_g1107));
			float3 temp_output_6992_0 = appendResult10_g1107;
			float4 texArray3384 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3344_0, _Texture_2_Normal_Index)  );
			float2 appendResult11_g556 = (fixed2(texArray3384.w , texArray3384.y));
			float2 temp_output_4_0_g556 = ( ( ( appendResult11_g556 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_2_Normal_Power * -1 ) );
			float dotResult5_g556 = dot( temp_output_4_0_g556 , temp_output_4_0_g556 );
			float temp_output_9_0_g556 = sqrt( ( 1.0 - saturate( dotResult5_g556 ) ) );
			float3 appendResult19_g556 = (fixed3(temp_output_4_0_g556.y , temp_output_4_0_g556.x , temp_output_9_0_g556));
			...
			float2 appendResult11_g555 = (fixed2(texArray3351.w , texArray3351.y));
			float2 temp_output_4_0_g555 = ( ( ( appendResult11_g555 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			float dotResult5_g555 = dot( temp_output_4_0_g555 , temp_output_4_0_g555 );
			float temp_output_9_0_g555 = sqrt( ( 1.0 - saturate( dotResult5_g555 ) ) );
			float3 appendResult10_g555 = (fixed3(temp_output_4_0_g555.x , temp_output_4_0_g555.y , temp_output_9_0_g555));
			float3 appendResult6867 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6401 = BlendComponents91;
			float3 weightedAvg6401 = ( ( weightedBlendVar6401.x*( appendResult19_g556 * appendResult6864 ) + weightedBlendVar6401.y*temp_output_6992_0 + weightedBlendVar6401.z*( appendResult10_g555 * appendResult6867 ) )/( weightedBlendVar6401.x + weightedBlendVar6401.y + weightedBlendVar6401.z ) );
			...
			float2 appendResult11_g1108 = (fixed2(texArray3416.w , texArray3416.y));
			float2 temp_output_4_0_g1108 = ( ( ( appendResult11_g1108 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			...
			float3 temp_output_6995_0 = appendResult10_g1108;
			float4 texArray3445 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3411_0, _Texture_3_Normal_Index)  );
			float2 appendResult11_g548 = (fixed2(texArray3445.w , texArray3445.y));
			float2 temp_output_4_0_g548 = ( ( ( appendResult11_g548 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_3_Normal_Power * -1 ) );
			...
			float2 appendResult11_g547 = (fixed2(texArray3417.w , texArray3417.y));
			float2 temp_output_4_0_g547 = ( ( ( appendResult11_g547 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			...
			float3 weightedAvg6408 = ( ( weightedBlendVar6408.x*( appendResult19_g548 * appendResult6871 ) + weightedBlendVar6408.y*temp_output_6995_0 + weightedBlendVar6408.z*( appendResult10_g547 * appendResult6874 ) )/( weightedBlendVar6408.x + weightedBlendVar6408.y + weightedBlendVar6408.z ) );
			...
			float2 appendResult11_g1106 = (fixed2(texArray3483.w , texArray3483.y));
			float2 temp_output_4_0_g1106 = ( ( ( appendResult11_g1106 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			...
			float3 appendResult10_g1106 = (fixed3(temp_output_4_0_g1106.x , temp_output_4_0_g1106.y , temp_output_9_0_g1106));
			float3 temp_output_6998_0 = appendResult10_g1106;
			float4 texArray3512 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3478_0, _Texture_4_Normal_Index)  );
			float2 appendResult11_g554 = (fixed2(texArray3512.w , texArray3512.y));
			float2 temp_output_4_0_g554 = ( ( ( appendResult11_g554 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_4_Normal_Power * -1 ) );
			float dotResult5_g554 = dot( temp_output_4_0_g554 , temp_output_4_0_g554 );
			float temp_output_9_0_g554 = sqrt( ( 1.0 - saturate( dotResult5_g554 ) ) );
			float3 appendResult19_g554 = (fixed3(temp_output_4_0_g554.y , temp_output_4_0_g554.x , temp_output_9_0_g554));
			...
			float2 appendResult11_g552 = (fixed2(texArray3484.w , texArray3484.y));
			float2 temp_output_4_0_g552 = ( ( ( appendResult11_g552 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			...
			float3 appendResult10_g552 = (fixed3(temp_output_4_0_g552.x , temp_output_4_0_g552.y , temp_output_9_0_g552));
			float3 appendResult6881 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6415 = BlendComponents91;
			float3 weightedAvg6415 = ( ( weightedBlendVar6415.x*( appendResult19_g554 * appendResult6878 ) + weightedBlendVar6415.y*temp_output_6998_0 + weightedBlendVar6415.z*( appendResult10_g552 * appendResult6881 ) )/( weightedBlendVar6415.x + weightedBlendVar6415.y + weightedBlendVar6415.z ) );
			...
			float2 appendResult11_g1147 = (fixed2(texArray4424.w , texArray4424.y));
			float2 temp_output_4_0_g1147 = ( ( ( appendResult11_g1147 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
			...
			float3 appendResult10_g1147 = (fixed3(temp_output_4_0_g1147.x , temp_output_4_0_g1147.y , temp_output_9_0_g1147));
			float3 temp_output_7001_0 = appendResult10_g1147;
			float4 texArray4417 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4400_0, _Texture_5_Normal_Index)  );
			float2 appendResult11_g1101 = (fixed2(texArray4417.w , texArray4417.y));
			float2 temp_output_4_0_g1101 = ( ( ( appendResult11_g1101 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_5_Normal_Power * -1 ) );
			...
			float3 weightedAvg6422 = ( ( weightedBlendVar6422.x*( appendResult19_g1101 * appendResult6885 ) + weightedBlendVar6422.y*temp_output_7001_0 + weightedBlendVar6422.z*( appendResult10_g1113 * appendResult6888 ) )/( weightedBlendVar6422.x + weightedBlendVar6422.y + weightedBlendVar6422.z ) );
			...
			float2 appendResult11_g1142 = (fixed2(texArray4493.w , texArray4493.y));
			float2 temp_output_4_0_g1142 = ( ( ( appendResult11_g1142 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			...
			float3 appendResult10_g1142 = (fixed3(temp_output_4_0_g1142.x , temp_output_4_0_g1142.y , temp_output_9_0_g1142));
			float3 temp_output_7004_0 = appendResult10_g1142;
			float4 texArray4486 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4472_0, _Texture_6_Normal_Index)  );
			float2 appendResult11_g1112 = (fixed2(texArray4486.w , texArray4486.y));
			float2 temp_output_4_0_g1112 = ( ( ( appendResult11_g1112 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_6_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1112 = (fixed3(temp_output_4_0_g1112.y , temp_output_4_0_g1112.x , temp_output_9_0_g1112));
			...
			float2 appendResult11_g1105 = (fixed2(texArray4491.w , texArray4491.y));
			float2 temp_output_4_0_g1105 = ( ( ( appendResult11_g1105 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			...
			float3 appendResult10_g1105 = (fixed3(temp_output_4_0_g1105.x , temp_output_4_0_g1105.y , temp_output_9_0_g1105));
			float3 appendResult6895 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6429 = BlendComponents91;
			float3 weightedAvg6429 = ( ( weightedBlendVar6429.x*( appendResult19_g1112 * appendResult6892 ) + weightedBlendVar6429.y*temp_output_7004_0 + weightedBlendVar6429.z*( appendResult10_g1105 * appendResult6895 ) )/( weightedBlendVar6429.x + weightedBlendVar6429.y + weightedBlendVar6429.z ) );
			...
			float2 appendResult11_g1139 = (fixed2(texArray4567.w , texArray4567.y));
			...
			float3 appendResult10_g1139 = (fixed3(temp_output_4_0_g1139.x , temp_output_4_0_g1139.y , temp_output_9_0_g1139));
			float3 temp_output_7007_0 = appendResult10_g1139;
			float4 texArray4560 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4546_0, _Texture_7_Normal_Index)  );
			float2 appendResult11_g1109 = (fixed2(texArray4560.w , texArray4560.y));
			float2 temp_output_4_0_g1109 = ( ( ( appendResult11_g1109 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_7_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1109 = (fixed3(temp_output_4_0_g1109.y , temp_output_4_0_g1109.x , temp_output_9_0_g1109));
			...
			float2 appendResult11_g1111 = (fixed2(texArray4565.w , texArray4565.y));
			float2 temp_output_4_0_g1111 = ( ( ( appendResult11_g1111 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
			...
			float3 weightedAvg6436 = ( ( weightedBlendVar6436.x*( appendResult19_g1109 * appendResult6899 ) + weightedBlendVar6436.y*temp_output_7007_0 + weightedBlendVar6436.z*( appendResult10_g1111 * appendResult6902 ) )/( weightedBlendVar6436.x + weightedBlendVar6436.y + weightedBlendVar6436.z ) );
			...
			float2 appendResult11_g1145 = (fixed2(texArray4641.w , texArray4641.y));
			float2 temp_output_4_0_g1145 = ( ( ( appendResult11_g1145 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			...
			float3 temp_output_7010_0 = appendResult10_g1145;
			float4 texArray4634 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4620_0, _Texture_8_Normal_Index)  );
			float2 appendResult11_g1102 = (fixed2(texArray4634.w , texArray4634.y));
			float2 temp_output_4_0_g1102 = ( ( ( appendResult11_g1102 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_8_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1102 = (fixed3(temp_output_4_0_g1102.y , temp_output_4_0_g1102.x , temp_output_9_0_g1102));
			...
			float2 appendResult11_g1103 = (fixed2(texArray4639.w , texArray4639.y));
			float2 temp_output_4_0_g1103 = ( ( ( appendResult11_g1103 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			...
			float3 weightedAvg6443 = ( ( weightedBlendVar6443.x*( appendResult19_g1102 * appendResult6906 ) + weightedBlendVar6443.y*temp_output_7010_0 + weightedBlendVar6443.z*( appendResult10_g1103 * appendResult6909 ) )/( weightedBlendVar6443.x + weightedBlendVar6443.y + weightedBlendVar6443.z ) );
			...
			float2 appendResult11_g1174 = (fixed2(texArray4788.w , texArray4788.y));
			float2 temp_output_4_0_g1174 = ( ( ( appendResult11_g1174 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 appendResult10_g1174 = (fixed3(temp_output_4_0_g1174.x , temp_output_4_0_g1174.y , temp_output_9_0_g1174));
			float3 temp_output_7034_0 = appendResult10_g1174;
			float4 texArray5285 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4706_0, _Texture_9_Normal_Index)  );
			float2 appendResult11_g1150 = (fixed2(texArray5285.w , texArray5285.y));
			float2 temp_output_4_0_g1150 = ( ( ( appendResult11_g1150 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_9_Normal_Power * -1 ) );
			...
			float2 appendResult11_g1149 = (fixed2(texArray4783.w , texArray4783.y));
			float2 temp_output_4_0_g1149 = ( ( ( appendResult11_g1149 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 weightedAvg6450 = ( ( weightedBlendVar6450.x*( appendResult19_g1150 * appendResult6962 ) + weightedBlendVar6450.y*temp_output_7034_0 + weightedBlendVar6450.z*( appendResult10_g1149 * appendResult6965 ) )/( weightedBlendVar6450.x + weightedBlendVar6450.y + weightedBlendVar6450.z ) );
			...
			float2 appendResult11_g1175 = (fixed2(texArray4822.w , texArray4822.y));
			float2 temp_output_4_0_g1175 = ( ( ( appendResult11_g1175 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
			...
			float3 appendResult10_g1175 = (fixed3(temp_output_4_0_g1175.x , temp_output_4_0_g1175.y , temp_output_9_0_g1175));
			float3 temp_output_7031_0 = appendResult10_g1175;
			float4 texArray4798 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4742_0, _Texture_10_Normal_Index)  );
			float2 appendResult11_g1143 = (fixed2(texArray4798.w , texArray4798.y));
			float2 temp_output_4_0_g1143 = ( ( ( appendResult11_g1143 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_10_Normal_Power * -1 ) );
			...
			float2 appendResult11_g1138 = (fixed2(texArray4791.w , texArray4791.y));
			float2 temp_output_4_0_g1138 = ( ( ( appendResult11_g1138 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
			float dotResult5_g1138 = dot( temp_output_4_0_g1138 , temp_output_4_0_g1138 );
			float temp_output_9_0_g1138 = sqrt( ( 1.0 - saturate( dotResult5_g1138 ) ) );
			float3 appendResult10_g1138 = (fixed3(temp_output_4_0_g1138.x , temp_output_4_0_g1138.y , temp_output_9_0_g1138));
			float3 appendResult6958 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6457 = BlendComponents91;
			float3 weightedAvg6457 = ( ( weightedBlendVar6457.x*( appendResult19_g1143 * appendResult6955 ) + weightedBlendVar6457.y*temp_output_7031_0 + weightedBlendVar6457.z*( appendResult10_g1138 * appendResult6958 ) )/( weightedBlendVar6457.x + weightedBlendVar6457.y + weightedBlendVar6457.z ) );
			...
			float2 appendResult11_g1177 = (fixed2(texArray4856.w , texArray4856.y));
			float2 temp_output_4_0_g1177 = ( ( ( appendResult11_g1177 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
			...
			float3 appendResult10_g1177 = (fixed3(temp_output_4_0_g1177.x , temp_output_4_0_g1177.y , temp_output_9_0_g1177));
			float3 temp_output_7028_0 = appendResult10_g1177;
			float4 texArray4828 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4748_0, _Texture_11_Normal_Index)  );
			float2 appendResult11_g1148 = (fixed2(texArray4828.w , texArray4828.y));
			float2 temp_output_4_0_g1148 = ( ( ( appendResult11_g1148 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_11_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1148 = (fixed3(temp_output_4_0_g1148.y , temp_output_4_0_g1148.x , temp_output_9_0_g1148));
			...
			float2 appendResult11_g1141 = (fixed2(texArray4811.w , texArray4811.y));
			float2 temp_output_4_0_g1141 = ( ( ( appendResult11_g1141 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
			...
			float3 weightedAvg6464 = ( ( weightedBlendVar6464.x*( appendResult19_g1148 * appendResult6948 ) + weightedBlendVar6464.y*temp_output_7028_0 + weightedBlendVar6464.z*( appendResult10_g1141 * appendResult6951 ) )/( weightedBlendVar6464.x + weightedBlendVar6464.y + weightedBlendVar6464.z ) );
			...
			float2 appendResult11_g1176 = (fixed2(texArray4870.w , texArray4870.y));
			float2 temp_output_4_0_g1176 = ( ( ( appendResult11_g1176 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			float3 appendResult10_g1176 = (fixed3(temp_output_4_0_g1176.x , temp_output_4_0_g1176.y , temp_output_9_0_g1176));
			float3 temp_output_7025_0 = appendResult10_g1176;
			float4 texArray4850 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4758_0, _Texture_12_Normal_Index)  );
			float2 appendResult11_g1144 = (fixed2(texArray4850.w , texArray4850.y));
			float2 temp_output_4_0_g1144 = ( ( ( appendResult11_g1144 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_12_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1144 = (fixed3(temp_output_4_0_g1144.y , temp_output_4_0_g1144.x , temp_output_9_0_g1144));
			...
			float2 appendResult11_g1146 = (fixed2(texArray4852.w , texArray4852.y));
			...
			float3 weightedAvg6471 = ( ( weightedBlendVar6471.x*( appendResult19_g1144 * appendResult6941 ) + weightedBlendVar6471.y*temp_output_7025_0 + weightedBlendVar6471.z*( appendResult10_g1146 * appendResult6944 ) )/( weightedBlendVar6471.x + weightedBlendVar6471.y + weightedBlendVar6471.z ) );
			...
			float2 appendResult11_g1180 = (fixed2(texArray5120.w , texArray5120.y));
			float2 temp_output_4_0_g1180 = ( ( ( appendResult11_g1180 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 appendResult10_g1180 = (fixed3(temp_output_4_0_g1180.x , temp_output_4_0_g1180.y , temp_output_9_0_g1180));
			float3 temp_output_7022_0 = appendResult10_g1180;
			float4 texArray5127 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5025_0, _Texture_13_Normal_Index)  );
			float2 appendResult11_g1169 = (fixed2(texArray5127.w , texArray5127.y));
			float2 temp_output_4_0_g1169 = ( ( ( appendResult11_g1169 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_13_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1169 = (fixed3(temp_output_4_0_g1169.y , temp_output_4_0_g1169.x , temp_output_9_0_g1169));
			...
			float2 appendResult11_g1172 = (fixed2(texArray5109.w , texArray5109.y));
			float2 temp_output_4_0_g1172 = ( ( ( appendResult11_g1172 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 appendResult10_g1172 = (fixed3(temp_output_4_0_g1172.x , temp_output_4_0_g1172.y , temp_output_9_0_g1172));
			float3 appendResult6937 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6478 = BlendComponents91;
			float3 weightedAvg6478 = ( ( weightedBlendVar6478.x*( appendResult19_g1169 * appendResult6934 ) + weightedBlendVar6478.y*temp_output_7022_0 + weightedBlendVar6478.z*( appendResult10_g1172 * appendResult6937 ) )/( weightedBlendVar6478.x + weightedBlendVar6478.y + weightedBlendVar6478.z ) );
			...
			float2 appendResult11_g1179 = (fixed2(texArray5178.w , texArray5178.y));
			float2 temp_output_4_0_g1179 = ( ( ( appendResult11_g1179 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			...
			float3 appendResult10_g1179 = (fixed3(temp_output_4_0_g1179.x , temp_output_4_0_g1179.y , temp_output_9_0_g1179));
			float3 temp_output_7019_0 = appendResult10_g1179;
			float4 texArray5017 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5009_0, _Texture_14_Normal_Index)  );
			float2 appendResult11_g1173 = (fixed2(texArray5017.w , texArray5017.y));
			float2 temp_output_4_0_g1173 = ( ( ( appendResult11_g1173 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_14_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1173 = (fixed3(temp_output_4_0_g1173.y , temp_output_4_0_g1173.x , temp_output_9_0_g1173));
			...
			float2 appendResult11_g1168 = (fixed2(texArray5170.w , texArray5170.y));
			float2 temp_output_4_0_g1168 = ( ( ( appendResult11_g1168 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			...
			float3 appendResult10_g1168 = (fixed3(temp_output_4_0_g1168.x , temp_output_4_0_g1168.y , temp_output_9_0_g1168));
			float3 appendResult6930 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6485 = BlendComponents91;
			float3 weightedAvg6485 = ( ( weightedBlendVar6485.x*( appendResult19_g1173 * appendResult6927 ) + weightedBlendVar6485.y*temp_output_7019_0 + weightedBlendVar6485.z*( appendResult10_g1168 * appendResult6930 ) )/( weightedBlendVar6485.x + weightedBlendVar6485.y + weightedBlendVar6485.z ) );
			...
			float2 appendResult11_g1181 = (fixed2(texArray5246.w , texArray5246.y));
			float2 temp_output_4_0_g1181 = ( ( ( appendResult11_g1181 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 appendResult10_g1181 = (fixed3(temp_output_4_0_g1181.x , temp_output_4_0_g1181.y , temp_output_9_0_g1181));
			float3 temp_output_7016_0 = appendResult10_g1181;
			float4 texArray5227 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5213_0, _Texture_15_Normal_Index)  );
			float2 appendResult11_g1165 = (fixed2(texArray5227.w , texArray5227.y));
			float2 temp_output_4_0_g1165 = ( ( ( appendResult11_g1165 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_15_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1165 = (fixed3(temp_output_4_0_g1165.y , temp_output_4_0_g1165.x , temp_output_9_0_g1165));
			...
			float2 appendResult11_g1170 = (fixed2(texArray5250.w , texArray5250.y));
			float2 temp_output_4_0_g1170 = ( ( ( appendResult11_g1170 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 appendResult10_g1170 = (fixed3(temp_output_4_0_g1170.x , temp_output_4_0_g1170.y , temp_output_9_0_g1170));
			float3 appendResult6923 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6492 = BlendComponents91;
			float3 weightedAvg6492 = ( ( weightedBlendVar6492.x*( appendResult19_g1165 * appendResult6920 ) + weightedBlendVar6492.y*temp_output_7016_0 + weightedBlendVar6492.z*( appendResult10_g1170 * appendResult6923 ) )/( weightedBlendVar6492.x + weightedBlendVar6492.y + weightedBlendVar6492.z ) );
			...
			float2 appendResult11_g1178 = (fixed2(texArray5099.w , texArray5099.y));
			float2 temp_output_4_0_g1178 = ( ( ( appendResult11_g1178 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			...
			float3 appendResult10_g1178 = (fixed3(temp_output_4_0_g1178.x , temp_output_4_0_g1178.y , temp_output_9_0_g1178));
			float3 temp_output_7013_0 = appendResult10_g1178;
			float4 texArray5082 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5079_0, _Texture_16_Normal_Index)  );
			float2 appendResult11_g1171 = (fixed2(texArray5082.w , texArray5082.y));
			float2 temp_output_4_0_g1171 = ( ( ( appendResult11_g1171 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_16_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1171 = (fixed3(temp_output_4_0_g1171.y , temp_output_4_0_g1171.x , temp_output_9_0_g1171));
			...
			float2 appendResult11_g1164 = (fixed2(texArray4731.w , texArray4731.y));
			float2 temp_output_4_0_g1164 = ( ( ( appendResult11_g1164 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			...
			float3 weightedAvg6499 = ( ( weightedBlendVar6499.x*( appendResult19_g1171 * appendResult6913 ) + weightedBlendVar6499.y*temp_output_7013_0 + weightedBlendVar6499.z*( appendResult10_g1164 * appendResult6916 ) )/( weightedBlendVar6499.x + weightedBlendVar6499.y + weightedBlendVar6499.z ) );
			...
			float2 appendResult11_g1182 = (fixed2(texArray4382.w , texArray4382.y));
			float2 temp_output_4_0_g1182 = ( ( ( appendResult11_g1182 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Snow_Normal_Scale );
			...
			float3 appendResult10_g1182 = (fixed3(temp_output_4_0_g1182.x , temp_output_4_0_g1182.y , temp_output_9_0_g1182));
			fixed3 ifLocalVar7819 = 0;
			UNITY_BRANCH 
			if( _Texture_Snow_Normal_Index <= 0 )
				ifLocalVar7819 = EmptyNRM7829;
			else
				ifLocalVar7819 = appendResult10_g1182;
			...
			float clampResult8121 = clamp( ( tex2DNode8036.a + ( 1.0 - _Global_Color_Opacity_Power ) ) , 0 , 1 );
			float2 appendResult8050 = (fixed2(1 , ( lerpResult8035 * clampResult8121 )));
			...
			float3 appendResult8049 = (fixed3(layeredBlend6532.xyz));
			float3 appendResult8051 = (fixed3(tex2DNode8036.rgb));
			...
			float3 appendResult8054 = (fixed3(tex2D( _Texture_Geological_Map, temp_cast_4 ).rgb));
			fixed2 temp_cast_6 = (( ( ase_worldPos.y / _Geological_Tiling_Far ) + _Geological_Map_Offset_Far )).xx;
			float3 appendResult8053 = (fixed3(tex2D( _Texture_Geological_Map, temp_cast_6 ).rgb));
			...
			float3 appendResult8052 = (fixed3(ifLocalVar7821.x , ifLocalVar7821.y , ifLocalVar7821.z));
			fixed3 In08069 = float3( 0,0,0 );
			fixed localMyCustomExpression8069 = MyCustomExpression8069( In08069 );
			float temp_output_8075_0 = ( _Glitter_Refreshing_Speed * ( ( localMyCustomExpression8069 * 10 ) + ( _WorldSpaceCameraPos.x + _WorldSpaceCameraPos.y + _WorldSpaceCameraPos.z ) ) );
			float temp_output_8078_0 = ( 0 + temp_output_8075_0 );
			float clampResult8095 = clamp( sin( ( temp_output_8078_0 * 0.1 ) ) , 0 , 1 );
			float2 temp_output_8081_0 = ( Top_Bottom1999 * ( 1 / _Glitter_Tiling ) );
			float2 appendResult8116 = (fixed2(temp_output_8081_0.y , temp_output_8081_0.x));
			fixed4 tex2DNode8097 = tex2D( _Texture_Glitter, ( appendResult8116 + float2( 0.37,0.67 ) ) );
			float2 panner8082 = ( temp_output_8081_0 + ( temp_output_8075_0 * 0.01 ) * float2( 1,1 ));
			...
			float clampResult8099 = clamp( pow( tex2D( _Texture_Glitter, ( ( rotator8084 + temp_output_8081_0 ) * float2( 0.2,0.2 ) ) ).r , ( 1.0 - _Glitter_Noise_Threshold ) ) , 0 , 1 );
			float lerpResult8101 = lerp(  ( clampResult8095 - 0.2 > 0 ? tex2D( _Texture_Glitter, temp_output_8081_0 ).r : clampResult8095 - 0.2 <= 0 && clampResult8095 + 0.2 >= 0 ? tex2DNode8097.r : tex2DNode8097.r )  , 0.6 , clampResult8099);
			float clampResult8105 = clamp( pow( lerpResult8101 , 100.0 ) , 0 , 1 );
			...
			float clampResult8111 = clamp( temp_output_8106_0 , 0 , 1 );
			...
			float lerpResult8112 = lerp( ifLocalVar7821.w , _Glitter_Smoothness , clampResult8111);
