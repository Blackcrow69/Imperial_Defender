Shader "CTS/CTS Terrain Shader Advanced"
{
	...
	SubShader
	{
		...
		inline fixed CameraRefresh8020( inout fixed3 In0 )
		{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float localMyCustomExpression7999 = ( 0 );
			v.tangent.xyz = cross ( v.normal, float3( 0, 0, 1 ) );
			v.tangent.w = -1;
			fixed3 temp_cast_0 = (localMyCustomExpression7999).xxx;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult8002 = (fixed2(ase_vertex3Pos.x , ase_vertex3Pos.z));
			fixed2 Top_Bottom1999 = appendResult8002;
			...
			float2 appendResult11_g1157 = (fixed2(texArray6256.w , texArray6256.y));
			float2 temp_output_4_0_g1157 = ( ( ( appendResult11_g1157 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power_Close );
			...
			float2 appendResult11_g1158 = (fixed2(texArray4374.w , texArray4374.y));
			float2 temp_output_4_0_g1158 = ( ( ( appendResult11_g1158 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power );
			...
			float3 lerpResult6257 = lerp( appendResult10_g1157 , appendResult10_g1158 , UVmixDistance636);
			...
			float2 appendResult8003 = (fixed2(ase_vertex3Pos.z , ase_vertex3Pos.y));
			fixed2 Front_Back1991 = appendResult8003;
			...
			float2 appendResult8001 = (fixed2(ase_vertex3Pos.x , ase_vertex3Pos.y));
			fixed2 Left_Right2003 = appendResult8001;
			...
			float2 appendResult11_g1108 = (fixed2(texArray3300.w , texArray3300.y));
			float2 temp_output_4_0_g1108 = ( ( ( appendResult11_g1108 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			...
			float3 appendResult10_g1108 = (fixed3(temp_output_4_0_g1108.x , temp_output_4_0_g1108.y , temp_output_9_0_g1108));
			float3 temp_output_6989_0 = appendResult10_g1108;
			float4 texArray3299 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3279_0, _Texture_1_Normal_Index)  );
			float2 appendResult11_g543 = (fixed2(texArray3299.w , texArray3299.y));
			float2 temp_output_4_0_g543 = ( ( ( appendResult11_g543 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_1_Normal_Power * -1 ) );
			float dotResult5_g543 = dot( temp_output_4_0_g543 , temp_output_4_0_g543 );
			float temp_output_9_0_g543 = sqrt( ( 1.0 - saturate( dotResult5_g543 ) ) );
			float3 appendResult19_g543 = (fixed3(temp_output_4_0_g543.y , temp_output_4_0_g543.x , temp_output_9_0_g543));
			...
			float2 appendResult11_g545 = (fixed2(texArray3301.w , texArray3301.y));
			float2 temp_output_4_0_g545 = ( ( ( appendResult11_g545 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			float dotResult5_g545 = dot( temp_output_4_0_g545 , temp_output_4_0_g545 );
			float temp_output_9_0_g545 = sqrt( ( 1.0 - saturate( dotResult5_g545 ) ) );
			float3 appendResult10_g545 = (fixed3(temp_output_4_0_g545.x , temp_output_4_0_g545.y , temp_output_9_0_g545));
			float3 appendResult6860 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6393 = BlendComponents91;
			float3 weightedAvg6393 = ( ( weightedBlendVar6393.x*( appendResult19_g543 * appendResult6857 ) + weightedBlendVar6393.y*temp_output_6989_0 + weightedBlendVar6393.z*( appendResult10_g545 * appendResult6860 ) )/( weightedBlendVar6393.x + weightedBlendVar6393.y + weightedBlendVar6393.z ) );
			...
			float2 appendResult11_g1118 = (fixed2(texArray3350.w , texArray3350.y));
			float2 temp_output_4_0_g1118 = ( ( ( appendResult11_g1118 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			float dotResult5_g1118 = dot( temp_output_4_0_g1118 , temp_output_4_0_g1118 );
			float temp_output_9_0_g1118 = sqrt( ( 1.0 - saturate( dotResult5_g1118 ) ) );
			float3 appendResult10_g1118 = (fixed3(temp_output_4_0_g1118.x , temp_output_4_0_g1118.y , temp_output_9_0_g1118));
			float3 temp_output_6992_0 = appendResult10_g1118;
			float4 texArray3384 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3344_0, _Texture_2_Normal_Index)  );
			float2 appendResult11_g539 = (fixed2(texArray3384.w , texArray3384.y));
			float2 temp_output_4_0_g539 = ( ( ( appendResult11_g539 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_2_Normal_Power * -1 ) );
			float dotResult5_g539 = dot( temp_output_4_0_g539 , temp_output_4_0_g539 );
			float temp_output_9_0_g539 = sqrt( ( 1.0 - saturate( dotResult5_g539 ) ) );
			float3 appendResult19_g539 = (fixed3(temp_output_4_0_g539.y , temp_output_4_0_g539.x , temp_output_9_0_g539));
			...
			float2 appendResult11_g544 = (fixed2(texArray3351.w , texArray3351.y));
			float2 temp_output_4_0_g544 = ( ( ( appendResult11_g544 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			float dotResult5_g544 = dot( temp_output_4_0_g544 , temp_output_4_0_g544 );
			float temp_output_9_0_g544 = sqrt( ( 1.0 - saturate( dotResult5_g544 ) ) );
			float3 appendResult10_g544 = (fixed3(temp_output_4_0_g544.x , temp_output_4_0_g544.y , temp_output_9_0_g544));
			float3 appendResult6867 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6401 = BlendComponents91;
			float3 weightedAvg6401 = ( ( weightedBlendVar6401.x*( appendResult19_g539 * appendResult6864 ) + weightedBlendVar6401.y*temp_output_6992_0 + weightedBlendVar6401.z*( appendResult10_g544 * appendResult6867 ) )/( weightedBlendVar6401.x + weightedBlendVar6401.y + weightedBlendVar6401.z ) );
			...
			float2 appendResult11_g1112 = (fixed2(texArray3416.w , texArray3416.y));
			float2 temp_output_4_0_g1112 = ( ( ( appendResult11_g1112 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			float dotResult5_g1112 = dot( temp_output_4_0_g1112 , temp_output_4_0_g1112 );
			float temp_output_9_0_g1112 = sqrt( ( 1.0 - saturate( dotResult5_g1112 ) ) );
			float3 appendResult10_g1112 = (fixed3(temp_output_4_0_g1112.x , temp_output_4_0_g1112.y , temp_output_9_0_g1112));
			float3 temp_output_6995_0 = appendResult10_g1112;
			float4 texArray3445 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3411_0, _Texture_3_Normal_Index)  );
			float2 appendResult11_g541 = (fixed2(texArray3445.w , texArray3445.y));
			float2 temp_output_4_0_g541 = ( ( ( appendResult11_g541 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_3_Normal_Power * -1 ) );
			float dotResult5_g541 = dot( temp_output_4_0_g541 , temp_output_4_0_g541 );
			float temp_output_9_0_g541 = sqrt( ( 1.0 - saturate( dotResult5_g541 ) ) );
			float3 appendResult19_g541 = (fixed3(temp_output_4_0_g541.y , temp_output_4_0_g541.x , temp_output_9_0_g541));
			...
			float2 appendResult11_g540 = (fixed2(texArray3417.w , texArray3417.y));
			float2 temp_output_4_0_g540 = ( ( ( appendResult11_g540 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			float dotResult5_g540 = dot( temp_output_4_0_g540 , temp_output_4_0_g540 );
			float temp_output_9_0_g540 = sqrt( ( 1.0 - saturate( dotResult5_g540 ) ) );
			float3 appendResult10_g540 = (fixed3(temp_output_4_0_g540.x , temp_output_4_0_g540.y , temp_output_9_0_g540));
			float3 appendResult6874 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6408 = BlendComponents91;
			float3 weightedAvg6408 = ( ( weightedBlendVar6408.x*( appendResult19_g541 * appendResult6871 ) + weightedBlendVar6408.y*temp_output_6995_0 + weightedBlendVar6408.z*( appendResult10_g540 * appendResult6874 ) )/( weightedBlendVar6408.x + weightedBlendVar6408.y + weightedBlendVar6408.z ) );
			...
			float2 appendResult11_g1109 = (fixed2(texArray3483.w , texArray3483.y));
			float2 temp_output_4_0_g1109 = ( ( ( appendResult11_g1109 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			...
			float3 appendResult10_g1109 = (fixed3(temp_output_4_0_g1109.x , temp_output_4_0_g1109.y , temp_output_9_0_g1109));
			float3 temp_output_6998_0 = appendResult10_g1109;
			float4 texArray3512 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3478_0, _Texture_4_Normal_Index)  );
			float2 appendResult11_g542 = (fixed2(texArray3512.w , texArray3512.y));
			float2 temp_output_4_0_g542 = ( ( ( appendResult11_g542 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_4_Normal_Power * -1 ) );
			float dotResult5_g542 = dot( temp_output_4_0_g542 , temp_output_4_0_g542 );
			float temp_output_9_0_g542 = sqrt( ( 1.0 - saturate( dotResult5_g542 ) ) );
			float3 appendResult19_g542 = (fixed3(temp_output_4_0_g542.y , temp_output_4_0_g542.x , temp_output_9_0_g542));
			...
			float2 appendResult11_g538 = (fixed2(texArray3484.w , texArray3484.y));
			float2 temp_output_4_0_g538 = ( ( ( appendResult11_g538 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			float dotResult5_g538 = dot( temp_output_4_0_g538 , temp_output_4_0_g538 );
			float temp_output_9_0_g538 = sqrt( ( 1.0 - saturate( dotResult5_g538 ) ) );
			float3 appendResult10_g538 = (fixed3(temp_output_4_0_g538.x , temp_output_4_0_g538.y , temp_output_9_0_g538));
			float3 appendResult6881 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6415 = BlendComponents91;
			float3 weightedAvg6415 = ( ( weightedBlendVar6415.x*( appendResult19_g542 * appendResult6878 ) + weightedBlendVar6415.y*temp_output_6998_0 + weightedBlendVar6415.z*( appendResult10_g538 * appendResult6881 ) )/( weightedBlendVar6415.x + weightedBlendVar6415.y + weightedBlendVar6415.z ) );
			...
			float2 appendResult11_g1114 = (fixed2(texArray4417.w , texArray4417.y));
			float2 temp_output_4_0_g1114 = ( ( ( appendResult11_g1114 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_5_Normal_Power * -1 ) );
			float dotResult5_g1114 = dot( temp_output_4_0_g1114 , temp_output_4_0_g1114 );
			float temp_output_9_0_g1114 = sqrt( ( 1.0 - saturate( dotResult5_g1114 ) ) );
			float3 appendResult19_g1114 = (fixed3(temp_output_4_0_g1114.y , temp_output_4_0_g1114.x , temp_output_9_0_g1114));
			...
			float2 appendResult11_g1113 = (fixed2(texArray4422.w , texArray4422.y));
			float2 temp_output_4_0_g1113 = ( ( ( appendResult11_g1113 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
			float dotResult5_g1113 = dot( temp_output_4_0_g1113 , temp_output_4_0_g1113 );
			float temp_output_9_0_g1113 = sqrt( ( 1.0 - saturate( dotResult5_g1113 ) ) );
			float3 appendResult10_g1113 = (fixed3(temp_output_4_0_g1113.x , temp_output_4_0_g1113.y , temp_output_9_0_g1113));
			float3 appendResult6888 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6422 = BlendComponents91;
			float3 weightedAvg6422 = ( ( weightedBlendVar6422.x*( appendResult19_g1114 * appendResult6885 ) + weightedBlendVar6422.y*temp_output_7001_0 + weightedBlendVar6422.z*( appendResult10_g1113 * appendResult6888 ) )/( weightedBlendVar6422.x + weightedBlendVar6422.y + weightedBlendVar6422.z ) );
			...
			float2 appendResult11_g1122 = (fixed2(texArray4493.w , texArray4493.y));
			float2 temp_output_4_0_g1122 = ( ( ( appendResult11_g1122 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			float dotResult5_g1122 = dot( temp_output_4_0_g1122 , temp_output_4_0_g1122 );
			float temp_output_9_0_g1122 = sqrt( ( 1.0 - saturate( dotResult5_g1122 ) ) );
			float3 appendResult10_g1122 = (fixed3(temp_output_4_0_g1122.x , temp_output_4_0_g1122.y , temp_output_9_0_g1122));
			float3 temp_output_7004_0 = appendResult10_g1122;
			float4 texArray4486 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4472_0, _Texture_6_Normal_Index)  );
			float2 appendResult11_g1115 = (fixed2(texArray4486.w , texArray4486.y));
			float2 temp_output_4_0_g1115 = ( ( ( appendResult11_g1115 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_6_Normal_Power * -1 ) );
			float dotResult5_g1115 = dot( temp_output_4_0_g1115 , temp_output_4_0_g1115 );
			float temp_output_9_0_g1115 = sqrt( ( 1.0 - saturate( dotResult5_g1115 ) ) );
			float3 appendResult19_g1115 = (fixed3(temp_output_4_0_g1115.y , temp_output_4_0_g1115.x , temp_output_9_0_g1115));
			...
			float2 appendResult11_g1111 = (fixed2(texArray4491.w , texArray4491.y));
			float2 temp_output_4_0_g1111 = ( ( ( appendResult11_g1111 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			...
			float3 appendResult10_g1111 = (fixed3(temp_output_4_0_g1111.x , temp_output_4_0_g1111.y , temp_output_9_0_g1111));
			float3 appendResult6895 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6429 = BlendComponents91;
			float3 weightedAvg6429 = ( ( weightedBlendVar6429.x*( appendResult19_g1115 * appendResult6892 ) + weightedBlendVar6429.y*temp_output_7004_0 + weightedBlendVar6429.z*( appendResult10_g1111 * appendResult6895 ) )/( weightedBlendVar6429.x + weightedBlendVar6429.y + weightedBlendVar6429.z ) );
			...
			float2 appendResult11_g1126 = (fixed2(texArray4567.w , texArray4567.y));
			float2 temp_output_4_0_g1126 = ( ( ( appendResult11_g1126 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
			...
			float3 temp_output_7007_0 = appendResult10_g1126;
			float4 texArray4560 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4546_0, _Texture_7_Normal_Index)  );
			float2 appendResult11_g1119 = (fixed2(texArray4560.w , texArray4560.y));
			float2 temp_output_4_0_g1119 = ( ( ( appendResult11_g1119 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_7_Normal_Power * -1 ) );
			float dotResult5_g1119 = dot( temp_output_4_0_g1119 , temp_output_4_0_g1119 );
			float temp_output_9_0_g1119 = sqrt( ( 1.0 - saturate( dotResult5_g1119 ) ) );
			float3 appendResult19_g1119 = (fixed3(temp_output_4_0_g1119.y , temp_output_4_0_g1119.x , temp_output_9_0_g1119));
			...
			float2 appendResult11_g1117 = (fixed2(texArray4565.w , texArray4565.y));
			float2 temp_output_4_0_g1117 = ( ( ( appendResult11_g1117 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
			float dotResult5_g1117 = dot( temp_output_4_0_g1117 , temp_output_4_0_g1117 );
			float temp_output_9_0_g1117 = sqrt( ( 1.0 - saturate( dotResult5_g1117 ) ) );
			float3 appendResult10_g1117 = (fixed3(temp_output_4_0_g1117.x , temp_output_4_0_g1117.y , temp_output_9_0_g1117));
			float3 appendResult6902 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6436 = BlendComponents91;
			float3 weightedAvg6436 = ( ( weightedBlendVar6436.x*( appendResult19_g1119 * appendResult6899 ) + weightedBlendVar6436.y*temp_output_7007_0 + weightedBlendVar6436.z*( appendResult10_g1117 * appendResult6902 ) )/( weightedBlendVar6436.x + weightedBlendVar6436.y + weightedBlendVar6436.z ) );
			...
			float2 appendResult11_g1121 = (fixed2(texArray4641.w , texArray4641.y));
			float2 temp_output_4_0_g1121 = ( ( ( appendResult11_g1121 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			float dotResult5_g1121 = dot( temp_output_4_0_g1121 , temp_output_4_0_g1121 );
			float temp_output_9_0_g1121 = sqrt( ( 1.0 - saturate( dotResult5_g1121 ) ) );
			float3 appendResult10_g1121 = (fixed3(temp_output_4_0_g1121.x , temp_output_4_0_g1121.y , temp_output_9_0_g1121));
			float3 temp_output_7010_0 = appendResult10_g1121;
			float4 texArray4634 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4620_0, _Texture_8_Normal_Index)  );
			float2 appendResult11_g1110 = (fixed2(texArray4634.w , texArray4634.y));
			float2 temp_output_4_0_g1110 = ( ( ( appendResult11_g1110 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_8_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1110 = (fixed3(temp_output_4_0_g1110.y , temp_output_4_0_g1110.x , temp_output_9_0_g1110));
			...
			float2 appendResult11_g1116 = (fixed2(texArray4639.w , texArray4639.y));
			float2 temp_output_4_0_g1116 = ( ( ( appendResult11_g1116 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			float dotResult5_g1116 = dot( temp_output_4_0_g1116 , temp_output_4_0_g1116 );
			float temp_output_9_0_g1116 = sqrt( ( 1.0 - saturate( dotResult5_g1116 ) ) );
			float3 appendResult10_g1116 = (fixed3(temp_output_4_0_g1116.x , temp_output_4_0_g1116.y , temp_output_9_0_g1116));
			float3 appendResult6909 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6443 = BlendComponents91;
			float3 weightedAvg6443 = ( ( weightedBlendVar6443.x*( appendResult19_g1110 * appendResult6906 ) + weightedBlendVar6443.y*temp_output_7010_0 + weightedBlendVar6443.z*( appendResult10_g1116 * appendResult6909 ) )/( weightedBlendVar6443.x + weightedBlendVar6443.y + weightedBlendVar6443.z ) );
			...
			float2 appendResult11_g1148 = (fixed2(texArray4788.w , texArray4788.y));
			float2 temp_output_4_0_g1148 = ( ( ( appendResult11_g1148 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 temp_output_7034_0 = appendResult10_g1148;
			float4 texArray5285 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4706_0, _Texture_9_Normal_Index)  );
			float2 appendResult11_g1124 = (fixed2(texArray5285.x , texArray5285.y));
			float2 temp_output_4_0_g1124 = ( ( ( appendResult11_g1124 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_9_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1124 = (fixed3(temp_output_4_0_g1124.y , temp_output_4_0_g1124.x , temp_output_9_0_g1124));
			...
			float2 appendResult11_g1127 = (fixed2(texArray4783.w , texArray4783.y));
			float2 temp_output_4_0_g1127 = ( ( ( appendResult11_g1127 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 weightedAvg6450 = ( ( weightedBlendVar6450.x*( appendResult19_g1124 * appendResult6962 ) + weightedBlendVar6450.y*temp_output_7034_0 + weightedBlendVar6450.z*( appendResult10_g1127 * appendResult6965 ) )/( weightedBlendVar6450.x + weightedBlendVar6450.y + weightedBlendVar6450.z ) );
			...
			float2 appendResult11_g1149 = (fixed2(texArray4822.w , texArray4822.y));
			float2 temp_output_4_0_g1149 = ( ( ( appendResult11_g1149 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
			...
			float3 appendResult10_g1149 = (fixed3(temp_output_4_0_g1149.x , temp_output_4_0_g1149.y , temp_output_9_0_g1149));
			float3 temp_output_7031_0 = appendResult10_g1149;
			float4 texArray4798 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4742_0, _Texture_10_Normal_Index)  );
			float2 appendResult11_g1120 = (fixed2(texArray4798.w , texArray4798.y));
			float2 temp_output_4_0_g1120 = ( ( ( appendResult11_g1120 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_10_Normal_Power * -1 ) );
			float dotResult5_g1120 = dot( temp_output_4_0_g1120 , temp_output_4_0_g1120 );
			float temp_output_9_0_g1120 = sqrt( ( 1.0 - saturate( dotResult5_g1120 ) ) );
			float3 appendResult19_g1120 = (fixed3(temp_output_4_0_g1120.y , temp_output_4_0_g1120.x , temp_output_9_0_g1120));
			...
			float2 appendResult11_g1130 = (fixed2(texArray4791.w , texArray4791.y));
			float2 temp_output_4_0_g1130 = ( ( ( appendResult11_g1130 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
			...
			float3 appendResult10_g1130 = (fixed3(temp_output_4_0_g1130.x , temp_output_4_0_g1130.y , temp_output_9_0_g1130));
			float3 appendResult6958 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6457 = BlendComponents91;
			float3 weightedAvg6457 = ( ( weightedBlendVar6457.x*( appendResult19_g1120 * appendResult6955 ) + weightedBlendVar6457.y*temp_output_7031_0 + weightedBlendVar6457.z*( appendResult10_g1130 * appendResult6958 ) )/( weightedBlendVar6457.x + weightedBlendVar6457.y + weightedBlendVar6457.z ) );
			...
			float2 appendResult11_g1151 = (fixed2(texArray4856.w , texArray4856.y));
			float2 temp_output_4_0_g1151 = ( ( ( appendResult11_g1151 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
			...
			float3 appendResult10_g1151 = (fixed3(temp_output_4_0_g1151.x , temp_output_4_0_g1151.y , temp_output_9_0_g1151));
			float3 temp_output_7028_0 = appendResult10_g1151;
			float4 texArray4828 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4748_0, _Texture_11_Normal_Index)  );
			float2 appendResult11_g1123 = (fixed2(texArray4828.w , texArray4828.y));
			float2 temp_output_4_0_g1123 = ( ( ( appendResult11_g1123 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_11_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1123 = (fixed3(temp_output_4_0_g1123.y , temp_output_4_0_g1123.x , temp_output_9_0_g1123));
			...
			float2 appendResult11_g1131 = (fixed2(texArray4811.w , texArray4811.y));
			float2 temp_output_4_0_g1131 = ( ( ( appendResult11_g1131 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
			...
			float3 weightedAvg6464 = ( ( weightedBlendVar6464.x*( appendResult19_g1123 * appendResult6948 ) + weightedBlendVar6464.y*temp_output_7028_0 + weightedBlendVar6464.z*( appendResult10_g1131 * appendResult6951 ) )/( weightedBlendVar6464.x + weightedBlendVar6464.y + weightedBlendVar6464.z ) );
			...
			float2 appendResult11_g1146 = (fixed2(texArray4870.w , texArray4870.y));
			float2 temp_output_4_0_g1146 = ( ( ( appendResult11_g1146 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			float3 appendResult10_g1146 = (fixed3(temp_output_4_0_g1146.x , temp_output_4_0_g1146.y , temp_output_9_0_g1146));
			float3 temp_output_7025_0 = appendResult10_g1146;
			float4 texArray4850 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4758_0, _Texture_12_Normal_Index)  );
			float2 appendResult11_g1125 = (fixed2(texArray4850.w , texArray4850.y));
			float2 temp_output_4_0_g1125 = ( ( ( appendResult11_g1125 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_12_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1125 = (fixed3(temp_output_4_0_g1125.y , temp_output_4_0_g1125.x , temp_output_9_0_g1125));
			...
			float2 appendResult11_g1129 = (fixed2(texArray4852.w , texArray4852.y));
			float2 temp_output_4_0_g1129 = ( ( ( appendResult11_g1129 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			float3 appendResult10_g1129 = (fixed3(temp_output_4_0_g1129.x , temp_output_4_0_g1129.y , temp_output_9_0_g1129));
			float3 appendResult6944 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6471 = BlendComponents91;
			float3 weightedAvg6471 = ( ( weightedBlendVar6471.x*( appendResult19_g1125 * appendResult6941 ) + weightedBlendVar6471.y*temp_output_7025_0 + weightedBlendVar6471.z*( appendResult10_g1129 * appendResult6944 ) )/( weightedBlendVar6471.x + weightedBlendVar6471.y + weightedBlendVar6471.z ) );
			...
			float2 appendResult11_g1154 = (fixed2(texArray5120.w , texArray5120.y));
			float2 temp_output_4_0_g1154 = ( ( ( appendResult11_g1154 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 temp_output_7022_0 = appendResult10_g1154;
			float4 texArray5127 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5025_0, _Texture_13_Normal_Index)  );
			float2 appendResult11_g1150 = (fixed2(texArray5127.w , texArray5127.y));
			float2 temp_output_4_0_g1150 = ( ( ( appendResult11_g1150 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_13_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1150 = (fixed3(temp_output_4_0_g1150.y , temp_output_4_0_g1150.x , temp_output_9_0_g1150));
			...
			float2 appendResult11_g1141 = (fixed2(texArray5109.w , texArray5109.y));
			...
			float3 appendResult10_g1141 = (fixed3(temp_output_4_0_g1141.x , temp_output_4_0_g1141.y , temp_output_9_0_g1141));
			float3 appendResult6937 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6478 = BlendComponents91;
			float3 weightedAvg6478 = ( ( weightedBlendVar6478.x*( appendResult19_g1150 * appendResult6934 ) + weightedBlendVar6478.y*temp_output_7022_0 + weightedBlendVar6478.z*( appendResult10_g1141 * appendResult6937 ) )/( weightedBlendVar6478.x + weightedBlendVar6478.y + weightedBlendVar6478.z ) );
			...
			float2 appendResult11_g1153 = (fixed2(texArray5178.w , texArray5178.y));
			float2 temp_output_4_0_g1153 = ( ( ( appendResult11_g1153 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			...
			float3 appendResult10_g1153 = (fixed3(temp_output_4_0_g1153.x , temp_output_4_0_g1153.y , temp_output_9_0_g1153));
			float3 temp_output_7019_0 = appendResult10_g1153;
			float4 texArray5017 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5009_0, _Texture_14_Normal_Index)  );
			float2 appendResult11_g1143 = (fixed2(texArray5017.w , texArray5017.y));
			float2 temp_output_4_0_g1143 = ( ( ( appendResult11_g1143 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_14_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1143 = (fixed3(temp_output_4_0_g1143.y , temp_output_4_0_g1143.x , temp_output_9_0_g1143));
			...
			float2 appendResult11_g1144 = (fixed2(texArray5170.w , texArray5170.y));
			float2 temp_output_4_0_g1144 = ( ( ( appendResult11_g1144 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			...
			float3 appendResult10_g1144 = (fixed3(temp_output_4_0_g1144.x , temp_output_4_0_g1144.y , temp_output_9_0_g1144));
			float3 appendResult6930 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6485 = BlendComponents91;
			float3 weightedAvg6485 = ( ( weightedBlendVar6485.x*( appendResult19_g1143 * appendResult6927 ) + weightedBlendVar6485.y*temp_output_7019_0 + weightedBlendVar6485.z*( appendResult10_g1144 * appendResult6930 ) )/( weightedBlendVar6485.x + weightedBlendVar6485.y + weightedBlendVar6485.z ) );
			...
			float2 appendResult11_g1155 = (fixed2(texArray5246.w , texArray5246.y));
			float2 temp_output_4_0_g1155 = ( ( ( appendResult11_g1155 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 temp_output_7016_0 = appendResult10_g1155;
			float4 texArray5227 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5213_0, _Texture_15_Normal_Index)  );
			float2 appendResult11_g1142 = (fixed2(texArray5227.w , texArray5227.y));
			float2 temp_output_4_0_g1142 = ( ( ( appendResult11_g1142 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_15_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1142 = (fixed3(temp_output_4_0_g1142.y , temp_output_4_0_g1142.x , temp_output_9_0_g1142));
			...
			float2 appendResult11_g1140 = (fixed2(texArray5250.w , texArray5250.y));
			float2 temp_output_4_0_g1140 = ( ( ( appendResult11_g1140 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 appendResult10_g1140 = (fixed3(temp_output_4_0_g1140.x , temp_output_4_0_g1140.y , temp_output_9_0_g1140));
			float3 appendResult6923 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6492 = BlendComponents91;
			float3 weightedAvg6492 = ( ( weightedBlendVar6492.x*( appendResult19_g1142 * appendResult6920 ) + weightedBlendVar6492.y*temp_output_7016_0 + weightedBlendVar6492.z*( appendResult10_g1140 * appendResult6923 ) )/( weightedBlendVar6492.x + weightedBlendVar6492.y + weightedBlendVar6492.z ) );
			...
			float2 appendResult11_g1152 = (fixed2(texArray5099.w , texArray5099.y));
			float2 temp_output_4_0_g1152 = ( ( ( appendResult11_g1152 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			...
			float3 appendResult10_g1152 = (fixed3(temp_output_4_0_g1152.x , temp_output_4_0_g1152.y , temp_output_9_0_g1152));
			float3 temp_output_7013_0 = appendResult10_g1152;
			float4 texArray5082 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5079_0, _Texture_16_Normal_Index)  );
			float2 appendResult11_g1147 = (fixed2(texArray5082.w , texArray5082.y));
			float2 temp_output_4_0_g1147 = ( ( ( appendResult11_g1147 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_16_Normal_Power * -1 ) );
			...
			float3 appendResult19_g1147 = (fixed3(temp_output_4_0_g1147.y , temp_output_4_0_g1147.x , temp_output_9_0_g1147));
			...
			float2 appendResult11_g1145 = (fixed2(texArray4731.w , texArray4731.y));
			float2 temp_output_4_0_g1145 = ( ( ( appendResult11_g1145 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			...
			float3 appendResult10_g1145 = (fixed3(temp_output_4_0_g1145.x , temp_output_4_0_g1145.y , temp_output_9_0_g1145));
			float3 appendResult6916 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6499 = BlendComponents91;
			float3 weightedAvg6499 = ( ( weightedBlendVar6499.x*( appendResult19_g1147 * appendResult6913 ) + weightedBlendVar6499.y*temp_output_7013_0 + weightedBlendVar6499.z*( appendResult10_g1145 * appendResult6916 ) )/( weightedBlendVar6499.x + weightedBlendVar6499.y + weightedBlendVar6499.z ) );
			...
			float2 appendResult11_g1156 = (fixed2(texArray4382.w , texArray4382.y));
			float2 temp_output_4_0_g1156 = ( ( ( appendResult11_g1156 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Snow_Normal_Scale );
			...
			if( _Texture_Snow_Normal_Index <= -1 )
				...
				ifLocalVar7798 = appendResult10_g1156;
			...
			float clampResult8078 = clamp( ( tex2DNode7984.a + ( 1.0 - _Global_Color_Opacity_Power ) ) , 0 , 1 );
			float2 appendResult7986 = (fixed2(1 , ( lerpResult7983 * clampResult8078 )));
			...
			float3 appendResult7996 = (fixed3(tex2DNode7984.rgb));
			...
			fixed4 tex2DNode6968 = tex2D( _Texture_Geological_Map, temp_cast_2 );
			...
			fixed3 In08020 = float3( 0,0,0 );
			fixed localCameraRefresh8020 = CameraRefresh8020( In08020 );
			float temp_output_8067_0 = ( _Glitter_Refreshing_Speed * ( ( localCameraRefresh8020 * 10 ) + ( _WorldSpaceCameraPos.x + _WorldSpaceCameraPos.y + _WorldSpaceCameraPos.z ) ) );
			float temp_output_8025_0 = ( 0 + temp_output_8067_0 );
			float clampResult8042 = clamp( sin( ( temp_output_8025_0 * 0.1 ) ) , 0 , 1 );
			float2 temp_output_8062_0 = ( Top_Bottom1999 * ( 1 / _Glitter_Tiling ) );
			float2 appendResult8073 = (fixed2(temp_output_8062_0.y , temp_output_8062_0.x));
			fixed4 tex2DNode8041 = tex2D( _Texture_Glitter, ( appendResult8073 + float2( 0.37,0.67 ) ) );
			float2 panner8029 = ( temp_output_8062_0 + ( temp_output_8067_0 * 0.01 ) * float2( 1,1 ));
			...
			float clampResult8045 = clamp( pow( tex2D( _Texture_Glitter, ( ( rotator8031 + temp_output_8062_0 ) * float2( 0.2,0.2 ) ) ).r , ( 1.0 - _Glitter_Noise_Threshold ) ) , 0 , 1 );
			float lerpResult8048 = lerp(  ( clampResult8042 - 0.2 > 0 ? tex2D( _Texture_Glitter, temp_output_8062_0 ).r : clampResult8042 - 0.2 <= 0 && clampResult8042 + 0.2 >= 0 ? tex2DNode8041.r : tex2DNode8041.r )  , 0.6 , clampResult8045);
			...
			float clampResult8054 = clamp( temp_output_8052_0 , 0 , 1 );
			...
			float lerpResult8057 = lerp( ifLocalVar7802.w , _Glitter_Smoothness , clampResult8054);
			float lerpResult3951 = lerp( ( layeredBlend6532.w * _Terrain_Smoothness ) , lerpResult8057 , HeightMask6539);
