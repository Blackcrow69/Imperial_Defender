Shader "CTS/CTS Terrain Shader Basic CutOut"
{
	...
	SubShader
	{
		...
		inline fixed MyCustomExpression6279( inout fixed3 In0 )
		{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			fixed localTangent6263 = ( 0 );
			v.tangent.xyz = cross ( v.normal, float3( 0, 0, 1 ) );
			v.tangent.w = -1;
			fixed3 temp_cast_0 = (localTangent6263).xxx;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult6267 = (fixed2(ase_vertex3Pos.x , ase_vertex3Pos.z));
			fixed2 Top_Bottom1999 = appendResult6267;
			...
			float2 appendResult11_g982 = (fixed2(texArray5480.w , texArray5480.y));
			...
			float3 lerpResult5460 = lerp( appendResult10_g982 , appendResult10_g981 , UVmixDistance636);
			...
			float2 appendResult11_g943 = (fixed2(texArray3300.w , texArray3300.y));
			float2 temp_output_4_0_g943 = ( ( ( appendResult11_g943 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			...
			float3 temp_output_6001_0 = appendResult10_g943;
			...
			float2 appendResult6265 = (fixed2(ase_vertex3Pos.z , ase_vertex3Pos.y));
			fixed2 Front_Back1991 = appendResult6265;
			...
			float2 appendResult11_g772 = (fixed2(texArray3299.w , texArray3299.y));
			float2 temp_output_4_0_g772 = ( ( ( appendResult11_g772 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_1_Normal_Power * -1 ) );
			float dotResult5_g772 = dot( temp_output_4_0_g772 , temp_output_4_0_g772 );
			float temp_output_9_0_g772 = sqrt( ( 1.0 - saturate( dotResult5_g772 ) ) );
			float3 appendResult19_g772 = (fixed3(temp_output_4_0_g772.y , temp_output_4_0_g772.x , temp_output_9_0_g772));
			float3 appendResult5874 = (fixed3(ase_worldNormal.x , -1 , 1));
			float2 appendResult6266 = (fixed2(ase_vertex3Pos.x , ase_vertex3Pos.y));
			fixed2 Left_Right2003 = appendResult6266;
			...
			float2 appendResult11_g771 = (fixed2(texArray3301.w , texArray3301.y));
			float2 temp_output_4_0_g771 = ( ( ( appendResult11_g771 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			float dotResult5_g771 = dot( temp_output_4_0_g771 , temp_output_4_0_g771 );
			float temp_output_9_0_g771 = sqrt( ( 1.0 - saturate( dotResult5_g771 ) ) );
			float3 appendResult10_g771 = (fixed3(temp_output_4_0_g771.x , temp_output_4_0_g771.y , temp_output_9_0_g771));
			float3 appendResult5876 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar5676 = BlendComponents91;
			float3 weightedAvg5676 = ( ( weightedBlendVar5676.x*( appendResult19_g772 * appendResult5874 ) + weightedBlendVar5676.y*temp_output_6001_0 + weightedBlendVar5676.z*( appendResult10_g771 * appendResult5876 ) )/( weightedBlendVar5676.x + weightedBlendVar5676.y + weightedBlendVar5676.z ) );
			...
			float2 appendResult11_g945 = (fixed2(texArray3350.w , texArray3350.y));
			float2 temp_output_4_0_g945 = ( ( ( appendResult11_g945 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			...
			float3 temp_output_6005_0 = appendResult10_g945;
			...
			float2 appendResult11_g773 = (fixed2(texArray3384.w , texArray3384.y));
			float2 temp_output_4_0_g773 = ( ( ( appendResult11_g773 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_2_Normal_Power * -1 ) );
			float dotResult5_g773 = dot( temp_output_4_0_g773 , temp_output_4_0_g773 );
			float temp_output_9_0_g773 = sqrt( ( 1.0 - saturate( dotResult5_g773 ) ) );
			float3 appendResult19_g773 = (fixed3(temp_output_4_0_g773.y , temp_output_4_0_g773.x , temp_output_9_0_g773));
			...
			float2 appendResult11_g777 = (fixed2(texArray3351.w , texArray3351.y));
			float2 temp_output_4_0_g777 = ( ( ( appendResult11_g777 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			float dotResult5_g777 = dot( temp_output_4_0_g777 , temp_output_4_0_g777 );
			float temp_output_9_0_g777 = sqrt( ( 1.0 - saturate( dotResult5_g777 ) ) );
			float3 appendResult10_g777 = (fixed3(temp_output_4_0_g777.x , temp_output_4_0_g777.y , temp_output_9_0_g777));
			float3 appendResult5882 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar5499 = BlendComponents91;
			float3 weightedAvg5499 = ( ( weightedBlendVar5499.x*( appendResult19_g773 * appendResult5879 ) + weightedBlendVar5499.y*temp_output_6005_0 + weightedBlendVar5499.z*( appendResult10_g777 * appendResult5882 ) )/( weightedBlendVar5499.x + weightedBlendVar5499.y + weightedBlendVar5499.z ) );
			...
			float2 appendResult11_g941 = (fixed2(texArray3416.w , texArray3416.y));
			float2 temp_output_4_0_g941 = ( ( ( appendResult11_g941 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			...
			float3 temp_output_6008_0 = appendResult10_g941;
			...
			float2 appendResult11_g774 = (fixed2(texArray3445.w , texArray3445.y));
			float2 temp_output_4_0_g774 = ( ( ( appendResult11_g774 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_3_Normal_Power * -1 ) );
			float dotResult5_g774 = dot( temp_output_4_0_g774 , temp_output_4_0_g774 );
			float temp_output_9_0_g774 = sqrt( ( 1.0 - saturate( dotResult5_g774 ) ) );
			float3 appendResult19_g774 = (fixed3(temp_output_4_0_g774.y , temp_output_4_0_g774.x , temp_output_9_0_g774));
			...
			float2 appendResult11_g769 = (fixed2(texArray3417.w , texArray3417.y));
			float2 temp_output_4_0_g769 = ( ( ( appendResult11_g769 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			float dotResult5_g769 = dot( temp_output_4_0_g769 , temp_output_4_0_g769 );
			float temp_output_9_0_g769 = sqrt( ( 1.0 - saturate( dotResult5_g769 ) ) );
			float3 appendResult10_g769 = (fixed3(temp_output_4_0_g769.x , temp_output_4_0_g769.y , temp_output_9_0_g769));
			float3 appendResult5889 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar5503 = BlendComponents91;
			float3 weightedAvg5503 = ( ( weightedBlendVar5503.x*( appendResult19_g774 * appendResult5886 ) + weightedBlendVar5503.y*temp_output_6008_0 + weightedBlendVar5503.z*( appendResult10_g769 * appendResult5889 ) )/( weightedBlendVar5503.x + weightedBlendVar5503.y + weightedBlendVar5503.z ) );
			...
			float2 appendResult11_g939 = (fixed2(texArray3483.w , texArray3483.y));
			float2 temp_output_4_0_g939 = ( ( ( appendResult11_g939 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			...
			float3 temp_output_6011_0 = appendResult10_g939;
			...
			float2 appendResult11_g775 = (fixed2(texArray3512.w , texArray3512.y));
			float2 temp_output_4_0_g775 = ( ( ( appendResult11_g775 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_4_Normal_Power * -1 ) );
			float dotResult5_g775 = dot( temp_output_4_0_g775 , temp_output_4_0_g775 );
			float temp_output_9_0_g775 = sqrt( ( 1.0 - saturate( dotResult5_g775 ) ) );
			float3 appendResult19_g775 = (fixed3(temp_output_4_0_g775.y , temp_output_4_0_g775.x , temp_output_9_0_g775));
			...
			float2 appendResult11_g776 = (fixed2(texArray3484.w , texArray3484.y));
			float2 temp_output_4_0_g776 = ( ( ( appendResult11_g776 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			float dotResult5_g776 = dot( temp_output_4_0_g776 , temp_output_4_0_g776 );
			float temp_output_9_0_g776 = sqrt( ( 1.0 - saturate( dotResult5_g776 ) ) );
			float3 appendResult10_g776 = (fixed3(temp_output_4_0_g776.x , temp_output_4_0_g776.y , temp_output_9_0_g776));
			float3 appendResult5896 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar5507 = BlendComponents91;
			float3 weightedAvg5507 = ( ( weightedBlendVar5507.x*( appendResult19_g775 * appendResult5893 ) + weightedBlendVar5507.y*temp_output_6011_0 + weightedBlendVar5507.z*( appendResult10_g776 * appendResult5896 ) )/( weightedBlendVar5507.x + weightedBlendVar5507.y + weightedBlendVar5507.z ) );
			...
			float2 appendResult11_g956 = (fixed2(texArray4424.w , texArray4424.y));
			float2 temp_output_4_0_g956 = ( ( ( appendResult11_g956 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
			...
			float3 temp_output_6014_0 = appendResult10_g956;
			...
			float2 appendResult11_g946 = (fixed2(texArray4417.w , texArray4417.y));
			float2 temp_output_4_0_g946 = ( ( ( appendResult11_g946 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_5_Normal_Power * -1 ) );
			...
			float3 appendResult19_g946 = (fixed3(temp_output_4_0_g946.y , temp_output_4_0_g946.x , temp_output_9_0_g946));
			...
			float2 appendResult11_g942 = (fixed2(texArray4422.w , texArray4422.y));
			float2 temp_output_4_0_g942 = ( ( ( appendResult11_g942 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
			...
			float3 weightedAvg5511 = ( ( weightedBlendVar5511.x*( appendResult19_g946 * appendResult5900 ) + weightedBlendVar5511.y*temp_output_6014_0 + weightedBlendVar5511.z*( appendResult10_g942 * appendResult5903 ) )/( weightedBlendVar5511.x + weightedBlendVar5511.y + weightedBlendVar5511.z ) );
			...
			float2 appendResult11_g958 = (fixed2(texArray4493.w , texArray4493.y));
			float2 temp_output_4_0_g958 = ( ( ( appendResult11_g958 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			...
			float3 temp_output_6017_0 = appendResult10_g958;
			...
			float2 appendResult11_g937 = (fixed2(texArray4486.w , texArray4486.y));
			float2 temp_output_4_0_g937 = ( ( ( appendResult11_g937 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_6_Normal_Power * -1 ) );
			...
			float2 appendResult11_g944 = (fixed2(texArray4491.w , texArray4491.y));
			float2 temp_output_4_0_g944 = ( ( ( appendResult11_g944 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			...
			float3 weightedAvg5519 = ( ( weightedBlendVar5519.x*( appendResult19_g937 * appendResult5907 ) + weightedBlendVar5519.y*temp_output_6017_0 + weightedBlendVar5519.z*( appendResult10_g944 * appendResult5910 ) )/( weightedBlendVar5519.x + weightedBlendVar5519.y + weightedBlendVar5519.z ) );
			...
			float2 appendResult11_g953 = (fixed2(texArray4567.w , texArray4567.y));
			float2 temp_output_4_0_g953 = ( ( ( appendResult11_g953 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
			...
			float3 temp_output_6020_0 = appendResult10_g953;
			...
			float2 appendResult11_g936 = (fixed2(texArray4560.w , texArray4560.y));
			float2 temp_output_4_0_g936 = ( ( ( appendResult11_g936 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_7_Normal_Power * -1 ) );
			...
			float3 appendResult19_g936 = (fixed3(temp_output_4_0_g936.y , temp_output_4_0_g936.x , temp_output_9_0_g936));
			...
			float2 appendResult11_g940 = (fixed2(texArray4565.w , texArray4565.y));
			float2 temp_output_4_0_g940 = ( ( ( appendResult11_g940 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
			...
			float3 weightedAvg5523 = ( ( weightedBlendVar5523.x*( appendResult19_g936 * appendResult5914 ) + weightedBlendVar5523.y*temp_output_6020_0 + weightedBlendVar5523.z*( appendResult10_g940 * appendResult5917 ) )/( weightedBlendVar5523.x + weightedBlendVar5523.y + weightedBlendVar5523.z ) );
			...
			float2 appendResult11_g962 = (fixed2(texArray4641.w , texArray4641.y));
			float2 temp_output_4_0_g962 = ( ( ( appendResult11_g962 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			...
			float3 appendResult10_g962 = (fixed3(temp_output_4_0_g962.x , temp_output_4_0_g962.y , temp_output_9_0_g962));
			float3 temp_output_6023_0 = appendResult10_g962;
			...
			float2 appendResult11_g935 = (fixed2(texArray4634.w , texArray4634.y));
			float2 temp_output_4_0_g935 = ( ( ( appendResult11_g935 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_8_Normal_Power * -1 ) );
			...
			float2 appendResult11_g947 = (fixed2(texArray4639.w , texArray4639.y));
			float2 temp_output_4_0_g947 = ( ( ( appendResult11_g947 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			...
			float3 weightedAvg5527 = ( ( weightedBlendVar5527.x*( appendResult19_g935 * appendResult5921 ) + weightedBlendVar5527.y*temp_output_6023_0 + weightedBlendVar5527.z*( appendResult10_g947 * appendResult5924 ) )/( weightedBlendVar5527.x + weightedBlendVar5527.y + weightedBlendVar5527.z ) );
			...
			float2 appendResult11_g972 = (fixed2(texArray4788.w , texArray4788.y));
			...
			float3 temp_output_6047_0 = appendResult10_g972;
			...
			float2 appendResult11_g963 = (fixed2(texArray5285.w , texArray5285.y));
			float2 temp_output_4_0_g963 = ( ( ( appendResult11_g963 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_9_Normal_Power * -1 ) );
			...
			float3 appendResult19_g963 = (fixed3(temp_output_4_0_g963.y , temp_output_4_0_g963.x , temp_output_9_0_g963));
			...
			float2 appendResult11_g948 = (fixed2(texArray4783.w , texArray4783.y));
			float2 temp_output_4_0_g948 = ( ( ( appendResult11_g948 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 appendResult10_g948 = (fixed3(temp_output_4_0_g948.x , temp_output_4_0_g948.y , temp_output_9_0_g948));
			float3 appendResult5980 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar5491 = BlendComponents91;
			float3 weightedAvg5491 = ( ( weightedBlendVar5491.x*( appendResult19_g963 * appendResult5977 ) + weightedBlendVar5491.y*temp_output_6047_0 + weightedBlendVar5491.z*( appendResult10_g948 * appendResult5980 ) )/( weightedBlendVar5491.x + weightedBlendVar5491.y + weightedBlendVar5491.z ) );
			...
			float2 appendResult11_g974 = (fixed2(texArray4822.w , texArray4822.y));
			float2 temp_output_4_0_g974 = ( ( ( appendResult11_g974 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
			...
			float3 temp_output_6044_0 = appendResult10_g974;
			...
			float2 appendResult11_g954 = (fixed2(texArray4791.w , texArray4791.y));
			float2 temp_output_4_0_g954 = ( ( ( appendResult11_g954 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
			...
			float3 weightedAvg5531 = ( ( weightedBlendVar5531.x*( appendResult19_g961 * appendResult5970 ) + weightedBlendVar5531.y*temp_output_6044_0 + weightedBlendVar5531.z*( appendResult10_g954 * appendResult5973 ) )/( weightedBlendVar5531.x + weightedBlendVar5531.y + weightedBlendVar5531.z ) );
			...
			float2 appendResult11_g968 = (fixed2(texArray4856.w , texArray4856.y));
			float2 temp_output_4_0_g968 = ( ( ( appendResult11_g968 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
			...
			float3 temp_output_6041_0 = appendResult10_g968;
			...
			float2 appendResult11_g959 = (fixed2(texArray4828.w , texArray4828.y));
			float2 temp_output_4_0_g959 = ( ( ( appendResult11_g959 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_11_Normal_Power * -1 ) );
			...
			float3 appendResult19_g959 = (fixed3(temp_output_4_0_g959.y , temp_output_4_0_g959.x , temp_output_9_0_g959));
			...
			float2 appendResult11_g957 = (fixed2(texArray4811.w , texArray4811.y));
			float2 temp_output_4_0_g957 = ( ( ( appendResult11_g957 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
			...
			float3 weightedAvg5535 = ( ( weightedBlendVar5535.x*( appendResult19_g959 * appendResult5963 ) + weightedBlendVar5535.y*temp_output_6041_0 + weightedBlendVar5535.z*( appendResult10_g957 * appendResult5966 ) )/( weightedBlendVar5535.x + weightedBlendVar5535.y + weightedBlendVar5535.z ) );
			...
			float2 appendResult11_g966 = (fixed2(texArray4870.w , texArray4870.y));
			float2 temp_output_4_0_g966 = ( ( ( appendResult11_g966 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			float3 temp_output_6038_0 = appendResult10_g966;
			...
			float2 appendResult11_g960 = (fixed2(texArray4850.w , texArray4850.y));
			float2 temp_output_4_0_g960 = ( ( ( appendResult11_g960 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_12_Normal_Power * -1 ) );
			...
			float2 appendResult11_g955 = (fixed2(texArray4852.w , texArray4852.y));
			float2 temp_output_4_0_g955 = ( ( ( appendResult11_g955 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			float3 weightedAvg5539 = ( ( weightedBlendVar5539.x*( appendResult19_g960 * appendResult5956 ) + weightedBlendVar5539.y*temp_output_6038_0 + weightedBlendVar5539.z*( appendResult10_g955 * appendResult5959 ) )/( weightedBlendVar5539.x + weightedBlendVar5539.y + weightedBlendVar5539.z ) );
			...
			float2 appendResult11_g978 = (fixed2(texArray5120.w , texArray5120.y));
			float2 temp_output_4_0_g978 = ( ( ( appendResult11_g978 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 temp_output_6035_0 = appendResult10_g978;
			...
			float2 appendResult11_g975 = (fixed2(texArray5127.w , texArray5127.y));
			float2 temp_output_4_0_g975 = ( ( ( appendResult11_g975 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_13_Normal_Power * -1 ) );
			...
			float3 appendResult19_g975 = (fixed3(temp_output_4_0_g975.y , temp_output_4_0_g975.x , temp_output_9_0_g975));
			...
			float2 appendResult11_g965 = (fixed2(texArray5109.w , texArray5109.y));
			float2 temp_output_4_0_g965 = ( ( ( appendResult11_g965 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 appendResult10_g965 = (fixed3(temp_output_4_0_g965.x , temp_output_4_0_g965.y , temp_output_9_0_g965));
			float3 appendResult5952 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar5543 = BlendComponents91;
			float3 weightedAvg5543 = ( ( weightedBlendVar5543.x*( appendResult19_g975 * appendResult5949 ) + weightedBlendVar5543.y*temp_output_6035_0 + weightedBlendVar5543.z*( appendResult10_g965 * appendResult5952 ) )/( weightedBlendVar5543.x + weightedBlendVar5543.y + weightedBlendVar5543.z ) );
			...
			float2 appendResult11_g979 = (fixed2(texArray5178.w , texArray5178.y));
			float2 temp_output_4_0_g979 = ( ( ( appendResult11_g979 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			...
			float3 temp_output_6032_0 = appendResult10_g979;
			...
			float2 appendResult11_g969 = (fixed2(texArray5017.w , texArray5017.y));
			float2 temp_output_4_0_g969 = ( ( ( appendResult11_g969 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_14_Normal_Power * -1 ) );
			...
			float3 appendResult19_g969 = (fixed3(temp_output_4_0_g969.y , temp_output_4_0_g969.x , temp_output_9_0_g969));
			...
			float3 weightedAvg5547 = ( ( weightedBlendVar5547.x*( appendResult19_g969 * appendResult5942 ) + weightedBlendVar5547.y*temp_output_6032_0 + weightedBlendVar5547.z*( appendResult10_g971 * appendResult5945 ) )/( weightedBlendVar5547.x + weightedBlendVar5547.y + weightedBlendVar5547.z ) );
			...
			float2 appendResult11_g976 = (fixed2(texArray5246.w , texArray5246.y));
			float2 temp_output_4_0_g976 = ( ( ( appendResult11_g976 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 temp_output_6029_0 = appendResult10_g976;
			...
			float2 appendResult11_g964 = (fixed2(texArray5227.w , texArray5227.y));
			float2 temp_output_4_0_g964 = ( ( ( appendResult11_g964 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_15_Normal_Power * -1 ) );
			...
			float2 appendResult11_g967 = (fixed2(texArray5250.w , texArray5250.y));
			...
			float3 weightedAvg5551 = ( ( weightedBlendVar5551.x*( appendResult19_g964 * appendResult5935 ) + weightedBlendVar5551.y*temp_output_6029_0 + weightedBlendVar5551.z*( appendResult10_g967 * appendResult5938 ) )/( weightedBlendVar5551.x + weightedBlendVar5551.y + weightedBlendVar5551.z ) );
			...
			float2 appendResult11_g977 = (fixed2(texArray5099.w , texArray5099.y));
			float2 temp_output_4_0_g977 = ( ( ( appendResult11_g977 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			...
			float3 temp_output_6026_0 = appendResult10_g977;
			...
			float2 appendResult11_g973 = (fixed2(texArray5082.w , texArray5082.y));
			float2 temp_output_4_0_g973 = ( ( ( appendResult11_g973 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_16_Normal_Power * -1 ) );
			...
			float3 appendResult19_g973 = (fixed3(temp_output_4_0_g973.y , temp_output_4_0_g973.x , temp_output_9_0_g973));
			...
			float2 appendResult11_g970 = (fixed2(texArray4731.w , texArray4731.y));
			float2 temp_output_4_0_g970 = ( ( ( appendResult11_g970 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			...
			float3 weightedAvg5555 = ( ( weightedBlendVar5555.x*( appendResult19_g973 * appendResult5928 ) + weightedBlendVar5555.y*temp_output_6026_0 + weightedBlendVar5555.z*( appendResult10_g970 * appendResult5931 ) )/( weightedBlendVar5555.x + weightedBlendVar5555.y + weightedBlendVar5555.z ) );
			...
			if( _Texture_Snow_Normal_Index <= -1 )
				...
				ifLocalVar6166 = appendResult10_g980;
			...
			float clampResult6326 = clamp( ( tex2DNode6204.a + ( 1.0 - _Global_Color_Opacity_Power ) ) , 0 , 1 );
			float2 appendResult6241 = (fixed2(1 , ( lerpResult6230 * clampResult6326 )));
			...
			fixed3 In06279 = float3( 0,0,0 );
			fixed localMyCustomExpression6279 = MyCustomExpression6279( In06279 );
			float temp_output_6283_0 = ( _Glitter_Refreshing_Speed * ( ( localMyCustomExpression6279 * 10 ) + ( _WorldSpaceCameraPos.x + _WorldSpaceCameraPos.y + _WorldSpaceCameraPos.z ) ) );
			float temp_output_6286_0 = ( 0 + temp_output_6283_0 );
			float clampResult6298 = clamp( sin( ( temp_output_6286_0 * 0.1 ) ) , 0 , 1 );
			float2 temp_output_6289_0 = ( Top_Bottom1999 * ( 1 / _Glitter_Tiling ) );
			float2 appendResult6321 = (fixed2(temp_output_6289_0.y , temp_output_6289_0.x));
			fixed4 tex2DNode6300 = tex2D( _Texture_Glitter, ( appendResult6321 + float2( 0.37,0.67 ) ) );
			float2 panner6290 = ( temp_output_6289_0 + ( temp_output_6283_0 * 0.01 ) * float2( 1,1 ));
			...
			float clampResult6302 = clamp( pow( tex2D( _Texture_Glitter, ( ( rotator6292 + temp_output_6289_0 ) * float2( 0.2,0.2 ) ) ).r , ( 1.0 - _Glitter_Noise_Threshold ) ) , 0 , 1 );
			float lerpResult6303 = lerp(  ( clampResult6298 - 0.2 > 0 ? tex2D( _Texture_Glitter, temp_output_6289_0 ).r : clampResult6298 - 0.2 <= 0 && clampResult6298 + 0.2 >= 0 ? tex2DNode6300.r : tex2DNode6300.r )  , 0.6 , clampResult6302);
			float clampResult6305 = clamp( pow( lerpResult6303 , 100.0 ) , 0 , 1 );
			...
			float clampResult6307 = clamp( temp_output_6306_0 , 0 , 1 );
			...
			float lerpResult6308 = lerp( ifLocalVar6165.w , _Glitter_Smoothness , clampResult6307);
			float lerpResult3951 = lerp( ( layeredBlend5646.w * _Terrain_Smoothness ) , lerpResult6308 , lerpResult3742);
