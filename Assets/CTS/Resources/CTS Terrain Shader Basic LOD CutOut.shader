Shader "CTS/CTS Terrain Shader Basic LOD CutOut"
{
	Properties
	{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			fixed localTangent6174 = ( 0 );
			v.tangent.xyz = cross ( v.normal, float3( 0, 0, 1 ) );
			v.tangent.w = -1;
			fixed3 temp_cast_0 = (localTangent6174).xxx;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult6176 = (fixed2(ase_vertex3Pos.x , ase_vertex3Pos.z));
			fixed2 Top_Bottom1999 = appendResult6176;
			...
			float2 appendResult11_g223 = (fixed2(texArray4374.w , texArray4374.y));
			...
			float3 appendResult10_g223 = (fixed3(temp_output_4_0_g223.x , temp_output_4_0_g223.y , temp_output_9_0_g223));
			float3 temp_output_6050_0 = appendResult10_g223;
			...
			fixed3 temp_cast_1 = (WorldNormalVector( i , _Vector0 ).y).xxx;
			float clampResult4302 = clamp( ( 1 * _Snow_Amount ) , 0.4 , 1 );
			...
			float3 lerpResult4350 = lerp( _Vector0 , temp_cast_1 , pow( clampResult4298 , 2 ));
			float3 clampResult4299 = clamp( ( lerpResult4350 * clampResult4298 ) , float3( 0,0,0 ) , float3( 1,0,0 ) );
			float clampResult3702 = clamp( pow( ( ( ( _Texture_16_Snow_Reduction * Splat4_A2546 ) + ( ( _Texture_15_Snow_Reduction * Splat4_B2545 ) + ( ( ( _Texture_13_Snow_Reduction * Splat4_R2543 ) + ( ( _Texture_12_Snow_Reduction * Splat3_A2540 ) + ( ( _Texture_11_Snow_Reduction * Splat3_B2539 ) + ( ( ( _Texture_9_Snow_Reduction * Splat3_R2537 ) + ( ( _Texture_8_Snow_Reduction * Splat2_A2109 ) + ( ( _Texture_7_Snow_Reduction * Splat2_B2108 ) + ( ( ( _Texture_5_Snow_Reduction * Splat2_R2106 ) + ( ( _Texture_1_Snow_Reduction * Splat1_R1438 ) + ( ( _Texture_2_Snow_Reduction * Splat1_G1441 ) + ( ( _Texture_3_Snow_Reduction * Splat1_B1442 ) + ( _Texture_4_Snow_Reduction * Splat1_A1491 ) ) ) ) ) + ( _Texture_6_Snow_Reduction * Splat2_G2107 ) ) ) ) ) + ( _Texture_10_Snow_Reduction * Splat3_G2538 ) ) ) ) ) + ( _Texture_14_Snow_Reduction * Splat4_G2544 ) ) ) ) * 5 ) , 3 ) , 0 , 1 );
			float3 lerpResult3742 = lerp( saturate( clampResult4299 ) , float3( 0,0,0 ) , clampResult3702);
			float3 lerpResult5722 = lerp( lerpResult3776 , lerpResult3906 , lerpResult3742.x);
			...
			fixed4 tex2DNode6148 = tex2D( _Global_Color_Map, ( _Global_Color_Map_Offset + ( _Global_Color_Map_Scale * uv_TexCoord2588 ) ) );
			float clampResult6182 = clamp( ( tex2DNode6148.a + ( 1.0 - _Global_Color_Opacity_Power ) ) , 0 , 1 );
			float2 appendResult6159 = (fixed2(1 , ( _Global_Color_Map_Far_Power * clampResult6182 )));
			...
			fixed4 Texture_1_Final950 = ifLocalVar6119;
			...
			fixed4 Texture_2_Final3385 = ifLocalVar6120;
			...
			fixed4 Texture_3_Final3451 = ifLocalVar6121;
			float4 texArray3473 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Albedo, float3(( ( Top_Bottom1999 * ( 1 / _Texture_4_Tiling ) ) / _Texture_4_Far_Multiplier ), _Texture_4_Albedo_Index)  );
			fixed4 ifLocalVar6122 = 0;
			UNITY_BRANCH 
			if( _Texture_4_Albedo_Index > -1 )
				ifLocalVar6122 = ( texArray3473 * _Texture_4_Color );
			fixed4 Texture_4_Final3518 = ifLocalVar6122;
			...
			fixed4 Texture_5_Final4396 = ifLocalVar6123;
			...
			fixed4 Texture_6_Final4536 = ifLocalVar6124;
			...
			fixed4 Texture_7_Final4614 = ifLocalVar6125;
			...
			fixed4 Texture_8_Final4689 = ifLocalVar6126;
			...
			fixed4 Texture_9_Final4987 = ifLocalVar6134;
			...
			fixed4 Texture_10_Final4994 = ifLocalVar6133;
			...
			fixed4 Texture_11_Final4996 = ifLocalVar6132;
			...
			fixed4 Texture_12_Final4997 = ifLocalVar6131;
			...
			fixed4 Texture_13_Final5058 = ifLocalVar6130;
			...
			fixed4 Texture_14_Final5163 = ifLocalVar6129;
			...
			fixed4 Texture_15_Final5270 = ifLocalVar6128;
			...
			fixed4 Texture_16_Final5094 = ifLocalVar6127;
			...
			float3 appendResult6149 = (fixed3(tex2DNode6148.r , tex2DNode6148.g , tex2DNode6148.b));
			...
			float3 lerpResult1356 = lerp( clampResult5715 , appendResult1410 , lerpResult3742.x);
			o.Albedo = lerpResult1356;
			float3 clampResult5471 = clamp( appendResult1410 , float3( 0,0,0 ) , float3( 0.5,0.5,0.5 ) );
			float3 lerpResult4040 = lerp( ( ( appendResult3857 * float3( 0.3,0.3,0.3 ) ) * _Terrain_Specular ) , ( clampResult5471 * _Snow_Specular ) , lerpResult3742.x);
			o.Specular = lerpResult4040;
			float lerpResult3951 = lerp( ( layeredBlend5646.w * _Terrain_Smoothness ) , ( _Texture_Snow_Average * _Snow_Color ).w , lerpResult3742.x);
			o.Smoothness = lerpResult3951;
			float clampResult6096 = clamp( ( ( 1 + temp_output_4100_0.y ) * 0.5 ) , ( 1 - _Ambient_Occlusion_Power ) , 1 );
			#ifdef _USE_AO_ON
			...
			float clampResult6167 = clamp( ( ase_worldPos.y + ( 0 - _Remove_Vert_Height ) ) , 0 , 1 );
			clip( ( tex2D( _Texture_Additional_Masks, uv_Texture_Additional_Masks ).a * clampResult6167 ) - _Cutoff );
		}
