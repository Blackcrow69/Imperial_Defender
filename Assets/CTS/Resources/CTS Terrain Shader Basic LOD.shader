Shader "CTS/CTS Terrain Shader Basic LOD"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			fixed localMyCustomExpression6172 = ( 0 );
			v.tangent.xyz = cross ( v.normal, float3( 0, 0, 1 ) );
			v.tangent.w = -1;
			fixed3 temp_cast_0 = (localMyCustomExpression6172).xxx;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult6171 = (fixed2(ase_vertex3Pos.x , ase_vertex3Pos.z));
			fixed2 Top_Bottom1999 = appendResult6171;
			...
			float clampResult6177 = clamp( ( tex2DNode6148.a + ( 1.0 - _Global_Color_Opacity_Power ) ) , 0 , 1 );
			float2 appendResult6159 = (fixed2(1 , ( _Global_Color_Map_Far_Power * clampResult6177 )));
