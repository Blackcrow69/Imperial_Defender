Shader "CTS/CTS Terrain Shader Advanced Mesh"
{
	Properties
	{
	...
	SubShader
	{
		...
		inline fixed MyCustomExpression8008( inout fixed3 In0 )
		{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 appendResult1998 = (fixed2(ase_worldPos.x , ase_worldPos.z));
			...
			float2 appendResult11_g973 = (fixed2(texArray6256.w , texArray6256.y));
			float2 temp_output_4_0_g973 = ( ( ( appendResult11_g973 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power_Close );
			...
			float2 appendResult11_g972 = (fixed2(texArray4374.w , texArray4374.y));
			float2 temp_output_4_0_g972 = ( ( ( appendResult11_g972 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Perlin_Normal_Power );
			...
			float3 lerpResult6257 = lerp( appendResult10_g973 , appendResult10_g972 , UVmixDistance636);
			...
			float2 appendResult879 = (fixed2(ase_worldPos.z , ase_worldPos.y));
			...
			float2 appendResult2002 = (fixed2(ase_worldPos.x , ase_worldPos.y));
			...
			float2 appendResult11_g918 = (fixed2(texArray3300.w , texArray3300.y));
			float2 temp_output_4_0_g918 = ( ( ( appendResult11_g918 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			...
			float3 temp_output_6989_0 = appendResult10_g918;
			float4 texArray3299 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3279_0, _Texture_1_Normal_Index)  );
			float2 appendResult11_g433 = (fixed2(texArray3299.w , texArray3299.y));
			float2 temp_output_4_0_g433 = ( ( ( appendResult11_g433 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_1_Normal_Power * -1 ) );
			...
			float3 appendResult19_g433 = (fixed3(temp_output_4_0_g433.y , temp_output_4_0_g433.x , temp_output_9_0_g433));
			...
			float2 appendResult11_g435 = (fixed2(texArray3301.w , texArray3301.y));
			float2 temp_output_4_0_g435 = ( ( ( appendResult11_g435 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_1_Normal_Power );
			...
			float3 weightedAvg6393 = ( ( weightedBlendVar6393.x*( appendResult19_g433 * appendResult6857 ) + weightedBlendVar6393.y*temp_output_6989_0 + weightedBlendVar6393.z*( appendResult10_g435 * appendResult6860 ) )/( weightedBlendVar6393.x + weightedBlendVar6393.y + weightedBlendVar6393.z ) );
			...
			float2 appendResult11_g919 = (fixed2(texArray3350.w , texArray3350.y));
			float2 temp_output_4_0_g919 = ( ( ( appendResult11_g919 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			...
			float3 temp_output_6992_0 = appendResult10_g919;
			float4 texArray3384 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3344_0, _Texture_2_Normal_Index)  );
			float2 appendResult11_g431 = (fixed2(texArray3384.w , texArray3384.y));
			float2 temp_output_4_0_g431 = ( ( ( appendResult11_g431 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_2_Normal_Power * -1 ) );
			...
			float3 appendResult19_g431 = (fixed3(temp_output_4_0_g431.y , temp_output_4_0_g431.x , temp_output_9_0_g431));
			...
			float2 appendResult11_g430 = (fixed2(texArray3351.w , texArray3351.y));
			float2 temp_output_4_0_g430 = ( ( ( appendResult11_g430 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_2_Normal_Power );
			float dotResult5_g430 = dot( temp_output_4_0_g430 , temp_output_4_0_g430 );
			float temp_output_9_0_g430 = sqrt( ( 1.0 - saturate( dotResult5_g430 ) ) );
			float3 appendResult10_g430 = (fixed3(temp_output_4_0_g430.x , temp_output_4_0_g430.y , temp_output_9_0_g430));
			float3 appendResult6867 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6401 = BlendComponents91;
			float3 weightedAvg6401 = ( ( weightedBlendVar6401.x*( appendResult19_g431 * appendResult6864 ) + weightedBlendVar6401.y*temp_output_6992_0 + weightedBlendVar6401.z*( appendResult10_g430 * appendResult6867 ) )/( weightedBlendVar6401.x + weightedBlendVar6401.y + weightedBlendVar6401.z ) );
			...
			float2 appendResult11_g922 = (fixed2(texArray3416.w , texArray3416.y));
			float2 temp_output_4_0_g922 = ( ( ( appendResult11_g922 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			...
			float3 temp_output_6995_0 = appendResult10_g922;
			float4 texArray3445 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_3411_0, _Texture_3_Normal_Index)  );
			float2 appendResult11_g432 = (fixed2(texArray3445.w , texArray3445.y));
			float2 temp_output_4_0_g432 = ( ( ( appendResult11_g432 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_3_Normal_Power * -1 ) );
			...
			float3 appendResult19_g432 = (fixed3(temp_output_4_0_g432.y , temp_output_4_0_g432.x , temp_output_9_0_g432));
			...
			float2 appendResult11_g437 = (fixed2(texArray3417.w , texArray3417.y));
			float2 temp_output_4_0_g437 = ( ( ( appendResult11_g437 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_3_Normal_Power );
			...
			float3 appendResult10_g437 = (fixed3(temp_output_4_0_g437.x , temp_output_4_0_g437.y , temp_output_9_0_g437));
			float3 appendResult6874 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6408 = BlendComponents91;
			float3 weightedAvg6408 = ( ( weightedBlendVar6408.x*( appendResult19_g432 * appendResult6871 ) + weightedBlendVar6408.y*temp_output_6995_0 + weightedBlendVar6408.z*( appendResult10_g437 * appendResult6874 ) )/( weightedBlendVar6408.x + weightedBlendVar6408.y + weightedBlendVar6408.z ) );
			...
			float2 appendResult11_g925 = (fixed2(texArray3483.w , texArray3483.y));
			float2 temp_output_4_0_g925 = ( ( ( appendResult11_g925 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			...
			float3 temp_output_6998_0 = appendResult10_g925;
			...
			float2 appendResult11_g434 = (fixed2(texArray3484.w , texArray3484.y));
			float2 temp_output_4_0_g434 = ( ( ( appendResult11_g434 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_4_Normal_Power );
			...
			float3 appendResult10_g434 = (fixed3(temp_output_4_0_g434.x , temp_output_4_0_g434.y , temp_output_9_0_g434));
			float3 appendResult6881 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6415 = BlendComponents91;
			float3 weightedAvg6415 = ( ( weightedBlendVar6415.x*( appendResult19_g436 * appendResult6878 ) + weightedBlendVar6415.y*temp_output_6998_0 + weightedBlendVar6415.z*( appendResult10_g434 * appendResult6881 ) )/( weightedBlendVar6415.x + weightedBlendVar6415.y + weightedBlendVar6415.z ) );
			...
			float2 appendResult11_g945 = (fixed2(texArray4424.w , texArray4424.y));
			float2 temp_output_4_0_g945 = ( ( ( appendResult11_g945 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
			...
			float3 temp_output_7001_0 = appendResult10_g945;
			float4 texArray4417 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4400_0, _Texture_5_Normal_Index)  );
			float2 appendResult11_g924 = (fixed2(texArray4417.w , texArray4417.y));
			float2 temp_output_4_0_g924 = ( ( ( appendResult11_g924 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_5_Normal_Power * -1 ) );
			...
			float2 appendResult11_g923 = (fixed2(texArray4422.w , texArray4422.y));
			float2 temp_output_4_0_g923 = ( ( ( appendResult11_g923 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_5_Normal_Power );
			...
			float3 weightedAvg6422 = ( ( weightedBlendVar6422.x*( appendResult19_g924 * appendResult6885 ) + weightedBlendVar6422.y*temp_output_7001_0 + weightedBlendVar6422.z*( appendResult10_g923 * appendResult6888 ) )/( weightedBlendVar6422.x + weightedBlendVar6422.y + weightedBlendVar6422.z ) );
			...
			float2 appendResult11_g943 = (fixed2(texArray4493.w , texArray4493.y));
			float2 temp_output_4_0_g943 = ( ( ( appendResult11_g943 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			...
			float3 appendResult10_g943 = (fixed3(temp_output_4_0_g943.x , temp_output_4_0_g943.y , temp_output_9_0_g943));
			float3 temp_output_7004_0 = appendResult10_g943;
			float4 texArray4486 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4472_0, _Texture_6_Normal_Index)  );
			float2 appendResult11_g928 = (fixed2(texArray4486.w , texArray4486.y));
			float2 temp_output_4_0_g928 = ( ( ( appendResult11_g928 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_6_Normal_Power * -1 ) );
			...
			float3 appendResult19_g928 = (fixed3(temp_output_4_0_g928.y , temp_output_4_0_g928.x , temp_output_9_0_g928));
			...
			float2 appendResult11_g920 = (fixed2(texArray4491.w , texArray4491.y));
			float2 temp_output_4_0_g920 = ( ( ( appendResult11_g920 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_6_Normal_Power );
			...
			float3 weightedAvg6429 = ( ( weightedBlendVar6429.x*( appendResult19_g928 * appendResult6892 ) + weightedBlendVar6429.y*temp_output_7004_0 + weightedBlendVar6429.z*( appendResult10_g920 * appendResult6895 ) )/( weightedBlendVar6429.x + weightedBlendVar6429.y + weightedBlendVar6429.z ) );
			...
			float2 appendResult11_g942 = (fixed2(texArray4567.w , texArray4567.y));
			...
			float3 temp_output_7007_0 = appendResult10_g942;
			float4 texArray4560 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4546_0, _Texture_7_Normal_Index)  );
			float2 appendResult11_g929 = (fixed2(texArray4560.w , texArray4560.y));
			float2 temp_output_4_0_g929 = ( ( ( appendResult11_g929 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_7_Normal_Power * -1 ) );
			...
			float2 appendResult11_g927 = (fixed2(texArray4565.w , texArray4565.y));
			float2 temp_output_4_0_g927 = ( ( ( appendResult11_g927 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_7_Normal_Power );
			...
			float3 weightedAvg6436 = ( ( weightedBlendVar6436.x*( appendResult19_g929 * appendResult6899 ) + weightedBlendVar6436.y*temp_output_7007_0 + weightedBlendVar6436.z*( appendResult10_g927 * appendResult6902 ) )/( weightedBlendVar6436.x + weightedBlendVar6436.y + weightedBlendVar6436.z ) );
			...
			float2 appendResult11_g934 = (fixed2(texArray4641.w , texArray4641.y));
			float2 temp_output_4_0_g934 = ( ( ( appendResult11_g934 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			...
			float3 temp_output_7010_0 = appendResult10_g934;
			float4 texArray4634 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4620_0, _Texture_8_Normal_Index)  );
			float2 appendResult11_g926 = (fixed2(texArray4634.w , texArray4634.y));
			float2 temp_output_4_0_g926 = ( ( ( appendResult11_g926 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_8_Normal_Power * -1 ) );
			...
			float3 appendResult19_g926 = (fixed3(temp_output_4_0_g926.y , temp_output_4_0_g926.x , temp_output_9_0_g926));
			...
			float2 appendResult11_g921 = (fixed2(texArray4639.w , texArray4639.y));
			float2 temp_output_4_0_g921 = ( ( ( appendResult11_g921 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_8_Normal_Power );
			...
			float3 weightedAvg6443 = ( ( weightedBlendVar6443.x*( appendResult19_g926 * appendResult6906 ) + weightedBlendVar6443.y*temp_output_7010_0 + weightedBlendVar6443.z*( appendResult10_g921 * appendResult6909 ) )/( weightedBlendVar6443.x + weightedBlendVar6443.y + weightedBlendVar6443.z ) );
			...
			float2 appendResult11_g956 = (fixed2(texArray4788.w , texArray4788.y));
			float2 temp_output_4_0_g956 = ( ( ( appendResult11_g956 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 temp_output_7034_0 = appendResult10_g956;
			float4 texArray5285 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4706_0, _Texture_9_Normal_Index)  );
			float2 appendResult11_g941 = (fixed2(texArray5285.x , texArray5285.y));
			float2 temp_output_4_0_g941 = ( ( ( appendResult11_g941 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_9_Normal_Power * -1 ) );
			...
			float3 appendResult19_g941 = (fixed3(temp_output_4_0_g941.y , temp_output_4_0_g941.x , temp_output_9_0_g941));
			...
			float2 appendResult11_g947 = (fixed2(texArray4783.w , texArray4783.y));
			float2 temp_output_4_0_g947 = ( ( ( appendResult11_g947 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_9_Normal_Power );
			...
			float3 weightedAvg6450 = ( ( weightedBlendVar6450.x*( appendResult19_g941 * appendResult6962 ) + weightedBlendVar6450.y*temp_output_7034_0 + weightedBlendVar6450.z*( appendResult10_g947 * appendResult6965 ) )/( weightedBlendVar6450.x + weightedBlendVar6450.y + weightedBlendVar6450.z ) );
			...
			float2 appendResult11_g960 = (fixed2(texArray4822.w , texArray4822.y));
			float2 temp_output_4_0_g960 = ( ( ( appendResult11_g960 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
			...
			float3 appendResult10_g960 = (fixed3(temp_output_4_0_g960.x , temp_output_4_0_g960.y , temp_output_9_0_g960));
			float3 temp_output_7031_0 = appendResult10_g960;
			float4 texArray4798 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4742_0, _Texture_10_Normal_Index)  );
			float2 appendResult11_g935 = (fixed2(texArray4798.w , texArray4798.y));
			float2 temp_output_4_0_g935 = ( ( ( appendResult11_g935 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_10_Normal_Power * -1 ) );
			...
			float3 appendResult19_g935 = (fixed3(temp_output_4_0_g935.y , temp_output_4_0_g935.x , temp_output_9_0_g935));
			...
			float2 appendResult11_g939 = (fixed2(texArray4791.w , texArray4791.y));
			float2 temp_output_4_0_g939 = ( ( ( appendResult11_g939 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_10_Normal_Power );
			...
			float3 weightedAvg6457 = ( ( weightedBlendVar6457.x*( appendResult19_g935 * appendResult6955 ) + weightedBlendVar6457.y*temp_output_7031_0 + weightedBlendVar6457.z*( appendResult10_g939 * appendResult6958 ) )/( weightedBlendVar6457.x + weightedBlendVar6457.y + weightedBlendVar6457.z ) );
			...
			float2 appendResult11_g940 = (fixed2(texArray4828.w , texArray4828.y));
			float2 temp_output_4_0_g940 = ( ( ( appendResult11_g940 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_11_Normal_Power * -1 ) );
			...
			float3 appendResult19_g940 = (fixed3(temp_output_4_0_g940.y , temp_output_4_0_g940.x , temp_output_9_0_g940));
			...
			float2 appendResult11_g946 = (fixed2(texArray4811.w , texArray4811.y));
			float2 temp_output_4_0_g946 = ( ( ( appendResult11_g946 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_11_Normal_Power );
			...
			float3 weightedAvg6464 = ( ( weightedBlendVar6464.x*( appendResult19_g940 * appendResult6948 ) + weightedBlendVar6464.y*temp_output_7028_0 + weightedBlendVar6464.z*( appendResult10_g946 * appendResult6951 ) )/( weightedBlendVar6464.x + weightedBlendVar6464.y + weightedBlendVar6464.z ) );
			...
			float2 appendResult11_g964 = (fixed2(texArray4870.w , texArray4870.y));
			float2 temp_output_4_0_g964 = ( ( ( appendResult11_g964 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			float3 appendResult10_g964 = (fixed3(temp_output_4_0_g964.x , temp_output_4_0_g964.y , temp_output_9_0_g964));
			float3 temp_output_7025_0 = appendResult10_g964;
			float4 texArray4850 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_4758_0, _Texture_12_Normal_Index)  );
			float2 appendResult11_g944 = (fixed2(texArray4850.w , texArray4850.y));
			float2 temp_output_4_0_g944 = ( ( ( appendResult11_g944 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_12_Normal_Power * -1 ) );
			...
			float2 appendResult11_g936 = (fixed2(texArray4852.w , texArray4852.y));
			float2 temp_output_4_0_g936 = ( ( ( appendResult11_g936 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_12_Normal_Power );
			...
			float3 weightedAvg6471 = ( ( weightedBlendVar6471.x*( appendResult19_g944 * appendResult6941 ) + weightedBlendVar6471.y*temp_output_7025_0 + weightedBlendVar6471.z*( appendResult10_g936 * appendResult6944 ) )/( weightedBlendVar6471.x + weightedBlendVar6471.y + weightedBlendVar6471.z ) );
			...
			float2 appendResult11_g970 = (fixed2(texArray5120.w , texArray5120.y));
			float2 temp_output_4_0_g970 = ( ( ( appendResult11_g970 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 appendResult10_g970 = (fixed3(temp_output_4_0_g970.x , temp_output_4_0_g970.y , temp_output_9_0_g970));
			float3 temp_output_7022_0 = appendResult10_g970;
			float4 texArray5127 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5025_0, _Texture_13_Normal_Index)  );
			float2 appendResult11_g962 = (fixed2(texArray5127.w , texArray5127.y));
			float2 temp_output_4_0_g962 = ( ( ( appendResult11_g962 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_13_Normal_Power * -1 ) );
			...
			float2 appendResult11_g957 = (fixed2(texArray5109.w , texArray5109.y));
			float2 temp_output_4_0_g957 = ( ( ( appendResult11_g957 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_13_Normal_Power );
			...
			float3 weightedAvg6478 = ( ( weightedBlendVar6478.x*( appendResult19_g962 * appendResult6934 ) + weightedBlendVar6478.y*temp_output_7022_0 + weightedBlendVar6478.z*( appendResult10_g957 * appendResult6937 ) )/( weightedBlendVar6478.x + weightedBlendVar6478.y + weightedBlendVar6478.z ) );
			...
			float2 appendResult11_g969 = (fixed2(texArray5178.w , texArray5178.y));
			float2 temp_output_4_0_g969 = ( ( ( appendResult11_g969 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			...
			float3 temp_output_7019_0 = appendResult10_g969;
			float4 texArray5017 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5009_0, _Texture_14_Normal_Index)  );
			float2 appendResult11_g965 = (fixed2(texArray5017.w , texArray5017.y));
			float2 temp_output_4_0_g965 = ( ( ( appendResult11_g965 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_14_Normal_Power * -1 ) );
			...
			float2 appendResult11_g959 = (fixed2(texArray5170.w , texArray5170.y));
			float2 temp_output_4_0_g959 = ( ( ( appendResult11_g959 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_14_Normal_Power );
			...
			float3 weightedAvg6485 = ( ( weightedBlendVar6485.x*( appendResult19_g965 * appendResult6927 ) + weightedBlendVar6485.y*temp_output_7019_0 + weightedBlendVar6485.z*( appendResult10_g959 * appendResult6930 ) )/( weightedBlendVar6485.x + weightedBlendVar6485.y + weightedBlendVar6485.z ) );
			...
			float2 appendResult11_g967 = (fixed2(texArray5246.w , texArray5246.y));
			float2 temp_output_4_0_g967 = ( ( ( appendResult11_g967 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 temp_output_7016_0 = appendResult10_g967;
			float4 texArray5227 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5213_0, _Texture_15_Normal_Index)  );
			float2 appendResult11_g958 = (fixed2(texArray5227.w , texArray5227.y));
			float2 temp_output_4_0_g958 = ( ( ( appendResult11_g958 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_15_Normal_Power * -1 ) );
			...
			float3 appendResult19_g958 = (fixed3(temp_output_4_0_g958.y , temp_output_4_0_g958.x , temp_output_9_0_g958));
			...
			float2 appendResult11_g955 = (fixed2(texArray5250.w , texArray5250.y));
			float2 temp_output_4_0_g955 = ( ( ( appendResult11_g955 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_15_Normal_Power );
			...
			float3 weightedAvg6492 = ( ( weightedBlendVar6492.x*( appendResult19_g958 * appendResult6920 ) + weightedBlendVar6492.y*temp_output_7016_0 + weightedBlendVar6492.z*( appendResult10_g955 * appendResult6923 ) )/( weightedBlendVar6492.x + weightedBlendVar6492.y + weightedBlendVar6492.z ) );
			...
			float2 appendResult11_g968 = (fixed2(texArray5099.w , texArray5099.y));
			float2 temp_output_4_0_g968 = ( ( ( appendResult11_g968 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			...
			float3 appendResult10_g968 = (fixed3(temp_output_4_0_g968.x , temp_output_4_0_g968.y , temp_output_9_0_g968));
			float3 temp_output_7013_0 = appendResult10_g968;
			float4 texArray5082 = UNITY_SAMPLE_TEX2DARRAY(_Texture_Array_Normal, float3(temp_output_5079_0, _Texture_16_Normal_Index)  );
			float2 appendResult11_g961 = (fixed2(texArray5082.w , texArray5082.y));
			float2 temp_output_4_0_g961 = ( ( ( appendResult11_g961 * float2( 2,2 ) ) + float2( -1,-1 ) ) * ( _Texture_16_Normal_Power * -1 ) );
			...
			float2 appendResult11_g963 = (fixed2(texArray4731.w , texArray4731.y));
			float2 temp_output_4_0_g963 = ( ( ( appendResult11_g963 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Texture_16_Normal_Power );
			float dotResult5_g963 = dot( temp_output_4_0_g963 , temp_output_4_0_g963 );
			float temp_output_9_0_g963 = sqrt( ( 1.0 - saturate( dotResult5_g963 ) ) );
			float3 appendResult10_g963 = (fixed3(temp_output_4_0_g963.x , temp_output_4_0_g963.y , temp_output_9_0_g963));
			float3 appendResult6916 = (fixed3(1 , ( ase_worldNormal.z * -1 ) , 1));
			float3 weightedBlendVar6499 = BlendComponents91;
			float3 weightedAvg6499 = ( ( weightedBlendVar6499.x*( appendResult19_g961 * appendResult6913 ) + weightedBlendVar6499.y*temp_output_7013_0 + weightedBlendVar6499.z*( appendResult10_g963 * appendResult6916 ) )/( weightedBlendVar6499.x + weightedBlendVar6499.y + weightedBlendVar6499.z ) );
			...
			float2 appendResult11_g971 = (fixed2(texArray4382.w , texArray4382.y));
			float2 temp_output_4_0_g971 = ( ( ( appendResult11_g971 * float2( 2,2 ) ) + float2( -1,-1 ) ) * _Snow_Normal_Scale );
			...
			if( _Texture_Snow_Normal_Index <= -1 )
				...
				ifLocalVar7798 = appendResult10_g971;
			...
			float clampResult8057 = clamp( ( tex2DNode7984.a + ( 1.0 - _Global_Color_Opacity_Power ) ) , 0 , 1 );
			float2 appendResult7986 = (fixed2(1 , ( lerpResult7983 * clampResult8057 )));
			...
			fixed3 In08008 = float3( 0,0,0 );
			fixed localMyCustomExpression8008 = MyCustomExpression8008( In08008 );
			float temp_output_8014_0 = ( _Glitter_Refreshing_Speed * ( ( localMyCustomExpression8008 * 10 ) + ( _WorldSpaceCameraPos.x + _WorldSpaceCameraPos.y + _WorldSpaceCameraPos.z ) ) );
			float temp_output_8016_0 = ( 0 + temp_output_8014_0 );
			float clampResult8033 = clamp( sin( ( temp_output_8016_0 * 0.1 ) ) , 0 , 1 );
			float2 temp_output_8021_0 = ( Top_Bottom1999 * ( 1 / _Glitter_Tiling ) );
			float2 appendResult8052 = (fixed2(temp_output_8021_0.y , temp_output_8021_0.x));
			fixed4 tex2DNode8036 = tex2D( _Texture_Glitter, ( appendResult8052 + float2( 0.37,0.67 ) ) );
			float2 panner8023 = ( temp_output_8021_0 + ( temp_output_8014_0 * 0.01 ) * float2( 1,1 ));
			...
			float clampResult8037 = clamp( pow( tex2D( _Texture_Glitter, ( ( rotator8024 + temp_output_8021_0 ) * float2( 0.2,0.2 ) ) ).r , ( 1.0 - _Glitter_Noise_Threshold ) ) , 0 , 1 );
			float lerpResult8040 = lerp(  ( clampResult8033 - 0.2 > 0 ? tex2D( _Texture_Glitter, temp_output_8021_0 ).r : clampResult8033 - 0.2 <= 0 && clampResult8033 + 0.2 >= 0 ? tex2DNode8036.r : tex2DNode8036.r )  , 0.6 , clampResult8037);
			float clampResult8043 = clamp( pow( lerpResult8040 , 100.0 ) , 0 , 1 );
			...
			float clampResult8044 = clamp( temp_output_8048_0 , 0 , 1 );
			...
			float lerpResult8050 = lerp( ifLocalVar7802.w , _Glitter_Smoothness , clampResult8044);
			float lerpResult3951 = lerp( ( layeredBlend6532.w * _Terrain_Smoothness ) , lerpResult8050 , HeightMask6539);
